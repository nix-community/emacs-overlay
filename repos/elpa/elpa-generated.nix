{ callPackage }:
{
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.10.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/ellama-1.10.0.tar";
        sha256 = "19flprw7zj8dggf3zs01rzl3ck59lwc6d0rl9fs06qz3z6f6r2d9";
      };
      packageRequires = [
        compat
        llm
  ...
  llm = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.28.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/llm-0.28.4.tar";
        sha256 = "0lbbfc8jfyg8ny94ghigi075qk15znqcj9xv9g23xsbyckngwqzp";
      };
      packageRequires = [
        compat
        plz
