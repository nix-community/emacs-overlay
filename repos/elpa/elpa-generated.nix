{ callPackage }:
  {
    ...
    auctex = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "12.2.2";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/auctex-12.2.2.tar";
          sha256 = "1map25xn7r28aldhcz9n8pbfk2l3gvnxx8hgih3ax8hyvnfi6brh";
        };
        packageRequires = [ cl-lib emacs ];
        meta = {
    ...
    phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.3.50";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/phps-mode-0.3.50.tar";
          sha256 = "1zyldj46giq02l1cnw7kkyqa9szj9kmzqhw8y2dwm96hm6wv2hvq";
        };
        packageRequires = [ emacs ];
        meta = {
