{ callPackage }:
  {
    ...
    phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.3.37";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/phps-mode-0.3.37.tar";
          sha256 = "18i8qd0vzl8hg42hdgrgkpyl25r9yr6d7r9vblwmbxvqpx1x5pgz";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    tramp = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "2.4.3.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/tramp-2.4.3.1.tar";
          sha256 = "0ijswcpakvy5nn3g3pkj7bp82r19z2x360020jsh0cxyz8i0lh3k";
        };
        packageRequires = [ emacs ];
        meta = {
