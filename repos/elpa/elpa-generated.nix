{ callPackage }:
  {
    ...
    phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.3.15";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/phps-mode-0.3.15.tar";
          sha256 = "13rcwyscbp2hc9a3md0vd3riv9c3b42qnnvb8j6wsrj916xc1984";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    tramp = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "2.4.2.4";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/tramp-2.4.2.4.tar";
          sha256 = "0jpzcip0amqxpidvy9a312h5alghk0lxrv703v2331r9bah3y55c";
        };
        packageRequires = [ emacs ];
        meta = {
