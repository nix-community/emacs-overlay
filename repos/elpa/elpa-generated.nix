{ callPackage }:
{
  ...
  elisa = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/elisa-1.1.0.tar";
        sha256 = "0sx2rllb6xjnr804z2mr94nzs9081jjwj34rlglhb398c42dvncy";
      };
      packageRequires = [
        async
        ellama
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.12.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/ellama-0.12.4.tar";
        sha256 = "1c0j59cwmbdk7ik5z2iwjjhj12k9z2h9crxs1ykrp25clhqj6wy6";
      };
      packageRequires = [
        compat
        llm
  ...
  org = callPackage (
    ...
    elpaBuild {
      ...
      version = "9.7.15";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/org-9.7.15.tar";
        sha256 = "0gc2y4piw07l4dvmc3gghz2ixwyginj68mr4sihxwbxmzgwl3ch3";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.7.8";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/transient-0.7.8.tar";
        sha256 = "06hv3h6m7p894dxcxlf2ayhf5a80xz9clcf87qb2gcwfhsvi1mhs";
      };
      packageRequires = [
        compat
        seq
