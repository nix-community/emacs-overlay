{ callPackage }:
{
  ...
  greader = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.12.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/greader-0.12.4.tar";
        sha256 = "10dmj3iqlrb2bxkv3xblxhkdqdkblbk98ycn9y10spqsnsmm11nr";
      };
      packageRequires = [
        compat
        seq
  ...
  org = callPackage (
    ...
    elpaBuild {
      ...
      version = "9.7.18";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/org-9.7.18.tar";
        sha256 = "1hdhxmcpzd334sclkmb4z7yaysw7hg3s2m3v984g7ya594dkkirx";
      };
      packageRequires = [ ];
      meta = {
