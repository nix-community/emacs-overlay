{ callPackage }:
  {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "20210913";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/eev-20210913.tar";
          sha256 = "0zzkiym3nb4s21iq1qmbrf68fjv93q5md21h07pg7p1i3pv12m2l";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    taxy = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.5";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/taxy-0.5.tar";
          sha256 = "0dydq897q6zif9p0jy8gj0ii2a5xzsy3q65h2rxx6r0jdzn4mysr";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    verilog-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "verilog-mode";
        ename = "verilog-mode";
        version = "2021.9.1.191709444";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/verilog-mode-2021.9.1.191709444.tar";
          sha256 = "1mi8xhgvh8qsg1zkspd8wapvyz2czcns8b36zl03vhxfa40sdpkc";
        };
        packageRequires = [];
        meta = {
