{ callPackage }:
  {
    ...
    ada-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "7.1.6";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/ada-mode-7.1.6.tar";
          sha256 = "0r7mgz8l2f61hzwd6cgcg2dlybjgq1gxwb989zw68kkdqvjkr6y1";
        };
    ...
    phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.4.5";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/phps-mode-0.4.5.tar";
          sha256 = "0m4bjgkra71r3scwv547m82csi8gyy978ashjg09ggk8fbr40a6z";
        };
        packageRequires = [ emacs ];
        meta = {
