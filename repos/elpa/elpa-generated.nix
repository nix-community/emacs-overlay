{ callPackage }:
  {
    ...
    auctex = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "13.1.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/auctex-13.1.0.tar";
          sha256 = "0x3f4g58czwbyxhr5zy60mlwr05aadd19k5gi6aq26h1p82hng63";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "20220218";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/eev-20220218.tar";
          sha256 = "0a7vs4dnsh6arixm69yz92gzmmw7ms28ci3709k5qwxhr5zybjs6";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    modus-themes = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "2.1.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/modus-themes-2.1.0.tar";
          sha256 = "08lz5k1dbrrss6s3avrx24ql34lmi9fbcksnh2738vynpcd1qdf9";
        };
        packageRequires = [ emacs ];
        meta = {
