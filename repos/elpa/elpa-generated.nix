{ callPackage }:
  {
    ...
    debbugs = callPackage ({ elpaBuild, emacs, fetchurl, lib, soap-client }:
      elpaBuild {
        ...
        version = "0.24";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/debbugs-0.24.tar";
          sha256 = "1b8qwdvf3jvw0chrdgbymb2ci9ms45mf90nrljxx7jql2lsr3x63";
        };
    ...
    modus-operandi-theme = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.10.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/modus-operandi-theme-0.10.0.el";
          sha256 = "1r6dkfdd967zw1nw58nlw7y1r9x8lcbr5gvjfbcbrw0agh87wb40";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    modus-vivendi-theme = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.10.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/modus-vivendi-theme-0.10.0.el";
          sha256 = "1kk8q5lrl69ysawnk2iymqmmcsad884kx691hjf2zdj6fskd070g";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.3.51";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/phps-mode-0.3.51.tar";
          sha256 = "1iz600208c3k2mlvs33mhdamcbsr02x55dwfhk1gr1favcd4vvrc";
        };
        packageRequires = [ emacs ];
        meta = {
