{ callPackage }:
  {
    ...
    ement = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "0.9.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/ement-0.9.1.tar";
          sha256 = "1hg2gbhnk4lyjph5fb2ydvz17ynm6rqy3yk842pjwf6fblwns693";
        };
        packageRequires = [
          emacs
          map
    ...
    inspector = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.30";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/inspector-0.30.tar";
          sha256 = "0a1m1qki4w0jvhrq3hzh7ch0r44fjqsb4n1pqzvkm3kgspqs0fmz";
        };
        packageRequires = [ emacs ];
        meta = {
