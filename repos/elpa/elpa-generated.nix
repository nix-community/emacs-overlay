{ callPackage }:
  {
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        ...
        version = "0.9.7";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/ellama-0.9.7.tar";
          sha256 = "1k59imynhkz7551kg5fna8dnmnqcazlawrx7dxlqy35fdpqb54vb";
        };
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "9.7.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/org-9.7.1.tar";
          sha256 = "1igk1qww4r8ngy1mgxgkd9rm65dw90qnnpyi0chx01p9s80wix3b";
        };
        packageRequires = [ emacs ];
        meta = {
