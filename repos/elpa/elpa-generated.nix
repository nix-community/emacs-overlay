{ callPackage }:
  {
    ...
    compat = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "29.1.3.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/compat-29.1.3.1.tar";
          sha256 = "025idv426a2igaz7ijf5njjdi53zm5lmf345a1smv03iqx3fyj81";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "20230102";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/eev-20230102.tar";
          sha256 = "0q9adnz8yhz9922kkvfg0p4g2gjphbckappkhd4l2whkbfg170pw";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    emms = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        ...
        version = "13";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/emms-13.tar";
          sha256 = "0kfpdyhvgjdzg5m1g1cd2spnmq1nad3h5zly240dpda0ww41wmm6";
        };
    ...
    posframe = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "1.3.2";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/posframe-1.3.2.tar";
          sha256 = "05qkwb3ys05chn0maz7q19kp539m7p5acb8di4rni4vjjlkpx2bj";
        };
        packageRequires = [ emacs ];
        meta = {
