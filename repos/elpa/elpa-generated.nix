{ callPackage }:
{
  ...
  flymake = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.4.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/flymake-1.4.0.tar";
        sha256 = "0j2vjbf5dp9kyi64bfbz9sn1s80zpvlxhbmggwv90g2n2x62h27s";
      };
      packageRequires = [
        eldoc
        project
  ...
  gtags-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.8.3";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/gtags-mode-1.8.3.tar";
        sha256 = "1iysqbck922irs376xnfxvg0zl7ka3dw0fq42lmb049ni65sni2r";
      };
      packageRequires = [ ];
      meta = {
  ...
  indent-bars = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.8.3";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/indent-bars-0.8.3.tar";
        sha256 = "1x4b4s8wq7jr0lwwn3smm5l3wn5lnwb9s9iir6kna875zgvfvw2s";
      };
      packageRequires = [ compat ];
      meta = {
