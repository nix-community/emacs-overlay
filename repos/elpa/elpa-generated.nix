{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.26.1";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/llm-0.26.1.tar";
        sha256 = "0ih1h4fwgn3fd4xgcl1yyxjmfmmj6y97966qrvky6iclclkdfi29";
      };
      packageRequires = [
        compat
        plz
  ...
  transient = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.9.2";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/transient-0.9.2.tar";
        sha256 = "0c2i1vfyh5zgz70pjkf7ypa7b576lzi58ig3jwm7zh8ivjz927qx";
      };
      packageRequires = [
        compat
        seq
