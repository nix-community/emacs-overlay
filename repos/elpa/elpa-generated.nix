{ callPackage }:
{
  ...
  consult-denote = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.2";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/consult-denote-0.1.2.tar";
        sha256 = "0kvxjglh8cij22qzqbxaf8zrp75cph4536iqncp1rq789i0mjkzm";
      };
      packageRequires = [
        consult
        denote
  ...
  dape = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.15.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/dape-0.15.0.tar";
        sha256 = "0l684hygqvh5d842b6j01g28k8lzjlqm2r6w6aaagvdwyhy5k2j5";
      };
  ...
  taxy-magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.14.1";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/taxy-magit-section-0.14.1.tar";
        sha256 = "03dldc28qpilra4ifpv4p51zp20bl8z87mikv8nwaqz05dm3mmly";
      };
      packageRequires = [
        magit-section
        taxy
