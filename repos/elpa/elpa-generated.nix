{ callPackage }:
  {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "9.7.8";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/org-9.7.8.tar";
          sha256 = "1nr0ivf7ba4fp8rqfsb69a555aim6j3bppq9xwd7sdn8nmm05jmn";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    transient = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        ...
        version = "0.7.3";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/transient-0.7.3.tar";
          sha256 = "0lr2aii0w43gxhlharniy27h6d165333hghb2hc6jdlnj0gs6ymw";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
