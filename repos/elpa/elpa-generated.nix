{ callPackage }:
  {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "20231226";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/eev-20231226.tar";
          sha256 = "04k5lhlxq3493ah10wa06s2j72niy75dp9gizzd4cnrwnpq586ds";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        ...
        version = "0.4.13";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/ellama-0.4.13.tar";
          sha256 = "0lyz2l0dhgiym1wj0ni05kh1z021bvs1mpm0i9dahr7j14x4gx0k";
        };
    ...
    llm = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.8.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/llm-0.8.0.tar";
          sha256 = "1pcpwkwdrpbdmq0macxy66p2cmrlq7y8j58k0qlbpiqssyrwakzp";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    vertico-posframe = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "0.7.6";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/vertico-posframe-0.7.6.tar";
          sha256 = "15d7j37rmmg021mciwibcfmdwjn2694ljlh4sj03m1j4gj7igfqd";
        };
