{ callPackage }:
  {
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        ...
        version = "0.11.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/ellama-0.11.1.tar";
          sha256 = "1w6cqizrqsfb2fq7ndrfg2db9l2yaiqbdlag1y017rscw3lwpjls";
        };
    ...
    greader = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        ...
        version = "0.11.12";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/greader-0.11.12.tar";
          sha256 = "1bz970q90bqm3a234ii5ih6d4hn5xzhif86lqhr51q2843mkkvp8";
        };
