{ callPackage }:
{
  ...
  elisa = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/elisa-1.1.1.tar";
        sha256 = "1y7jiwjn8saya27w73gpvskadhqg79laqg7xxfc8nbcj912cd705";
      };
      packageRequires = [
        async
        ellama
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.12.5";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/ellama-0.12.5.tar";
        sha256 = "14rvpcyvyjikj5hdja4ad00ya6pcr16n4rw040inndfcmyzflc4d";
      };
      packageRequires = [
        compat
        llm
  ...
  llm = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.18.1";
      src = fetchurl {
        url = "https://elpa.gnu.org/packages/llm-0.18.1.tar";
        sha256 = "022h9klhc63aihlqk6jdhhqcda98faq2ziz17kvmyxrcwli8ij6g";
      };
      packageRequires = [
        plz
        plz-event-source
