{ callPackage }:
{
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "3.1.0.20251224.113253";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-3.1.0.20251224.113253.tar";
        sha256 = "09309j4bm0i5fzn39lryhrbsispg6c3hsg1pm32sa45bsk7jdaq7";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.28.3.0.20251226.201422";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.28.3.0.20251226.201422.tar";
        sha256 = "1wrym9ypx0624wmfgiwhavdjfawd369769li0s30plmnpcps32cj";
      };
      packageRequires = [
        compat
        plz
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "1.12.0.20251224.94027";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-1.12.0.20251224.94027.tar";
        sha256 = "0rgaya44x4n05xhadm1lwmhvwyf1351iizxm8lmrlgajij2f3jyn";
      };
      packageRequires = [ compat ];
      meta = {
