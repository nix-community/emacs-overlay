{ callPackage }:
{
  ...
  bnf-mode = callPackage (
    ...
    elpaBuild {
      pname = "bnf-mode";
      ename = "bnf-mode";
      version = "0.4.5.0.20240915.75211";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/bnf-mode-0.4.5.0.20240915.75211.tar";
        sha256 = "0m3895ylr7krb4hcips0n12y0sh2qsc7qmk7sygxg7ir83xna6q6";
      };
      packageRequires = [ cl-lib ];
      meta = {
