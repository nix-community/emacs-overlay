{ callPackage }:
{
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.4.0.0.20240806.52817";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.4.0.0.20240806.52817.tar";
        sha256 = "0pxcxnjc4aln322hsb0jny9awbzh6h8wca4s8syivcxpp5kv04k0";
      };
      packageRequires = [ ];
      meta = {
