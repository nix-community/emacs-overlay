{ callPackage }:
{
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260428.203103";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260428.203103.tar";
        sha256 = "0wpi3xi783k7jk307yy01lhyh599hpawd3m7qi8d4kcw5y1fg540";
      };
      packageRequires = [ ];
      meta = {
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.17.0.0.20260429.202648";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.17.0.0.20260429.202648.tar";
        sha256 = "0vlx0ip6fxfkm5rq9yl04sc9fygs19imc4b0ifr9za2sqx11gwn7";
      };
      packageRequires = [
        compat
        llm
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.10.4.0.20260430.123454";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/gnosis-0.10.4.0.20260430.123454.tar";
        sha256 = "1cih0r8isz3jd4z38pi4j6wr3vl5hxxg5n21lnzxm97ybk5iin7c";
      };
      packageRequires = [
        compat
        keymap-popup
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20260430.133757";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20260430.133757.tar";
        sha256 = "0liidxk2qgcpk6b1v473q17f84camkshlz6yisahasx9q68wvnrd";
      };
      packageRequires = [ ];
      meta = {
  ...
  keymap-popup = callPackage (
    ...
    elpaBuild {
      pname = "keymap-popup";
      ename = "keymap-popup";
      version = "0.2.2.0.20260501.21342";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/keymap-popup-0.2.2.0.20260501.21342.tar";
        sha256 = "0arlhrrw184czj6bha0vap8s1n2n0pcgdi887di9aw05gxnd1bq7";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.30.3.0.20260430.230150";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.30.3.0.20260430.230150.tar";
        sha256 = "0387jnm6bdj2am3iqlrmhbck3xml7rbdk90lhnhpfif0wmraj2i0";
      };
      packageRequires = [
        compat
        plz
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "10.0pre0.20260429.190331";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-10.0pre0.20260429.190331.tar";
        sha256 = "13i8j3gcbnrr0z8kmff36asmkagzsg68ip8n6lxw480h4fx9ig24";
      };
      packageRequires = [ ];
      meta = {
