{ callPackage }:
  {
    ...
    activities = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "activities";
        ename = "activities";
        version = "0.6pre0.20240229.23855";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/activities-0.6pre0.20240229.23855.tar";
          sha256 = "1cj7rcbkqj5mx4h3nzi2n29xxx05bib1zlms3b6afqlq44908gdj";
        };
    ...
    assess = callPackage ({ elpaBuild, emacs, fetchurl, lib, m-buffer }:
      elpaBuild {
        pname = "assess";
        ename = "assess";
        version = "0.6.0.20240302.105557";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/assess-0.6.0.20240302.105557.tar";
          sha256 = "1gbigivqvafmx42m4r1rahy1zmc4nhm3xa2zlfaakx9iv82gxl7s";
        };
    ...
    cape = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "cape";
        ename = "cape";
        version = "1.3.0.20240226.55835";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/cape-1.3.0.20240226.55835.tar";
          sha256 = "10yk1sh964629wf06dir6jg2d1cwrdd2z9sv6y9bgayqc6ky2byq";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    company = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "company";
        ename = "company";
        version = "0.10.2.0.20240302.152556";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/company-0.10.2.0.20240302.152556.tar";
          sha256 = "1qqw52p94ji7acwjbqlh3qsin474vib2xx4fp0y79b3na8p1b6c7";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "consult";
        ename = "consult";
        version = "1.3.0.20240225.164446";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/consult-1.3.0.20240225.164446.tar";
          sha256 = "1x18mq9nrq49x0cj1flrb1zj37wa95xvvzmz7zbny3bh444g4cdf";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    corfu = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "corfu";
        ename = "corfu";
        version = "1.2.0.20240225.155830";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/corfu-1.2.0.20240225.155830.tar";
          sha256 = "19khsb8iccm73xbljhnmqnj1kgax9wv286yihm0bjdv26ifvqhii";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.7.0.0.20240302.134155";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.7.0.0.20240302.134155.tar";
          sha256 = "1bmxjlj2sjxxzbg88i0zlh4jpfpr4s0ml4aw2yirkp2qszbgx11w";
        };
    ...
    denote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "denote";
        ename = "denote";
        version = "2.2.4.0.20240229.111328";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/denote-2.2.4.0.20240229.111328.tar";
          sha256 = "1pnl7afhn1llyclmlyhkrbc15xmaagnnjlsj9zwvxdsyzysllcix";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ellama = callPackage ({ dash
      ...
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.8.10.0.20240225.180309";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.8.10.0.20240225.180309.tar";
          sha256 = "03jzvsizj690h0mqp6n231a4wyfpil95zy6ka2pw38ndhf91gmi9";
        };
    ...
    emms = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        pname = "emms";
        ename = "emms";
        version = "18.0.20240302.183022";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/emms-18.0.20240302.183022.tar";
          sha256 = "08v63f7qphwrajsripfnwnl2civfwhgmshpnyc5d7rsx4haqj9k3";
        };
    ...
    ess = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "ess";
        ename = "ess";
        version = "24.1.1.0.20240229.205422";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ess-24.1.1.0.20240229.205422.tar";
          sha256 = "1hv8y1ni3713883xqvzax7m6hhqbvclann3snh3f5hrlrk103nxc";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    hyperbole = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "hyperbole";
        ename = "hyperbole";
        version = "8.0.2pre0.20240229.133459";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/hyperbole-8.0.2pre0.20240229.133459.tar";
          sha256 = "14qps3hvdk720hzlbxbaaszy8nwpsqbxw57mpi9iacyzb2fv6fbx";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    lentic = callPackage ({ dash, elpaBuild, emacs, fetchurl, lib, m-buffer }:
      elpaBuild {
        pname = "lentic";
        ename = "lentic";
        version = "0.11.0.20240302.105519";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/lentic-0.11.0.20240302.105519.tar";
          sha256 = "07rj3yzq5gknk3pyrzklcrdxcs4kmr1k5wpc6cpp5bk6mkz0dkzn";
        };
    ...
    listen = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "listen";
        ename = "listen";
        version = "0.5pre0.20240302.100850";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/listen-0.5pre0.20240302.100850.tar";
          sha256 = "14m7vggd3hfrsr424gjf8l3smmdmdvwz4injsg1b5qinpragd27n";
        };
    ...
    llm = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "llm";
        ename = "llm";
        version = "0.10.0.0.20240302.150322";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/llm-0.10.0.0.20240302.150322.tar";
          sha256 = "0q558vpn7hf7xdhfgy3xhmplicpkq9m6zh34ld1594fq2dhsag1g";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "modus-themes";
        ename = "modus-themes";
        version = "4.3.0.0.20240302.100146";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/modus-themes-4.3.0.0.20240302.100146.tar";
          sha256 = "0d55282g8qn1hidjsmy96hl4jwzg76mkkdakmry4i4mc2qvrw23r";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240302.122616";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240302.122616.tar";
          sha256 = "07qrfj8y6vijjaj79clc20si0gb0brirbypn7kghn9rhm1ckicr6";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org-modern = callPackage ({ compat
      ...
      elpaBuild {
        pname = "org-modern";
        ename = "org-modern";
        version = "1.1.0.20240224.161419";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-modern-1.1.0.20240224.161419.tar";
          sha256 = "0m8z0cskqyrddrlsf6zp2y94hjfiwmkqagfmqqi7ymml4m5bggrs";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    phpinspect = callPackage ({ compat, elpaBuild, fetchurl, lib }:
      elpaBuild {
        pname = "phpinspect";
        ename = "phpinspect";
        version = "0.0.20240225.135700";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/phpinspect-0.0.20240225.135700.tar";
          sha256 = "0xfammgpqmhfzp1v8w8nhza2srg2f6w9c4125wlzd9dkvg2kb109";
        };
    ...
    project = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "project";
        ename = "project";
        version = "0.10.0.0.20240225.73245";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/project-0.10.0.0.20240225.73245.tar";
          sha256 = "0b0mb9r4j59wvxrvjbr9bhiqhzr8i28s4v1702wllrwingsfx2dl";
        };
    ...
    site-lisp = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "site-lisp";
        ename = "site-lisp";
        version = "0.1.2.0.20240229.91200";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/site-lisp-0.1.2.0.20240229.91200.tar";
          sha256 = "1gqq3p1h1vkzr28m4mlnnjgj9habsqf1l686ag7679g3lbrn8p5z";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.5.3.0.20240226.233232";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.5.3.0.20240226.233232.tar";
          sha256 = "0m49knjz3y8rrhyz57sw52xyl2ks2ndvvhw692yf1qnqsf936gvi";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    vertico = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vertico";
        ename = "vertico";
        version = "1.7.0.20240225.155645";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vertico-1.7.0.20240225.155645.tar";
          sha256 = "1w9b8lq7gsj2ynma9c7m5j8zx5gpmhs41dpl9ndxji9ji4d0gndx";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    which-key = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "which-key";
        ename = "which-key";
        version = "3.6.0.0.20240228.205349";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/which-key-3.6.0.0.20240228.205349.tar";
          sha256 = "0idsw00pvsml8ngz0r3d2nsgda352a6mr21i9q00hkhxxvjcm3k9";
        };
        packageRequires = [ emacs ];
        meta = {
