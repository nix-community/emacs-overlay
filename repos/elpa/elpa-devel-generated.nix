{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.7.0.20241029.145226";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.7.0.20241029.145226.tar";
        sha256 = "17cckadf1dff7wg9yzqz5vwvs3w45dnz807976ppx6cdrbv2ns6m";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult-denote = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.1.0.20241025.80559";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-denote-0.2.1.0.20241025.80559.tar";
        sha256 = "0nb68g8win9nrxhmgrp6rynhkqwj1dm07s7iza13q4lnwypbxffh";
      };
      packageRequires = [
        consult
        denote
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.0.0.0.20241025.81843";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.0.0.0.20241025.81843.tar";
        sha256 = "05hm93d9wssxm1wxln6im4zwqp8nhxmqg89zzhp7xms7phwjzdcr";
      };
      packageRequires = [ compat ];
      meta = {
