{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.28.3.0.20251225.160855";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.28.3.0.20251225.160855.tar";
        sha256 = "033phidz1ipd139fh4pzzgaq36r1s7a6q8igzc5ksmn0sj391xjc";
      };
      packageRequires = [
        compat
        plz
