{ callPackage }:
{
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "3.4.0.20260330.62005";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-3.4.0.20260330.62005.tar";
        sha256 = "0ayni341q9f6sai46k9sjww8ynkl4gr5y66gqrz4y99kv6xjfk6j";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260402.65645";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260402.65645.tar";
        sha256 = "1c6jvml8x87ix8fsa79i2g45c8mrzj45a4g4vw74nqzk487k6987";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "2.1.0.0.20260402.62010";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-2.1.0.0.20260402.62010.tar";
        sha256 = "14drh27nqxa4vq4rxj0q7wn1ic2q13r5qpsf5pm0ciyln8yq50wg";
      };
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.23.0.20260402.173242";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.23.0.20260402.173242.tar";
        sha256 = "07ivkszb6pdf4s6fnwjx3pva3sgj3j9974wjxwjvgrk6nva3pj6q";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  emacs-lisp-intro-nl = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.0.20260403.174739";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/emacs-lisp-intro-nl-0.0.20260403.174739.tar";
        sha256 = "0jqmfi1qskifzdcbgd241n85y1biln405asdsvhqzf6vmvgdl9d8";
      };
      packageRequires = [ ];
      meta = {
  ...
  embark = callPackage (
    ...
    elpaBuild {
      pname = "embark";
      ename = "embark";
      version = "1.1.0.20260403.150522";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-1.1.0.20260403.150522.tar";
        sha256 = "1cjrs906dv6km0qzjijgvzpqm2dl40dvf83w3bxg800r2dm5scvc";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  embark-consult = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0.20260403.150522";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-consult-1.1.0.20260403.150522.tar";
        sha256 = "0g507gs97dpkyhpr3c0a1x6nxc405qbjm6zpz3pjp8s0xlcqiw77";
      };
      packageRequires = [
        compat
        consult
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "1.4.0.20260329.232338";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-1.4.0.20260329.232338.tar";
        sha256 = "1xaq5dq5armncwim14wbnfhimzm4bpbw99ycah1l7jp3dbsc5zp5";
      };
      packageRequires = [ ];
      meta = {
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.10.3.0.20260403.234000";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/gnosis-0.10.3.0.20260403.234000.tar";
        sha256 = "0gdql9yd5qbb6l00bif6iwazmfj4rl8jbn70jl7jx8d64y7jsk9q";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20260402.213912";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20260402.213912.tar";
        sha256 = "0rgyd295hdacsj2f1r8p3v44pi1jslipiknm7dix60k0qjz7qp7h";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.12.0.0.20260401.214523";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.12.0.0.20260401.214523.tar";
        sha256 = "0w4fk668p6s65jx8qip9v36na9myykn0cj2qldlad8vvdghak20g";
      };
      packageRequires = [
        compat
        cond-let
