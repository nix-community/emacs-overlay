{ callPackage }:
{
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.0.0.0.20250606.75251";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.0.0.0.20250606.75251.tar";
        sha256 = "0r0ahk36wjfyi51cgdryh10c6g6lg8arbkmx1kyvmkjvq5s7r7ns";
      };
      packageRequires = [ ];
      meta = {
  ...
  gtags-mode = callPackage (
    ...
    elpaBuild {
      pname = "gtags-mode";
      ename = "gtags-mode";
      version = "1.8.7.0.20250605.153659";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/gtags-mode-1.8.7.0.20250605.153659.tar";
        sha256 = "16g2nrmj2m1fjza01n12jpv9xl1waxjyvagg1778pgzjhscsj5hd";
      };
      packageRequires = [ ];
      meta = {
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "6.3.0.20250605.103407";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-6.3.0.20250605.103407.tar";
        sha256 = "0w4v1z2s2cvrpyas1z54ymcg374gszjihlmvham877xz9fl5vz8q";
      };
      packageRequires = [ ];
      meta = {
  ...
  spacious-padding = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.7.0.0.20250601.41941";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/spacious-padding-0.7.0.0.20250601.41941.tar";
        sha256 = "0pcqsxdjbkv15y0rxylhi42j1n6lwra6yr42k4wgxqjkhgiz384h";
      };
      packageRequires = [ ];
      meta = {
