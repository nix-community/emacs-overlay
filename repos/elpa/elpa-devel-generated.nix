{ callPackage }:
{
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.8.0.0.20240919.104457";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.8.0.0.20240919.104457.tar";
        sha256 = "17licmzbmc7yjrb3k4iikkijybh8vxslmgs4z0y3vfnn492jacqf";
      };
      packageRequires = [ ];
      meta = {
