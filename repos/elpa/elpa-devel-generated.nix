{ callPackage }:
  {
    ...
    async = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "async";
        ename = "async";
        version = "1.9.8.0.20231222.113941";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/async-1.9.8.0.20231222.113941.tar";
          sha256 = "0ddz62gsibgn6bv6sjm5aqkd0rm2h51d8g462gwwlbjzsjgzh2kv";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    beframe = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "beframe";
        ename = "beframe";
        version = "1.0.0.0.20231117.85057";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/beframe-1.0.0.0.20231117.85057.tar";
          sha256 = "1xy57hwdg913pnbm1jq8lgli1y0k3wzm2g31q58xmnkw3wgs5qzj";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    cape = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "cape";
        ename = "cape";
        version = "1.0.0.20231223.104538";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/cape-1.0.0.20231223.104538.tar";
          sha256 = "05pand5gg92l2z4lh4shm9nqyi2529azl1phkbla40vn8n0xvh9h";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    company = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "company";
        ename = "company";
        version = "0.10.2.0.20231220.231604";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/company-0.10.2.0.20231220.231604.tar";
          sha256 = "1ldlpcwa4fxmdsdb7xl03wpkkjman40vp96bf9sy3m8gq7b4ng4p";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    compat = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "compat";
        ename = "compat";
        version = "29.1.4.4.0.20231123.175838";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/compat-29.1.4.4.0.20231123.175838.tar";
          sha256 = "0kllqadj459p2973b5zvx1fn59ncb0hh3qjvkf7j89n929xfdwri";
        };
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "consult";
        ename = "consult";
        version = "1.0.0.20231215.150546";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/consult-1.0.0.20231215.150546.tar";
          sha256 = "0cpch0prxymy83v634ml9nrn3a05a4iflqvzdg52waiax9b4p6nj";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    corfu = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "corfu";
        ename = "corfu";
        version = "1.0.0.20231223.110017";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/corfu-1.0.0.20231223.110017.tar";
          sha256 = "19h25vy8ykp294likl4kixl46z8dnjxcccy9rc97vnq46spyn532";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.3.0.0.20231222.104731";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.3.0.0.20231222.104731.tar";
          sha256 = "0vhhw8z33833hd5frhy2rlz1lxnaaj7alcjv59bhfd4gz84wwv6n";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    dired-preview = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "dired-preview";
        ename = "dired-preview";
        version = "0.1.1.0.20231123.95349";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dired-preview-0.1.1.0.20231123.95349.tar";
          sha256 = "0yjfhk6z1i9560h5wl082vkbfpbvycdylkvvnnnsvrajyz34r1fx";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "eev";
        ename = "eev";
        version = "20231217.0.20231222.234931";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eev-20231217.0.20231222.234931.tar";
          sha256 = "0ifzlf4bhh7cb47cpdcblyv6f29hfjsdjd4gn6q5yrppfy595ixs";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ef-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ef-themes";
        ename = "ef-themes";
        version = "1.4.1.0.20231221.82442";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ef-themes-1.4.1.0.20231221.82442.tar";
          sha256 = "0cp9aqcsammqf1k7psmmchaxl2j02g24zzb86pm4czlq2l8f711m";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eglot = callPackage ({ eldoc
      ...
      elpaBuild {
        pname = "eglot";
        ename = "eglot";
        version = "1.15.0.20231220.185718";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eglot-1.15.0.20231220.185718.tar";
          sha256 = "0mn2l3xqs2p7k6b2rqprqm8plla4plsxg1166wgkzjg5bmp79md9";
        };
        packageRequires = [
          eldoc
          emacs
    ...
    eldoc = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "eldoc";
        ename = "eldoc";
        version = "1.15.0.0.20231210.122204";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eldoc-1.15.0.0.20231210.122204.tar";
          sha256 = "05wrgrpysvnl1sbfj5rg6iq017fz83c5qcr9x6fwf2kfsg5l79xn";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.4.7.0.20231223.172909";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.4.7.0.20231223.172909.tar";
          sha256 = "0jbxwngy0g61jqi0i74wk7mm5adxahm5vfqmmc8l79ny04c1xhdy";
        };
    ...
    emms = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        pname = "emms";
        ename = "emms";
        version = "17.0.20231218.120319";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/emms-17.0.20231218.120319.tar";
          sha256 = "08131bla5yfpvvvrwf1niayqxbjfrnbmgr8hd1db7ryj7k1sf5g1";
        };
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6snapshot0.20231217.201755";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6snapshot0.20231217.201755.tar";
          sha256 = "1im1hbbqqj34mq2cw71z6np7qz5jbcj4fpsr57p2g47pkhx45mrn";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    jinx = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "jinx";
        ename = "jinx";
        version = "1.0.0.20231221.182321";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jinx-1.0.0.20231221.182321.tar";
          sha256 = "17dn1rgr5k40k6qscbqraff8l871zk772z3pv1d82z2f4732f98p";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    js2-mode = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        pname = "js2-mode";
        ename = "js2-mode";
        version = "20230408.0.20231219.192621";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/js2-mode-20230408.0.20231219.192621.tar";
          sha256 = "0y0569zzr2syklwd2vws7fnjh0a6dq6jw83qr7639l5d5d3lvlmp";
        };
        packageRequires = [ cl-lib emacs ];
        meta = {
    ...
    jsonrpc = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "jsonrpc";
        ename = "jsonrpc";
        version = "1.0.21.0.20231220.185718";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jsonrpc-1.0.21.0.20231220.185718.tar";
          sha256 = "0azvfwnpibcqdr29bzbdq414y2ci78rs9mf82k698hvzxgnfll2w";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    kind-icon = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "kind-icon";
        ename = "kind-icon";
        version = "0.2.1.0.20231217.93534";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/kind-icon-0.2.1.0.20231217.93534.tar";
          sha256 = "096vjmlrm652fsclh2r3hfn4g88basjzq6fm0m5a034y15rd4ws7";
        };
    ...
    llm = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "llm";
        ename = "llm";
        version = "0.7.0.0.20231223.11300";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/llm-0.7.0.0.20231223.11300.tar";
          sha256 = "06a785fw353jr3b57zaaznnmjqzpcylayk9md2y5cn2jy66m57rz";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    logos = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "logos";
        ename = "logos";
        version = "1.1.1.0.20231124.52443";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/logos-1.1.1.0.20231124.52443.tar";
          sha256 = "061bvyki036dfm9piiahmg2c0hv39vh5c9wdiaqdj1f28kxkxdcq";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    marginalia = callPackage ({ compat
      ...
      elpaBuild {
        pname = "marginalia";
        ename = "marginalia";
        version = "1.4.0.20231215.142739";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/marginalia-1.4.0.20231215.142739.tar";
          sha256 = "0n9i57aqmwgxv1zilad0dgyf9zri2yhbgfvvv9caxj0spsvpv0iq";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "modus-themes";
        ename = "modus-themes";
        version = "4.3.0.0.20231221.82407";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/modus-themes-4.3.0.0.20231221.82407.tar";
          sha256 = "1qn68xnzp41w31177qh154vrc19aa3v7lplw2hf1xpy0sdbz804y";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20231223.201954";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20231223.201954.tar";
          sha256 = "0akgnf0mrqls48nfhqskizzxn0fc1ysb485rjhw5cc9214i1k3vj";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org-modern = callPackage ({ compat
      ...
      elpaBuild {
        pname = "org-modern";
        ename = "org-modern";
        version = "1.1.0.20231202.132043";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-modern-1.1.0.20231202.132043.tar";
          sha256 = "1w479kbc8sy9jz38cc3mga4n9glls23m1jgddr274iic3m3jigz6";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    osm = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "osm";
        ename = "osm";
        version = "1.1.0.20231223.155748";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/osm-1.1.0.20231223.155748.tar";
          sha256 = "0ml6ngr79xnjzn10s2v9h7q2zf8gzlacc7j4p016d95gi12ay49y";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    pulsar = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "pulsar";
        ename = "pulsar";
        version = "1.0.1.0.20231124.52804";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/pulsar-1.0.1.0.20231124.52804.tar";
          sha256 = "086f3rndlk0jhzn1y982sncadh01xlmgxf13j72n6s42j6cb4kvg";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    python = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        pname = "python";
        ename = "python";
        version = "0.28.0.20231216.91751";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/python-0.28.0.20231216.91751.tar";
          sha256 = "0kqf3grq8idwszxajfzmw5bmn1l4yhvnbwr80r6gnl83chz473rg";
        };
    ...
    so-long = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "so-long";
        ename = "so-long";
        version = "1.1.2.0.20231123.115949";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/so-long-1.1.2.0.20231123.115949.tar";
          sha256 = "0bmbcifjvgiwg1rfqwg0qb98c5mlcb2amd4fg62ykkya16h7bmy8";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    soap-client = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        pname = "soap-client";
        ename = "soap-client";
        version = "3.2.3.0.20231209.72521";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/soap-client-3.2.3.0.20231209.72521.tar";
          sha256 = "10mmbv3wik0kj3gn3xk2sj41nfw0zipipxn3063rmfz51ljay5pi";
        };
        packageRequires = [ cl-lib emacs ];
        meta = {
    ...
    spacious-padding = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "0.3.0.0.20231221.44719";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/spacious-padding-0.3.0.0.20231221.44719.tar";
          sha256 = "1qrvx8l2l55wbz7yn4dcsxha8f41jj09jlryyl4j5jcp525lfxbz";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    standard-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "2.0.1.0.20231221.82501";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/standard-themes-2.0.1.0.20231221.82501.tar";
          sha256 = "0pgx8pqjvb95fa4xqj6zklwaihbw0xpwljcd00z3jb6iv6aq9mg0";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    tempel = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "tempel";
        ename = "tempel";
        version = "1.0.0.20231130.234819";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/tempel-1.0.0.20231130.234819.tar";
          sha256 = "1420mw6kcgip6p1mnr387l06dnwgpg3q4vbjxp9kggk8iv67a9rr";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.5.3.0.20231216.190823";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.5.3.0.20231216.190823.tar";
          sha256 = "0kxqc1zxg1hsyg0yqirzaj0p20dbhpzy9gn5r6r2ccwljgp6d2if";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    use-package = callPackage ({ bind-key
      ...
      elpaBuild {
        pname = "use-package";
        ename = "use-package";
        version = "2.4.5.0.20231210.122204";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/use-package-2.4.5.0.20231210.122204.tar";
          sha256 = "0b6dm69xvdggrxz9f9hnsgp434hdlzpp7jdgzmcyjb4zz6wvfnfb";
        };
    ...
    vundo = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vundo";
        ename = "vundo";
        version = "2.1.0.0.20231221.185129";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vundo-2.1.0.0.20231221.185129.tar";
          sha256 = "1mdxz4qv1ypyv1irpz051km9qavkx9pa4p9sid9p02zm0kqwn7fy";
        };
        packageRequires = [ emacs ];
        meta = {
