{ callPackage }:
{
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.3.0.0.20241024.53757";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.3.0.0.20241024.53757.tar";
        sha256 = "0a261nq58mgy5sbpaxpw1c9fhjp8qnngabhdvqhwzrwagi61ydxa";
      };
      packageRequires = [ ];
      meta = {
