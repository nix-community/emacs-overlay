{ callPackage }:
{
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.2.5.0.20250221.81150";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.2.5.0.20250221.81150.tar";
        sha256 = "1li22mkn4ybybaj5d0k1031f2x6pcjwn6lcavxkql9135sd4230g";
      };
      packageRequires = [
        compat
        llm
