{ callPackage }:
{
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "2.3.0.20250909.115846";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-2.3.0.20250909.115846.tar";
        sha256 = "14c4vr4pfl71b2843flq585ls6mcd5wa1yqj9zb32dvqwbhi5v9v";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  doric-themes = callPackage (
    ...
    elpaBuild {
      pname = "doric-themes";
      ename = "doric-themes";
      version = "0.4.0.0.20250914.65935";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/doric-themes-0.4.0.0.20250914.65935.tar";
        sha256 = "11md67m4dmqgsavdy3097sj86mlfi8n8bagl5xz9qa5mvgdmznqc";
      };
      packageRequires = [ ];
      meta = {
  ...
  eev = callPackage (
    ...
    elpaBuild {
      pname = "eev";
      ename = "eev";
      version = "20250607.0.20250831.220910";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eev-20250607.0.20250831.220910.tar";
        sha256 = "0m9w8wjggl6fgk4rndw2gga8i4b94d5gjhpac49g1ncqd9gdsyk8";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.10.0.0.20250909.65731";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.10.0.0.20250909.65731.tar";
        sha256 = "0khwl091vcf36qklgz0c4mas2wp8m2zszah87dghxbpvnmplyjpi";
      };
      packageRequires = [ ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.18.0.20250906.134233";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.18.0.20250906.134233.tar";
        sha256 = "0jx1080v2hqx3yc9dy5n39s15zmzdszcxq0blaw714lhn72bx4a8";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  el-job = callPackage (
    ...
    elpaBuild {
      pname = "el-job";
      ename = "el-job";
      version = "2.4.8.0.20250912.200807";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/el-job-2.4.8.0.20250912.200807.tar";
        sha256 = "03j3h0qw9d62hzak40vmi4cbx7hy0wkwnw6hqzbzr79820kl4v27";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250908.221811";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250908.221811.tar";
        sha256 = "0mld3q3p3b1yf6b5ygksf5jqd6bqzxqgkfnr4sip79ikd0d385bz";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.27.2.0.20250908.100659";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.27.2.0.20250908.100659.tar";
        sha256 = "1szz1bpyq0nnzz86v091dnf9zsmqg5kd7h56rp7mf6rn0760zrrm";
      };
      packageRequires = [
        compat
        plz
  ...
  marginalia = callPackage (
    ...
    elpaBuild {
      pname = "marginalia";
      ename = "marginalia";
      version = "2.3.0.20250908.164432";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/marginalia-2.3.0.20250908.164432.tar";
        sha256 = "0qsalnjc3ik6521kpi9zaab0v62dqlf154arm1z9ik2a6jkra5in";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "7.0.1.0.20250913.203606";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-7.0.1.0.20250913.203606.tar";
        sha256 = "02vjii6imn1aighdd5fap19jnqf174ac3b33dr4yvn80djyn1bv6";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.8.1.0.20250909.65533";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.8.1.0.20250909.65533.tar";
        sha256 = "05x01v8nmikrq3mj79qa83p71a2dwry16p82c9hrpm7qj2lny7j0";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250901.122649";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250901.122649.tar";
        sha256 = "06dyvnm2limca90f781rf3v6irnxmkrk1h3w0wc2jqm6jk063mvn";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-modern = callPackage (
    ...
    elpaBuild {
      pname = "org-modern";
      ename = "org-modern";
      version = "1.9.0.20250827.121317";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-modern-1.9.0.20250827.121317.tar";
        sha256 = "0ifhr42540hpnmls76hicds4yxwpc97yd2xlzcd24616xbr120sw";
      };
      packageRequires = [
        compat
        org
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20250909.232631";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20250909.232631.tar";
        sha256 = "1ksy8grdsvlywbps662a01bhj1ykfxai8d8y9s8dqay4ivb15vwg";
      };
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.2.0.0.20250909.65826";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-2.2.0.0.20250909.65826.tar";
        sha256 = "0gib739yjw5b33hlfffbkgdj1m3sk13qn11w707w72kxn9858g0j";
      };
      packageRequires = [ ];
      meta = {
  ...
  tempel = callPackage (
    ...
    elpaBuild {
      pname = "tempel";
      ename = "tempel";
      version = "1.6.0.20250908.164624";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tempel-1.6.0.20250908.164624.tar";
        sha256 = "1lxgyn05d61lg96kcgfl7sjg0mq46397fyqkpcggrf2dpyl73yrk";
      };
      packageRequires = [ compat ];
      meta = {
