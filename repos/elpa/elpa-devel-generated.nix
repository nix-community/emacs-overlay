{ callPackage }:
  {
    ...
    async = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "async";
        ename = "async";
        version = "1.9.8.0.20240716.140230";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/async-1.9.8.0.20240716.140230.tar";
          sha256 = "1zdirra170kfv98ywdma82hl42cvjs2jmkpnrh6lxa3pbicnkgri";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    cape = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "cape";
        ename = "cape";
        version = "1.5.0.20240717.81638";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/cape-1.5.0.20240717.81638.tar";
          sha256 = "0qsl5gd4zgqazj5d6g281r1fz9hp0m2x8wy0xh9dbrfzcy1jp7f2";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    company = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "company";
        ename = "company";
        version = "0.10.2.0.20240718.3228";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/company-0.10.2.0.20240718.3228.tar";
          sha256 = "1cbi8y56hxmhaxf678n6isl5nigp59z1m6a3g5gcg415v99gvpz4";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    corfu = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "corfu";
        ename = "corfu";
        version = "1.4.0.20240716.201137";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/corfu-1.4.0.20240716.201137.tar";
          sha256 = "0jbrpv7z88gd72i7nd2nzpyf9d8mc9i79qkwklzhrnr30hchsibv";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.14.0.0.20240715.192057";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.14.0.0.20240715.192057.tar";
          sha256 = "1kd380dvd5w0dldsgjw9vcbp11zxhnf0l0i1flkj637p33vbc97a";
        };
    ...
    denote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "denote";
        ename = "denote";
        version = "3.0.7.0.20240718.55847";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/denote-3.0.7.0.20240718.55847.tar";
          sha256 = "0jahnsj5n4n6r4cfrjrm9qp92jch1w6myl4hxjqvfc4nkbn57036";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    diff-hl = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "diff-hl";
        ename = "diff-hl";
        version = "1.9.2.0.20240715.1507";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/diff-hl-1.9.2.0.20240715.1507.tar";
          sha256 = "1kj1wz7k4q12sziqrb66bigshdbp2wkblbmmvfyizqq0k93v050r";
        };
        packageRequires = [ cl-lib emacs ];
        meta = {
    ...
    dired-preview = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "dired-preview";
        ename = "dired-preview";
        version = "0.2.0.0.20240717.100047";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dired-preview-0.2.0.0.20240717.100047.tar";
          sha256 = "0gxijiw6f32qva7zy9qi8d0qbzi39dwlnj94yvlkak40bbxpdy93";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "eev";
        ename = "eev";
        version = "20240718.0.20240718.31556";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eev-20240718.0.20240718.31556.tar";
          sha256 = "1ymb8rrc63cgfnb7v0dykn4njl6c9cyaakzvbkcm3shd8gv6irss";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eglot = callPackage ({ compat
      ...
      elpaBuild {
        pname = "eglot";
        ename = "eglot";
        version = "1.17.0.20240717.2159";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eglot-1.17.0.20240717.2159.tar";
          sha256 = "0c4rgnhydzbk3jyk1fsafwgx5a3y0fh6z35h7xy62ivbhcpnw8y4";
        };
        packageRequires = [
          compat
          eldoc
    ...
    elisa = callPackage ({ async
      ...
      elpaBuild {
        pname = "elisa";
        ename = "elisa";
        version = "1.0.2.0.20240717.212307";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/elisa-1.0.2.0.20240717.212307.tar";
          sha256 = "0mmn70mirj8kkcil3rgy9r75k9wfp0a8hnp7is8p22rhhvd42vpf";
        };
    ...
    embark = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "1.1.0.20240717.160305";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-1.1.0.20240717.160305.tar";
          sha256 = "01mif55mx68wn3mc4qz2x95lkm6ixr12m4flpbph804ahih0xwgn";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ compat
      ...
      elpaBuild {
        ...
        version = "1.1.0.20240717.160305";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-1.1.0.20240717.160305.tar";
          sha256 = "0bikryl16ai4dvx1wa674ah7q09f40d91vdz29b4p1l46q24rr06";
        };
    ...
    hyperbole = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "hyperbole";
        ename = "hyperbole";
        version = "9.0.2pre0.20240714.214930";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20240714.214930.tar";
          sha256 = "1h6ysa3h5iy48aqjs1h6ci8wla2ggvkrn9hzb59gavi8icsi967j";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    jinx = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "jinx";
        ename = "jinx";
        version = "1.9.0.20240717.74944";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jinx-1.9.0.20240717.74944.tar";
          sha256 = "0gd55rz34iax4ai0s8nj0gjljv3z3qgypq5mydiknin9s4jcdhw8";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.7.3.0.20240713.210218";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.7.3.0.20240713.210218.tar";
          sha256 = "1zd8qphhyvhllgszm1xar82g033xyclfxnyl6qbxk2659ia082y4";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    vertico = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vertico";
        ename = "vertico";
        version = "1.8.0.20240716.191900";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vertico-1.8.0.20240716.191900.tar";
          sha256 = "0wa0x7snq2z1vvzrmfp85x9n6ris7dq4fkq47mh501m6vpi5g3dr";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    which-key = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "which-key";
        ename = "which-key";
        version = "3.6.0.0.20240713.155007";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/which-key-3.6.0.0.20240713.155007.tar";
          sha256 = "1k04wilhjn9dilfy935vvgnpvnkdkw9j6blddwpb6yr6af0d2r06";
        };
        packageRequires = [ emacs ];
        meta = {
