{ callPackage }:
{
  ...
  cape = callPackage (
    ...
    elpaBuild {
      pname = "cape";
      ename = "cape";
      version = "2.6.0.20260322.83540";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cape-2.6.0.20260322.83540.tar";
        sha256 = "0wzdh45ch0kar8zh3qna9b9cjwm3srvd2cd8667nmyvx8hpzq2sd";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260324.125155";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260324.125155.tar";
        sha256 = "0kkv5is655yj6iyvv8kmrkq2cn8cjdv7b8l8w61bn4yn68y99j5z";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote-sequence = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.0.0.20260324.200342";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-sequence-0.2.0.0.20260324.200342.tar";
        sha256 = "0p80v4lqmqqpzbaqhhxcrmx81gmg38j2ra31wqhl2fg6b74qg6yk";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "2.1.0.0.20260320.61904";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-2.1.0.0.20260320.61904.tar";
        sha256 = "19ig908bnd1jsppb906lhgg8dq2qql1rp0q0w35v6rl2z29snxz1";
      };
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "1.4.0.20260324.160552";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-1.4.0.20260324.160552.tar";
        sha256 = "1jw8w1aa3n2dyp1xaxji67yfnzi3260h8qm9q90k6q0gw4v5ikhi";
      };
      packageRequires = [ ];
      meta = {
  ...
  kubed = callPackage (
    ...
    elpaBuild {
      pname = "kubed";
      ename = "kubed";
      version = "0.5.1.0.20260325.64823";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/kubed-0.5.1.0.20260325.64823.tar";
        sha256 = "0iwxj90f0gcl8i4dkxhk6sfvm00k9lvxhkz1x73fnqkwlvivblmx";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-modern = callPackage (
    ...
    elpaBuild {
      pname = "org-modern";
      ename = "org-modern";
      version = "1.13.0.20260325.72157";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-modern-1.13.0.20260325.72157.tar";
        sha256 = "1ggy8wdrb7yrs20kx65c7k3c8nlh1a1li21a2abwvhg0sph0b0py";
      };
      packageRequires = [
        compat
        org
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.12.0.0.20260324.130439";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.12.0.0.20260324.130439.tar";
        sha256 = "07gwrlj83gm73srv63i7i1vanm0v92f23df7b7svihslcd5cgpvq";
      };
      packageRequires = [
        compat
        cond-let
  ...
  triples = callPackage (
    ...
    elpaBuild {
      pname = "triples";
      ename = "triples";
      version = "0.6.1.0.20260324.210020";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/triples-0.6.1.0.20260324.210020.tar";
        sha256 = "1rqxh7i44mibf5hp9s9lwyw2ngrp746h7a9h14dcnajax2sj82ii";
      };
      packageRequires = [ seq ];
      meta = {
  ...
  vc-jj = callPackage (
    ...
    elpaBuild {
      pname = "vc-jj";
      ename = "vc-jj";
      version = "0.5.0.20260324.165127";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vc-jj-0.5.0.20260324.165127.tar";
        sha256 = "1pg0bafdbpj3ns03i3xnkm5mz1qcx0ciwhxjqj5zsalaw960qzaz";
      };
      packageRequires = [ compat ];
      meta = {
