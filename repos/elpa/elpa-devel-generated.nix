{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.30.3.0.20260520.201617";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.30.3.0.20260520.201617.tar";
        sha256 = "01y6ir2mis7k80x0rjkrbfwnsnyl3si8gi10wdv0a49vvisb3s3f";
      };
      packageRequires = [
        compat
        plz
