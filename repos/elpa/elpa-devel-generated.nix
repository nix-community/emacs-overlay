{ callPackage }:
{
  a68-mode = callPackage (
    ...
    elpaBuild {
      pname = "a68-mode";
      ename = "a68-mode";
      version = "1.0.0.20250423.134854";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/a68-mode-1.0.0.20250423.134854.tar";
        sha256 = "0rbaj345azq8x1vly8i9nyh938fjqhvpgjiy7zvr5dbycnzpx0jv";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "2.3.0.20250419.81502";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-2.3.0.20250419.81502.tar";
        sha256 = "1n4klf35ls9xdi567lpmj4sm5r1p9zrk9fc7sj9797mdl7nakjz1";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  minuet = callPackage (
    ...
    elpaBuild {
      pname = "minuet";
      ename = "minuet";
      version = "0.5.4.0.20250419.5945";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minuet-0.5.4.0.20250419.5945.tar";
        sha256 = "0hnh43flxzlxl6a9svm958x5dgpc1q6igmj1j52h2lj4gbysbqrb";
      };
      packageRequires = [
        dash
        plz
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.7.0.0.20250423.102657";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.7.0.0.20250423.102657.tar";
        sha256 = "0inh7rp8a2f7p93kisn3d3qv876bf386iqnmn883hlkq38zvga7h";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-modern = callPackage (
    ...
    elpaBuild {
      pname = "org-modern";
      ename = "org-modern";
      version = "1.7.0.20250422.215925";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-modern-1.7.0.20250422.215925.tar";
        sha256 = "11mzbnw7fqj29kh8h5s6njkf1wcj0f3vszmk4dj7z60461v6czsy";
      };
      packageRequires = [
        compat
        org
  ...
  show-font = callPackage (
    ...
    elpaBuild {
      pname = "show-font";
      ename = "show-font";
      version = "0.2.1.0.20250423.183357";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/show-font-0.2.1.0.20250423.183357.tar";
        sha256 = "17c8ddi5q7z9d5i1cxhanb7cnhfbczgpxf47j7flrpml4b38mf5f";
      };
      packageRequires = [ ];
      meta = {
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.1.0.0.20250423.171102";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.1.0.0.20250423.171102.tar";
        sha256 = "0mpd0df7i218vr1hcl1ghxi1jhik55nd1zf3j5havyvsvskxzpnw";
      };
      packageRequires = [ ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.1.0.20250419.81644";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.1.0.20250419.81644.tar";
        sha256 = "0w4x8agk5x0issjkdymlmxqma949kxzx5svlv9b37dbjnmraqlyk";
      };
      packageRequires = [ compat ];
      meta = {
