{ callPackage }:
  {
    ...
    compat = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "compat";
        ename = "compat";
        version = "29.1.4.4.0.20240113.225710";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/compat-29.1.4.4.0.20240113.225710.tar";
          sha256 = "1jd3rshfp5svm6qj55zrb2nk7qmbjf6a7zg9khm67ym5b2hcfnrs";
        };
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.3.0.0.20240116.193422";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.3.0.0.20240116.193422.tar";
          sha256 = "1s7pm7n2gblbhsd7smybnb5rly10l896wzfciryzvnhp7avzrhaj";
        };
    ...
    ebdb = callPackage ({ elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        pname = "ebdb";
        ename = "ebdb";
        version = "0.8.21.0.20240115.101712";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ebdb-0.8.21.0.20240115.101712.tar";
          sha256 = "132mqn4mzk8b3sazw0gnhlpx0cif3vs2drqckbv5fqvn1knd5na7";
        };
        packageRequires = [ emacs seq ];
        meta = {
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.5.7.0.20240116.185244";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.5.7.0.20240116.185244.tar";
          sha256 = "1b7fb9pdb8hnjy1km7js33vr08lldg9h9n8mzhkxnnq4ybai0ynm";
        };
    ...
    jsonrpc = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "jsonrpc";
        ename = "jsonrpc";
        version = "1.0.24.0.20240115.63624";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jsonrpc-1.0.24.0.20240115.63624.tar";
          sha256 = "17jxlknsmk5wlmj4d07lb2fpndbk3xbqx66knz5f2j0rpjnjkl7z";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240116.133843";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240116.133843.tar";
          sha256 = "0cl4jvyyb744a40y791bx5c2lhwv5ygnfnkx6r4ci8ahm2avyp1r";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.5.3.0.20240114.172236";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.5.3.0.20240114.172236.tar";
          sha256 = "19ng23bfq9ild2chq857rs0ly6cqbl50slqjr2x473g2905p9fdl";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    xelb = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "xelb";
        ename = "xelb";
        version = "0.18.0.20240115.193029";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/xelb-0.18.0.20240115.193029.tar";
          sha256 = "0hjxz27nfgvx591gxzfbm5g3ac61rp5zwbnk536sw6d0azp49q5v";
        };
        packageRequires = [ emacs ];
        meta = {
