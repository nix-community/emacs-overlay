{ callPackage }:
{
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.10.0.0.20251030.13524";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.10.0.0.20251030.13524.tar";
        sha256 = "0vlb2ivrarzj81lfy69i66azq6fzxzqcgw89rfzh1id6wbz7a3fs";
      };
      packageRequires = [ cl-lib ];
      meta = {
