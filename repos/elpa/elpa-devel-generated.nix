{ callPackage }:
{
  ...
  cape = callPackage (
    ...
    elpaBuild {
      pname = "cape";
      ename = "cape";
      version = "1.7.0.20240926.91852";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cape-1.7.0.20240926.91852.tar";
        sha256 = "02ha74szhksyc20brjildhbmrc6bfq09n2zmjir0r733r5ydaryz";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "1.8.0.20240930.101249";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-1.8.0.20240930.101249.tar";
        sha256 = "1qx7qxrygkh5hx06g6l3xy0srzfcx32igxdwdbf1jiba50b9915v";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "1.5.0.20240926.181040";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-1.5.0.20240926.181040.tar";
        sha256 = "0mcp0jb71w19afyrg0hhpq0scc1fv37h88lbzy87jh7naa91wzzc";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.15.0.0.20240930.194750";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.15.0.0.20240930.194750.tar";
        sha256 = "05jsa2pqhc6d6g2mg8m3267p7x3agyvvbx90hn8kk2qc8paiq2d4";
      };
  ...
  erc = callPackage (
    ...
    elpaBuild {
      pname = "erc";
      ename = "erc";
      version = "5.6.1snapshot0.20240929.164339";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/erc-5.6.1snapshot0.20240929.164339.tar";
        sha256 = "1p23p22rx6nz66javgl2j4mv7grb55a7awjj9m0swdp2xbmh8pnd";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  exwm = callPackage (
    ...
    elpaBuild {
      pname = "exwm";
      ename = "exwm";
      version = "0.31.0.20240924.63618";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/exwm-0.31.0.20240924.63618.tar";
        sha256 = "182lrdypwb9hh11hg4hkfg7ia2xn5f41fb6nnpdwcrv6c5ssszh9";
      };
      packageRequires = [
        compat
        xelb
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.17.4.0.20240928.203905";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.17.4.0.20240928.203905.tar";
        sha256 = "0b8c7kf93kpfncpngg01lllwhxwjj5nvnx2mckx8gd5icaqzv3vl";
      };
      packageRequires = [ plz ];
      meta = {
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "1.4.0.20240929.64257";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-1.4.0.20240929.64257.tar";
        sha256 = "15zcx7hhscdj7i67l1ky0dq0k15z3wf64nlamy0fnx0w6a9k0rkl";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.28.0.20240929.213954";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.28.0.20240929.213954.tar";
        sha256 = "0qd0jczdlaibwydizpvmh1xqgmjiwsvciqv7aiq76cb19mfyllwf";
      };
      packageRequires = [
        compat
        seq
