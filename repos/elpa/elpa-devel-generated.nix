{ callPackage }:
{
  ...
  cape = callPackage (
    ...
    elpaBuild {
      pname = "cape";
      ename = "cape";
      version = "2.8.0.20260811.3";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cape-2.8.0.20260811.3.tar";
        sha256 = "0m7p23779s63s92cnqfscwdm5kvf0ijzl82fkv5abilsqdjq3v4f";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  compat = callPackage (
    ...
    elpaBuild {
      pname = "compat";
      ename = "compat";
      version = "31.0.0.2.0.20260817.5";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/compat-31.0.0.2.0.20260817.5.tar";
        sha256 = "0lgy28d3vhwyancy4h1rmsb6h0v5l686l8wxx0bhj8rswmarbnb5";
      };
      packageRequires = [ ];
      meta = {
  ...
  dicom = callPackage (
    ...
    elpaBuild {
      pname = "dicom";
      ename = "dicom";
      version = "1.5.0.20260811.6";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dicom-1.5.0.20260811.6.tar";
        sha256 = "1zhcccf8r2svh1pkfsn69d78cihhhn5k6wh4d8397rycynls22d6";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.31.3.0.20260818.5";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.31.3.0.20260818.5.tar";
        sha256 = "0h1v1ix3mxws74zlhydg0zpd2xd6r1xkj6wymvz7yjxsbd2x6kd7";
      };
      packageRequires = [
        compat
        plz
  ...
  marginalia = callPackage (
    ...
    elpaBuild {
      pname = "marginalia";
      ename = "marginalia";
      version = "2.11.0.20260811.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/marginalia-2.11.0.20260811.4.tar";
        sha256 = "1yc7vyrgw275s2m7zg642vdv5xmdsdwn517nvy30y720wpryc58a";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.12.0.20260811.3";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.12.0.20260811.3.tar";
        sha256 = "14s1wncigxxm5prnnbhxy8i2a7dd0f5g0klp68gbz82wvx6lxp88";
      };
      packageRequires = [ compat ];
      meta = {
