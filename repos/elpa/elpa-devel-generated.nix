{ callPackage }:
  {
    ...
    activities = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "activities";
        ename = "activities";
        version = "0.7pre0.20240311.223616";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/activities-0.7pre0.20240311.223616.tar";
          sha256 = "0x1yzc65mxdmpm5zc0kbgkisdzdwsf6w73z7r4l2wbbfpbm7zkj4";
        };
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.7.0.0.20240311.154527";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.7.0.0.20240311.154527.tar";
          sha256 = "1165cvm3x35i71hlgb5j3djw1ikv7b44p3kibbm9kjbrg5lhhwn7";
        };
    ...
    denote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "denote";
        ename = "denote";
        version = "2.2.4.0.20240311.85358";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/denote-2.2.4.0.20240311.85358.tar";
          sha256 = "04973kybc5cvl62jp73cf43vb4i790hcx2jgw9fp9lsg5f2v30kf";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ement = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ement";
        ename = "ement";
        version = "0.15pre0.20240304.140420";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ement-0.15pre0.20240304.140420.tar";
          sha256 = "0iy7hg9iz79m5pq4xghb0kzlrr4pzm6i4fanq4jyhw00pr3lg7sv";
        };
        packageRequires = [
          emacs
          map
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6snapshot0.20240310.61129";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6snapshot0.20240310.61129.tar";
          sha256 = "0ywljz1cz14vj81gfzi73mlvgj3mgfn43ri53m03iq88ya17d9iw";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    gtags-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "gtags-mode";
        ename = "gtags-mode";
        version = "1.0.0.20240311.233037";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/gtags-mode-1.0.0.20240311.233037.tar";
          sha256 = "1pc24g7wxba3gq3xh4xyknxk59g33csbd8c40r9jxl7nq122arw1";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    hyperbole = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "hyperbole";
        ename = "hyperbole";
        version = "9.0.1.0.20240310.132957";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/hyperbole-9.0.1.0.20240310.132957.tar";
          sha256 = "1gcq2cyd6nmy1pg3rsfd3pna52q86cy4im4ww6llarvik17djl5g";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    listen = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "listen";
        ename = "listen";
        version = "0.7pre0.20240311.225820";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/listen-0.7pre0.20240311.225820.tar";
          sha256 = "1r0mph3icbwxymsjvxyxma1mvljgn76imf5fy08a8wdh8wh9hs4w";
        };
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "modus-themes";
        ename = "modus-themes";
        version = "4.3.0.0.20240303.102353";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/modus-themes-4.3.0.0.20240303.102353.tar";
          sha256 = "0ni208p000ba48ifdhygmw6dn8912vd8071zr948j7ipdd1zd5as";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    mpdired = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "mpdired";
        ename = "mpdired";
        version = "1.0.20240311.161639";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/mpdired-1.0.20240311.161639.tar";
          sha256 = "0p0fvgrhrl5zvlng0rlh3ps6qgyyn17z79vgsy1y9pdj373rqygr";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    orderless = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "orderless";
        ename = "orderless";
        version = "1.0.0.20240308.205227";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/orderless-1.0.0.20240308.205227.tar";
          sha256 = "06idxpr3jcg86qndmqj23xjai7q5wjq1xjmzdwj3k0vqvmh5qcrs";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240308.104526";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240308.104526.tar";
          sha256 = "1pridylpsrik6c4mx8f2arlqvd44inzdvvpw99778ajybbfkp2qm";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.5.3.0.20240311.163849";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.5.3.0.20240311.163849.tar";
          sha256 = "0zx55nisjh5wkbpkg3gqgzr1bi7z45z10862sni29xzbiiig4nrs";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    which-key = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "which-key";
        ename = "which-key";
        version = "3.6.0.0.20240307.192422";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/which-key-3.6.0.0.20240307.192422.tar";
          sha256 = "1fv6h8lh5dsziy1n3j7ykh311kicllhrcx25348x96gmqx5xrcaa";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    window-commander = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "3.0.2.0.20240311.140031";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/window-commander-3.0.2.0.20240311.140031.tar";
          sha256 = "1mn0nm56bqn48jj6049j5mxy34954z8n4h1lj36yh5lrd1lmg2p1";
        };
        packageRequires = [ emacs ];
        meta = {
