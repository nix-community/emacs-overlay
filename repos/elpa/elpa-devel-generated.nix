{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.1.2.0.20260217.131651";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.1.2.0.20260217.131651.tar";
        sha256 = "01w8brg4k55shynsg636pkjmlvxc93737nbvwxwkav5q912wm3gb";
      };
      packageRequires = [ ];
      meta = {
  ...
  cond-star = callPackage (
    ...
    elpaBuild {
      pname = "cond-star";
      ename = "cond-star";
      version = "1.0.0.20260211.142338";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cond-star-1.0.0.20260211.142338.tar";
        sha256 = "1kkwpjlh56632i95n227x60yz6s16xip4ra5sfr0glvvm8l7zfk5";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260213.115234";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260213.115234.tar";
        sha256 = "0vgk9q0h40s81p53kbz4sarp079z2vlkb2hkwad1iayb0ifm5vhf";
      };
      packageRequires = [ ];
      meta = {
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.10.0.0.20260208.22708";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.10.0.0.20260208.22708.tar";
        sha256 = "05hpb9hkf2gn1nhshsglsx91niv9nha42fyrmn383aaxqwzisxz6";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  doric-themes = callPackage (
    ...
    elpaBuild {
      pname = "doric-themes";
      ename = "doric-themes";
      version = "1.0.0.0.20260209.80340";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/doric-themes-1.0.0.0.20260209.80340.tar";
        sha256 = "04f2svk4gpfzrywp55rpzqcymmr4zhy0c6m9nvhb3fkh09hr6l4z";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "2.1.0.0.20260218.184221";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-2.1.0.0.20260218.184221.tar";
        sha256 = "1w2vqgacwn77f3ysswx0889zxy91vfjswhjna45jrcp1l8canx17";
      };
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.21.0.20260208.63808";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.21.0.20260208.63808.tar";
        sha256 = "13gh59b01radhhix89m1xvd23lnszp9g6hmdljpcylz91p2hgrx3";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.12.15.0.20260217.155551";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.12.15.0.20260217.155551.tar";
        sha256 = "0avliahpj35fln77jyjdcphfdvfzvvb5r4ywm989imh85p38awn7";
      };
      packageRequires = [
        compat
        llm
  ...
  emacs-lisp-intro-nl = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.0.20260218.203800";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/emacs-lisp-intro-nl-0.0.20260218.203800.tar";
        sha256 = "19v4mwndn0kgv019j5z2p0bchbrhb2vjfjipg0jycc98rdjr8an8";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20260218.134211";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20260218.134211.tar";
        sha256 = "1nsax65wxivai3pbiyrb9xw1yc8mn0ca79pcz7zfjib0v7848vir";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.29.0.0.20260216.142857";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.29.0.0.20260216.142857.tar";
        sha256 = "0y12b3cbdjmwrfgsisr5lfr18ilcs8ipmbz5d9x54swjjfbn0l3s";
      };
      packageRequires = [
        compat
        plz
  ...
  marginalia = callPackage (
    ...
    elpaBuild {
      pname = "marginalia";
      ename = "marginalia";
      version = "2.9.0.20260125.120506";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/marginalia-2.9.0.20260125.120506.tar";
        sha256 = "0i1qhdq84ldmlpghnw2kcqkyq4awkv8k144m01v7l7lh01gyax3w";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "8.0.5.0.20260214.160329";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-8.0.5.0.20260214.160329.tar";
        sha256 = "1y5k2l73byya8xypkgigvr2yy2bfykzv8lcwai2ibmvfqxwazxy9";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.2.0.0.20260218.184405";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.2.0.0.20260218.184405.tar";
        sha256 = "05x140pra062wrbi30bbjhng47ax9zdgamajk7j5dcrs938p8gr2";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20260218.185930";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20260218.185930.tar";
        sha256 = "06msfda3lghj8j0aqybhlj45ciq5jpf2386xv8r2gs07rv6ikjzd";
      };
      packageRequires = [ ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.2.0.20260210.165649";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.2.0.20260210.165649.tar";
        sha256 = "1dv2jc58pxwygd7h3qsysl3zy01kiwp23k2nqhyq2mqy2bnr3nmy";
      };
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.30.0.20260207.124427";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.30.0.20260207.124427.tar";
        sha256 = "04brpmfj849swdzfmsfaqc40mz7mwh33cgb9mm2x2sg7pcf02qb8";
      };
      packageRequires = [
        compat
        flymake
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "3.0.2.0.20260218.184423";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-3.0.2.0.20260218.184423.tar";
        sha256 = "035wvgy4niw8zvs776xzk9d5yz2iw0kr8mc7dnl4ndii52k5n20s";
      };
      packageRequires = [ modus-themes ];
      meta = {
  ...
  tempel = callPackage (
    ...
    elpaBuild {
      pname = "tempel";
      ename = "tempel";
      version = "1.11.0.20260125.120704";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tempel-1.11.0.20260125.120704.tar";
        sha256 = "1i38rlzc0zr8yqriiy81d2isfanl588psjxc61iqbrk1xwd6sk2k";
      };
      packageRequires = [ compat ];
      meta = {
