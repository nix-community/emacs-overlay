{ callPackage }:
{
  ...
  colorful-mode = callPackage (
    ...
    elpaBuild {
      pname = "colorful-mode";
      ename = "colorful-mode";
      version = "1.2.4.0.20250807.214755";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/colorful-mode-1.2.4.0.20250807.214755.tar";
        sha256 = "090i9wzbcal2b4bpj5979xcl6j9nd58mlba1fqkg937hnmxsiacb";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.24.1.0.20250801.201801";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.24.1.0.20250801.201801.tar";
        sha256 = "0lim0wg9ihw8r9blk90361dz86y2dnx7dhkrdv3ja9dlfzxkjzy6";
      };
  ...
  embark = callPackage (
    ...
    elpaBuild {
      pname = "embark";
      ename = "embark";
      version = "1.1.0.20250805.143137";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-1.1.0.20250805.143137.tar";
        sha256 = "1i06fwl3jmgcfp5pg85mzima6h0bbxykbvn9srrx5p216glj19ia";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  embark-consult = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0.20250805.143137";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-consult-1.1.0.20250805.143137.tar";
        sha256 = "0wmhsgy9dwca376hd5zn9v290dk5xfgfsy86vanhwn3103k36ksy";
      };
      packageRequires = [
        compat
        consult
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250807.214805";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250807.214805.tar";
        sha256 = "0rvjlalywgj6dhrs31skrapvgr1lsy77pmr6w0qfyh1kvyc6zbzk";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.27.0.0.20250713.124702";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.27.0.0.20250713.124702.tar";
        sha256 = "1kjj2zipdmgacli70z8p8p9f3apalfrydx2vj0373rhpvkqx8mlz";
      };
      packageRequires = [
        compat
        plz
  ...
  marginalia = callPackage (
    ...
    elpaBuild {
      pname = "marginalia";
      ename = "marginalia";
      version = "2.2.0.20250804.224339";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/marginalia-2.2.0.20250804.224339.tar";
        sha256 = "1m53f7jzgmvqg8j31lk3gj4rbx1y5f17y2cjczlhylh90z241q7f";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  minuet = callPackage (
    ...
    elpaBuild {
      pname = "minuet";
      ename = "minuet";
      version = "0.5.5.0.20250807.200925";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minuet-0.5.5.0.20250807.200925.tar";
        sha256 = "02vgyvcyrcwsdfcishik2wfpmm4904qlv3x2y02kjwvm0kczqkfm";
      };
      packageRequires = [
        dash
        plz
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.1.0.0.20250802.33952";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.1.0.0.20250802.33952.tar";
        sha256 = "0my67y52v2xzniq3c9y5zg2rf0mw0wbqqgi6srphg23d1xdnr131";
      };
      packageRequires = [ ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.4.0.20250806.52321";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.4.0.20250806.52321.tar";
        sha256 = "1xqrj90bjf3nl69xl558fpk196x3q2npdhlnxfs95v8h4dsgnhik";
      };
      packageRequires = [ compat ];
      meta = {
