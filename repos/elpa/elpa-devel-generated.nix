{ callPackage }:
{
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.10.0.0.20250315.33833";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.10.0.0.20250315.33833.tar";
        sha256 = "0ln54xz9fpa21calvxkv9qxvwciyb23l3l9ip4lsic722wxhc7nx";
      };
      packageRequires = [ cl-lib ];
      meta = {
