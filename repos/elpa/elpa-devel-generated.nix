{ callPackage }:
{
  ...
  pulsar = callPackage (
    ...
    elpaBuild {
      pname = "pulsar";
      ename = "pulsar";
      version = "1.3.4.0.20260413.54922";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/pulsar-1.3.4.0.20260413.54922.tar";
        sha256 = "1qsksqcyn2y0qa8gn89wvr6qbabanvfa4pchiyjkw4f1pv0ipm51";
      };
      packageRequires = [ ];
      meta = {
