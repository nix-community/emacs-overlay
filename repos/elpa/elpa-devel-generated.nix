{ callPackage }:
{
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.8.1.0.20251026.51551";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.8.1.0.20251026.51551.tar";
        sha256 = "124nfdkfxlz16qbfrrr4hw4qfkcpk562ndzrf79k3zcqhjbgx8dq";
      };
      packageRequires = [ ];
      meta = {
