{ callPackage }:
{
  ...
  doric-themes = callPackage (
    ...
    elpaBuild {
      pname = "doric-themes";
      ename = "doric-themes";
      version = "0.2.0.0.20250809.44747";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/doric-themes-0.2.0.0.20250809.44747.tar";
        sha256 = "1v2zz23a2x0b3vibzd67v358rabfbm9vam069msx8k3g5qvx7f5z";
      };
      packageRequires = [ ];
      meta = {
