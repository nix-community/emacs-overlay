{ callPackage }:
{
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.3.0.0.20241225.64652";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.3.0.0.20241225.64652.tar";
        sha256 = "0faylkpxfsrikygg05b92xq4a5b0ivlcgm9acl6pa4rf856zgnpd";
      };
      packageRequires = [ ];
      meta = {
