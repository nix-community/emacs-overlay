{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.9.0.20250328.92719";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.9.0.20250328.92719.tar";
        sha256 = "0sz1477cwkbqbjybclm3rg1all9xidda0l9ifpp23f56gjm2lmn5";
      };
      packageRequires = [ ];
      meta = {
  ...
  counsel = callPackage (
    ...
    elpaBuild {
      pname = "counsel";
      ename = "counsel";
      version = "0.15.0.0.20250322.162656";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/counsel-0.15.0.0.20250322.162656.tar";
        sha256 = "02cjcb90xvijrjqz66cnblg4cpa19glkjz1a973q30cq1s3i3lcz";
      };
      packageRequires = [
        ivy
        swiper
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.23.0.0.20250329.1212";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.23.0.0.20250329.1212.tar";
        sha256 = "09srxiviniy7wmyjszjsqjji7rs03yh73khgyfiq3sm429lxc2ks";
      };
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "3.1.0.0.20250329.72557";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-3.1.0.0.20250329.72557.tar";
        sha256 = "107dr0229k9ra5n2iy18n06wvwqcfnf4hw57qv7xm2b6n8dd4f8w";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote-sequence = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.0.0.1.0.20250322.71214";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-sequence-0.0.0.1.0.20250322.71214.tar";
        sha256 = "0jcikfwn1ylwziw9l5mnsfagnxscpgfdnvzmnkaif1f6i1iydnz7";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  eldoc = callPackage (
    ...
    elpaBuild {
      pname = "eldoc";
      ename = "eldoc";
      version = "1.15.0.0.20250322.115509";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eldoc-1.15.0.0.20250322.115509.tar";
        sha256 = "045ww7f8p6bb0x59sa63754nn1yh0cg0ppym3mccql4r05gnm3qr";
      };
      packageRequires = [ ];
      meta = {
  ...
  jinx = callPackage (
    ...
    elpaBuild {
      pname = "jinx";
      ename = "jinx";
      version = "2.0.0.20250322.84205";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jinx-2.0.0.20250322.84205.tar";
        sha256 = "040czwblkfmfw6d7g8qgfqc73pbls8di1amlsdksdpjshw24h6wf";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250327.182508";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250327.182508.tar";
        sha256 = "03r9mk5ywrcnb1v3zmjj8cq09s3kxwikzb827dcvf6vycfvlwlrs";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.8.6.0.20250328.194012";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.8.6.0.20250328.194012.tar";
        sha256 = "03fgrl2vnqq0rvacyfiaksj7dqwkla5m0sv5kkc1k5cv5xgjm4mj";
      };
      packageRequires = [
        compat
        seq
  ...
  use-package = callPackage (
    ...
    elpaBuild {
      pname = "use-package";
      ename = "use-package";
      version = "2.4.6.0.20250322.130937";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/use-package-2.4.6.0.20250322.130937.tar";
        sha256 = "0w68kqf7g46f622ydhlcw4pjdg7awjq66yfiakfkc9sfm1ajfxdi";
      };
  ...
  which-key = callPackage (
    ...
    elpaBuild {
      pname = "which-key";
      ename = "which-key";
      version = "3.6.1.0.20250317.231629";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/which-key-3.6.1.0.20250317.231629.tar";
        sha256 = "0m61iaxpiddh48ll24651dbyjzrh5mrwbgsgnkfyyv4r81v0vcn2";
      };
      packageRequires = [ ];
      meta = {
