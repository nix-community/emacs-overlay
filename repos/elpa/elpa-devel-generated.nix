{ callPackage }:
{
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.4.0.20250804.224155";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.4.0.20250804.224155.tar";
        sha256 = "1v5k8739kv9g8mnwvabvrb4ad221vkw4mg02mhiss7b3xx5wvvq3";
      };
      packageRequires = [ compat ];
      meta = {
