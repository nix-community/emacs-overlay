{ callPackage }:
{
  ...
  spacious-padding = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.7.0.0.20250718.41509";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/spacious-padding-0.7.0.0.20250718.41509.tar";
        sha256 = "0qqz5fbp2md40vmsmjqmdy08jp540bgz3k07m81ggd77jnbay6n6";
      };
      packageRequires = [ ];
      meta = {
