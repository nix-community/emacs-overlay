{ callPackage }:
{
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.21.0.0.20250109.163616";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.21.0.0.20250109.163616.tar";
        sha256 = "0qwsa4vllimdw34dg4726zcv8y47yab6h454jyjd4z9p4qbrih35";
      };
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.17.0.20250106.104713";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.17.0.20250106.104713.tar";
        sha256 = "1p4iy0s26dcb5xqnv9p5396p4nfplmklyxj84z9qrxdkw3r30xx0";
      };
      packageRequires = [
        compat
        eldoc
  ...
  emms = callPackage (
    ...
    elpaBuild {
      pname = "emms";
      ename = "emms";
      version = "21.0.20250109.162914";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/emms-21.0.20250109.162914.tar";
        sha256 = "1mrghnprxvjzps4yikidiv12h0pfjrhyf27brda8vxvfxh9wvcyl";
      };
      packageRequires = [
        cl-lib
        nadvice
  ...
  ess = callPackage (
    ...
    elpaBuild {
      pname = "ess";
      ename = "ess";
      version = "24.1.1.0.20250109.100659";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ess-24.1.1.0.20250109.100659.tar";
        sha256 = "1ycdh292bgn3zkr42wv3girhrc8l73yqj6bic5g1zn0fvzbw155i";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250109.180015";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250109.180015.tar";
        sha256 = "1kk43zxrd7msy2smmvkjf4rpdcqignil1p2612lakvmzmgmjw4s5";
      };
      packageRequires = [ ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "1.10.0.20250110.60447";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-1.10.0.20250110.60447.tar";
        sha256 = "0spzhp0i8jalbq0gnp0lg5f4m2rxgrqpnl2ndhjknfslri8hvc14";
      };
      packageRequires = [ compat ];
      meta = {
