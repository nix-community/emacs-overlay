{ callPackage }:
  {
    ...
    embark = callPackage ({ compat
      ...
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "0.22.1.0.20230713.123943";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-0.22.1.0.20230713.123943.tar";
          sha256 = "0llkxdh41j4wshgh3ylkkawiilmghsffqr0z8mz79wd3ll142vd3";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ consult
      ...
      elpaBuild {
        ...
        version = "0.7.0.20230713.123943";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-0.7.0.20230713.123943.tar";
          sha256 = "1g1bv0a5nbq4nqfi5qd0xdzzir0m62gcyvmbawv5gmk6baci82l8";
        };
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6snapshot0.20230713.184531";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6snapshot0.20230713.184531.tar";
          sha256 = "08r2xmf2q9gyzkjdfmawmwmrihkbaknw9pwhyfwfikvv7bfa8ppx";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    marginalia = callPackage ({ compat
      ...
      elpaBuild {
        pname = "marginalia";
        ename = "marginalia";
        version = "1.3.0.20230713.184647";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/marginalia-1.3.0.20230713.184647.tar";
          sha256 = "1sh8lv8m22970ls6cs09gwi93wbfmmadmpjqhz5kp20s104q3n1i";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20230713.172441";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20230713.172441.tar";
          sha256 = "0x2ibg861mc1bx7xzzggldz1b33k8kyyaf2fzy3awhllfzsx7lm5";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    vertico = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vertico";
        ename = "vertico";
        version = "1.4.0.20230714.63923";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vertico-1.4.0.20230714.63923.tar";
          sha256 = "1mj2gbcjbamfqx0nplw432f4ra064i8nalaj5c3spjlbsk0bh28a";
        };
        packageRequires = [ compat emacs ];
        meta = {
