{ callPackage }:
{
  ...
  colorful-mode = callPackage (
    ...
    elpaBuild {
      pname = "colorful-mode";
      ename = "colorful-mode";
      version = "1.1.0.0.20250211.233634";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/colorful-mode-1.1.0.0.20250211.233634.tar";
        sha256 = "1y0i5800qfwymqkw3fas3di5vak23cgava5piz0bjxjp5n47fzpw";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.9.0.0.20250212.62709";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.9.0.0.20250212.62709.tar";
        sha256 = "1l80fbv4kaji9nhd0bhqn2ip9sicyn3pj9xmf417qls42lrsfmyc";
      };
      packageRequires = [ ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.18.0.20250212.54658";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.18.0.20250212.54658.tar";
        sha256 = "0avwqriprrpjc1zfg12k69888izwv18m5plafdz4a48mxda545vs";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.0.2.0.20250212.204239";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.0.2.0.20250212.204239.tar";
        sha256 = "0brcj3fy8m8946yqbjh9r5ibw1bpjm2wqjl9m802fssh9s9khq03";
      };
      packageRequires = [
        compat
        llm
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250210.175201";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250210.175201.tar";
        sha256 = "1y502a7nwwg3hmb77q1381sjfgm8fxsvgbzwhi1k50qmgzff9507";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-gnosis = callPackage (
    ...
    elpaBuild {
      pname = "org-gnosis";
      ename = "org-gnosis";
      version = "0.0.4.0.20250212.213717";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-gnosis-0.0.4.0.20250212.213717.tar";
        sha256 = "0hh2yi8zs8ccd9r05y9fvlprb958lmg8yaijcjg79y42i9v0zk01";
      };
      packageRequires = [
        compat
        emacsql
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20250212.171846";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20250212.171846.tar";
        sha256 = "00c91rmqqrx5v4aaqhaxj7fw2jgisvpjis7js9vrxcl9ifds7pjk";
      };
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.2.0.0.20250212.62806";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-2.2.0.0.20250212.62806.tar";
        sha256 = "0a8d60i7hrlhm1xacxqzjpjz8z52ak6zfkh4waiqgb58nyhkknsg";
      };
      packageRequires = [ ];
      meta = {
