{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.7.0.20241121.80443";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.7.0.20241121.80443.tar";
        sha256 = "1p07z7m82skdrbf4y2hn021qdvc3dv8vwwafc85cqg22qlwgqjjs";
      };
      packageRequires = [ ];
      meta = {
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "1.5.0.20241123.82538";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-1.5.0.20241123.82538.tar";
        sha256 = "1rwc527qng4ccvffsmv4x7mij5fgbr2490h7wsy8hfrl3wnpbwji";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "3.1.0.0.20241123.91925";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-3.1.0.0.20241123.91925.tar";
        sha256 = "160gg0yw2lsgy2r1jrdyhrf7qynd95y0jr5db910mg8ii69i8jy1";
      };
      packageRequires = [ ];
      meta = {
  ...
  eev = callPackage (
    ...
    elpaBuild {
      pname = "eev";
      ename = "eev";
      version = "20241123.0.20241123.111922";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eev-20241123.0.20241123.111922.tar";
        sha256 = "06q7f1nc9vz34ds2yp19jar4crf0dqnlmav5rvs7nvqf4ff71j3k";
      };
      packageRequires = [ ];
      meta = {
  ...
  ess = callPackage (
    ...
    elpaBuild {
      pname = "ess";
      ename = "ess";
      version = "24.1.1.0.20241125.113115";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ess-24.1.1.0.20241125.113115.tar";
        sha256 = "06nz9lvlji3dlzfbcvpk0vmdr1k64dbx54mpc07k2mc3j2pzjiv8";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20241125.90148";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20241125.90148.tar";
        sha256 = "1fcaipccdr1fkh93dywpwm23nm25rfb88ky95cp3v32kx3g67a3y";
      };
      packageRequires = [ ];
      meta = {
  ...
  indent-bars = callPackage (
    ...
    elpaBuild {
      pname = "indent-bars";
      ename = "indent-bars";
      version = "0.8.2.0.20241109.70253";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/indent-bars-0.8.2.0.20241109.70253.tar";
        sha256 = "0lfyfssk3lpavfwhiindgs061r2imxw86xmg49myx3c9ys2i7wiq";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  jsonrpc = callPackage (
    ...
    elpaBuild {
      pname = "jsonrpc";
      ename = "jsonrpc";
      version = "1.0.25.0.20241024.85007";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jsonrpc-1.0.25.0.20241024.85007.tar";
        sha256 = "16a7vqlc07f1hfyivzandklgnxisw43xjzmxh3qjli899iwa6jx3";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.18.1.0.20241123.131216";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.18.1.0.20241123.131216.tar";
        sha256 = "1haj7h0103sj47vrwwbdfrdczijq6rdacmvzyqilq4mrxhvhks19";
      };
      packageRequires = [
        plz
        plz-event-source
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20241123.194407";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20241123.194407.tar";
        sha256 = "1vn9awb6hvnyhi6zsdmaljhr79dsh57p7bmf94nm6psqkcq14rvh";
      };
      packageRequires = [ ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20241029.22822";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20241029.22822.tar";
        sha256 = "0ijhxr03p38vp3w5qysxqvb4y3sczp0my5g82bdbv2isgyldnksm";
      };
  ...
  xref = callPackage (
    ...
    elpaBuild {
      pname = "xref";
      ename = "xref";
      version = "1.7.0.0.20241114.155120";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/xref-1.7.0.0.20241114.155120.tar";
        sha256 = "1vbs6qi5d1c8r1nd9443iwrljx2fkh8a4cy3prqmnbi3wp4fq619";
      };
      packageRequires = [ ];
      meta = {
