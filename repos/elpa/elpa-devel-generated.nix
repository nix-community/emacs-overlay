{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.1.2.0.20260525.33";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.1.2.0.20260525.33.tar";
        sha256 = "14g4djrwpn653jnqq073bhgccnzxknr3xlz8k0cavh6njnrbdqbm";
      };
      packageRequires = [ ];
      meta = {
  ...
  bufferlo = callPackage (
    ...
    elpaBuild {
      pname = "bufferlo";
      ename = "bufferlo";
      version = "1.2.0.20260518.3057";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/bufferlo-1.2.0.20260518.3057.tar";
        sha256 = "1q4mqn99ifb9vxa3fsl4g5nby6kl2xb5hyy9lkpqkw83zx4lzj8x";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.2.3.0.20260527.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.2.3.0.20260527.0.tar";
        sha256 = "0lpaf1ipavi20px23h3l7dwcxmgq91sw19hgx7hh4y6pvcmqbbs2";
      };
      packageRequires = [ ];
      meta = {
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.26.0.0.20260528.1";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.26.0.0.20260528.1.tar";
        sha256 = "05ijyk5m66wlxxasd4v5zpa732bvmci9mxr3l6ibfllzq1n18v4j";
      };
      packageRequires = [
        compat
        llm
  ...
  embark = callPackage (
    ...
    elpaBuild {
      pname = "embark";
      ename = "embark";
      version = "1.2.0.20260520.175049";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-1.2.0.20260520.175049.tar";
        sha256 = "118apcq0zk0hmksg093xfvaz6r6d0zb94m7fga8x3ja0zjqwrysz";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  embark-consult = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.2.0.20260520.175049";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/embark-consult-1.2.0.20260520.175049.tar";
        sha256 = "1yl3plqr2a87qz1s0ncs5nqachgdjjhx49gs7amnryxlwasay4v2";
      };
      packageRequires = [
        compat
        consult
  ...
  erc = callPackage (
    ...
    elpaBuild {
      pname = "erc";
      ename = "erc";
      version = "5.70.20260520.232452";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/erc-5.70.20260520.232452.tar";
        sha256 = "0waigs5fc6zvzdlffc06rq87szxxbnl0dky3y1z5skhzjhqlnbig";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  exwm = callPackage (
    ...
    elpaBuild {
      pname = "exwm";
      ename = "exwm";
      version = "0.34.0.20260527.69";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/exwm-0.34.0.20260527.69.tar";
        sha256 = "1sjkbww422wk3d1ycnsz44ibx12fxrxymz19rmm8qjdprd09s3av";
      };
      packageRequires = [
        compat
        xelb
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "1.7.0.20260528.7";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-1.7.0.20260528.7.tar";
        sha256 = "01pjcg1p70ybqlr85y9ij0bn9lbm65sj6pi060d3kkmlzir2bz7w";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.20.20260528.1122";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.20.20260528.1122.tar";
        sha256 = "1ry9rdp2biky0nybvcam5mfzyz6727cp0bz938nrmzlkza96qf4n";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.2.0.0.20260522.72020";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.2.0.0.20260522.72020.tar";
        sha256 = "0yf3ikjhvcrvd16m4klq3q16scx7mc1hvj615z7w3zgcryqym35q";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "10.0.20260531.248";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-10.0.20260531.248.tar";
        sha256 = "0n5knlbiqwzhxzlp2pjfnl1vd423mxia7c17aixd2w1048vzfkvk";
      };
      packageRequires = [ ];
      meta = {
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "2.3.0.20260519.102419";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-2.3.0.20260519.102419.tar";
        sha256 = "0n9vghgmz1mhz23hzpb7s0azhj2lbrlg3ca0c2bmr2q33cn9achr";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.13.3.0.20260518.141320";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.13.3.0.20260518.141320.tar";
        sha256 = "1csdsbxyw9cbx00gcapg76gppk43kdgk6ms8ghbbhcl3nqw0wm67";
      };
      packageRequires = [
        compat
        cond-let
  ...
  urgrep = callPackage (
    ...
    elpaBuild {
      pname = "urgrep";
      ename = "urgrep";
      version = "0.6.10.20260321.103449";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/urgrep-0.6.10.20260321.103449.tar";
        sha256 = "1pjyqz1wvvxkw2128j2kxpgh2w5vf73v64zwzb80sd3bpync3g0v";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.9.0.20260521.200344";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.9.0.20260521.200344.tar";
        sha256 = "1i2cc402h31k4xzs19l8biq87vrvq3chzj61kdfbz4216cladyg0";
      };
      packageRequires = [ compat ];
      meta = {
