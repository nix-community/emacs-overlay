{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.1.0.0.20251116.213829";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.1.0.0.20251116.213829.tar";
        sha256 = "1m07xj0037lrr1l8n0dfp5mbdl0x32wi8hbbkb8wrpplcx4jzp1s";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "3.0.0.20251117.145139";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-3.0.0.20251117.145139.tar";
        sha256 = "1prjm34akggn4n30gnsbfmk11h0a78p8y329ggqphpmsb3mn82p3";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.19.0.20251116.221640";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.19.0.20251116.221640.tar";
        sha256 = "1ikzz245iijr2s5lk4bbz0bbiifhzha9syh4b7v88vrqpdsr7naq";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  ement = callPackage (
    ...
    elpaBuild {
      pname = "ement";
      ename = "ement";
      version = "0.17.0.20251116.65849";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ement-0.17.0.20251116.65849.tar";
        sha256 = "0yqs4fsxc42bpsq3y8ksspbl1q62cq0a0bq0kxpsy0hrkhnzd15n";
      };
      packageRequires = [
        map
        persist
  ...
  exwm = callPackage (
    ...
    elpaBuild {
      pname = "exwm";
      ename = "exwm";
      version = "0.34.0.20251115.184427";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/exwm-0.34.0.20251115.184427.tar";
        sha256 = "00mil6h5h43mz1b1rg3rds6brsxb5pjv9lsp9pb40rj6irbs7px8";
      };
      packageRequires = [
        compat
        xelb
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20251117.145915";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20251117.145915.tar";
        sha256 = "0yrhsz419056h081vxsgya1nyp3zds2m4c33s59fbpk5q1l1bjn8";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.1.0.0.20251117.101445";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.1.0.0.20251117.101445.tar";
        sha256 = "15qxi506hl2a2d74cgbn023dfs060l3xnb4fkxnqn8s43szip53g";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20251116.180215";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20251116.180215.tar";
        sha256 = "0cxkh8mykphifxws0mdyxs2ibbmq8213r3lnp2w3c5vdwff2qhjh";
      };
      packageRequires = [ ];
      meta = {
  ...
  posframe = callPackage (
    ...
    elpaBuild {
      pname = "posframe";
      ename = "posframe";
      version = "1.4.4.0.20251117.30512";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/posframe-1.4.4.0.20251117.30512.tar";
        sha256 = "1rwns9j3pz7d1kiar7ss2l7sx6m42pv4s4h075zvcy23alk0syi0";
      };
      packageRequires = [ ];
      meta = {
