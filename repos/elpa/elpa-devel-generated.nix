{ callPackage }:
{
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "2.0.0.20250213.75746";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-2.0.0.20250213.75746.tar";
        sha256 = "1ppn4sq18ri362i6d4fiag0hlj9s8ynxah44qd9fmmr5k6q86rri";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.22.0.0.20250210.204103";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.22.0.0.20250210.204103.tar";
        sha256 = "0ip24m8929krgrzbrlzx5crg16xv85wvy9hbimzhg3dfxxqx10qc";
      };
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.9.0.0.20250215.140538";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.9.0.0.20250215.140538.tar";
        sha256 = "0ddhxhpg3r37byifc4z2yw8fmls50smap1snywz78iw0xh086as6";
      };
      packageRequires = [ ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.18.0.20250215.85855";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.18.0.20250215.85855.tar";
        sha256 = "02xbz42hi53v5fbl3gg3ypzzzrqdll90wanxwgv4ilkfr73dv39l";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.1.4.0.20250215.171250";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.1.4.0.20250215.171250.tar";
        sha256 = "1pgwsqjcan1g99ar9r17hdh2i1f2mj44lwckfg0nqwb6xirdsmz6";
      };
      packageRequires = [
        compat
        llm
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250209.112554";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250209.112554.tar";
        sha256 = "0ahhaq0c8aw4kgf44js03v7bj0vmbv2h807z0i1s5vnbiwyrqky8";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.23.0.0.20250213.4241";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.23.0.0.20250213.4241.tar";
        sha256 = "0rbzambxfam6cmdb6przwv58ip7xsz5xmb4vb2kwn72h3rarhadn";
      };
      packageRequires = [
        plz
        plz-event-source
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.6.0.0.20250215.140449";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.6.0.0.20250215.140449.tar";
        sha256 = "1pw38qkd1mwx2j8k38fs1y777mh9nzl41m837z97p00384956kl2";
      };
      packageRequires = [ ];
      meta = {
  ...
  popper = callPackage (
    ...
    elpaBuild {
      pname = "popper";
      ename = "popper";
      version = "0.4.6.0.20250215.81351";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/popper-0.4.6.0.20250215.81351.tar";
        sha256 = "051mmqbygvn7fg34lnnxrw3lz0fgx1awffrhrax35kgv7622zbsj";
      };
      packageRequires = [ ];
      meta = {
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.2.0.0.20250215.140613";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-2.2.0.0.20250215.140613.tar";
        sha256 = "1lhkhyin9q39cwykzx66f459p39jx2byagpjiwdmy0nx5gjvzsb7";
      };
      packageRequires = [ ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "1.11.0.20250215.172944";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-1.11.0.20250215.172944.tar";
        sha256 = "1mwzlw11asvsfgyj2m3npgxsjg58lkp0qrpp7fk7y82n051r68hc";
      };
      packageRequires = [ compat ];
      meta = {
