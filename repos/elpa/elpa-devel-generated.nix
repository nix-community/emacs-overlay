{ callPackage }:
  {
    ...
    kind-icon = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "kind-icon";
        ename = "kind-icon";
        version = "0.2.2.0.20240104.115117";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/kind-icon-0.2.2.0.20240104.115117.tar";
          sha256 = "1qri55filsiyipv21cic4qjss54cycrkvwnl25vp4arpk2v4a4ss";
        };
