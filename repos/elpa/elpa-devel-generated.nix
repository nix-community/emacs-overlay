{ callPackage }:
{
  a68-mode = callPackage (
    ...
    elpaBuild {
      pname = "a68-mode";
      ename = "a68-mode";
      version = "1.2.0.20250523.190001";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/a68-mode-1.2.0.20250523.190001.tar";
        sha256 = "1hr1pnsjwrk4v82i0gjr2z512561jb06ix81yfq14ghr9r5jblwi";
      };
      packageRequires = [ ];
      meta = {
  ...
  doric-themes = callPackage (
    ...
    elpaBuild {
      pname = "doric-themes";
      ename = "doric-themes";
      version = "0.0.1.0.20250523.125158";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/doric-themes-0.0.1.0.20250523.125158.tar";
        sha256 = "1xl9jivjd275fjzhyfzvxn40035ryagm61j86h2l4srngzndfrb7";
      };
      packageRequires = [ ];
      meta = {
  ...
  el-job = callPackage (
    ...
    elpaBuild {
      pname = "el-job";
      ename = "el-job";
      version = "2.4.7.0.20250522.211041";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/el-job-2.4.7.0.20250522.211041.tar";
        sha256 = "1w07k7gfrpp2d4rxmmq54myb6hdm6g27km11lhl6r7ydb867b3fw";
      };
      packageRequires = [ ];
      meta = {
  ...
  indent-bars = callPackage (
    ...
    elpaBuild {
      pname = "indent-bars";
      ename = "indent-bars";
      version = "0.8.4.0.20250520.221247";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/indent-bars-0.8.4.0.20250520.221247.tar";
        sha256 = "0gwx23scdmfyfv5d1gqdm5s4akmfwkb8h8zcx8p4zbs1ws46zp7l";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.26.0.0.20250522.215926";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.26.0.0.20250522.215926.tar";
        sha256 = "14pc9dbjpskdb25fsay85ppd6dmmr21c987jmm85k2rybsh2pnzm";
      };
      packageRequires = [
        compat
        plz
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "6.3.0.20250523.154939";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-6.3.0.20250523.154939.tar";
        sha256 = "0bjlaagv91xvsgaljx98cx5whzmsci6hnzk26kj60zwfwlaipdzg";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250518.125740";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250518.125740.tar";
        sha256 = "0hcrqj1w0m2gsr30kgiyihf29add2lin0yqdj021h8di55q1bjbi";
      };
      packageRequires = [ ];
      meta = {
