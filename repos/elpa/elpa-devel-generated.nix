{ callPackage }:
{
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260427.201611";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260427.201611.tar";
        sha256 = "06h5vx5ggrhq8ghw4603fq2raql6njwq258xmwwdzqnbmfp6308r";
      };
      packageRequires = [ ];
      meta = {
  ...
  forgejo = callPackage (
    ...
    elpaBuild {
      pname = "forgejo";
      ename = "forgejo";
      version = "0.1.2.0.20260428.25409";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/forgejo-0.1.2.0.20260428.25409.tar";
        sha256 = "17xs0y7pi49z9pir2dhyqclk335fb508vf41ghldlk52p6d7xs4a";
      };
      packageRequires = [
        keymap-popup
        markdown-mode
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "1.4.0.20260424.153732";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-1.4.0.20260424.153732.tar";
        sha256 = "0wfd69n066jg5nicx6490w7dw68430zqah2xrw50ywxd3bvrp7h8";
      };
      packageRequires = [ ];
      meta = {
  ...
  keymap-popup = callPackage (
    ...
    elpaBuild {
      pname = "keymap-popup";
      ename = "keymap-popup";
      version = "0.2.1.0.20260428.10641";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/keymap-popup-0.2.1.0.20260428.10641.tar";
        sha256 = "064bjc6klj71lahskk1qci4nl0a9hdcmrnv1iz9mc1cwifb80h2k";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.30.1.0.20260427.213252";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.30.1.0.20260427.213252.tar";
        sha256 = "1nljfzxwymmqf1q6dfbpmbl0zn1s28ybaywx10y6zxq00ghpy3r8";
      };
      packageRequires = [
        compat
        plz
  ...
  marginalia = callPackage (
    ...
    elpaBuild {
      pname = "marginalia";
      ename = "marginalia";
      version = "2.10.0.20260426.65037";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/marginalia-2.10.0.20260426.65037.tar";
        sha256 = "0lf1i93fhxzf961awnlasjf09hym7973dmw8pn4wkabkwvcxc4im";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "8.2.0.0.20260427.205636";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-8.2.0.0.20260427.205636.tar";
        sha256 = "1g40vfc0wrklf4vlhi0vgvs6nnyj454symp04a3fcf353jnjlqrz";
      };
      packageRequires = [ ];
      meta = {
  ...
  minimail = callPackage (
    ...
    elpaBuild {
      pname = "minimail";
      ename = "minimail";
      version = "0.4.0.20260427.90919";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minimail-0.4.0.20260427.90919.tar";
        sha256 = "1q7asvxgs7pmjv5y83zg8zdgm4alasbzccy3fx4bl8k5p4hfia9x";
      };
      packageRequires = [ transient ];
      meta = {
  ...
  minuet = callPackage (
    ...
    elpaBuild {
      pname = "minuet";
      ename = "minuet";
      version = "0.7.1.0.20260427.215107";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minuet-0.7.1.0.20260427.215107.tar";
        sha256 = "0wrcl7y4lxsjn6i749wvd47gx2gsnc43zp25v0mc25mjv7zpkimj";
      };
      packageRequires = [
        dash
        plz
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.2.0.0.20260424.102723";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.2.0.0.20260424.102723.tar";
        sha256 = "1088b9c1nz7a7fxfk5pd3yjplx0cknvlxk4xz8if66rvrnq82pwx";
      };
      packageRequires = [ ];
      meta = {
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.3.0.0.20260424.102749";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.3.0.0.20260424.102749.tar";
        sha256 = "10d6m93hnivdk460zhzy3jlr2cqn84d60l0xh1f64dxi6kar8bbz";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.13.0.0.20260427.153726";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.13.0.0.20260427.153726.tar";
        sha256 = "0vwlxbi2hwi1b71inb0l5xyqqwzk27b42ch88nfc597kbxah5vdx";
      };
      packageRequires = [
        compat
        cond-let
