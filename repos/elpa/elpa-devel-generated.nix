{ callPackage }:
{
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250324.172107";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250324.172107.tar";
        sha256 = "0nila3plxr73h4w1vm08rjhngpswmfliiqmw8sdy3ggmmc80avzd";
      };
      packageRequires = [ ];
      meta = {
