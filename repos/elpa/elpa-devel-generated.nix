{ callPackage }:
{
  ...
  cape = callPackage (
    ...
    elpaBuild {
      pname = "cape";
      ename = "cape";
      version = "1.8.0.20241226.122047";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cape-1.8.0.20241226.122047.tar";
        sha256 = "0aq6lc1jsv9dsfpmkmhlkhzy06jp6fizf77k7z8d5a7c9vy9pq1z";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "1.9.0.20241227.120450";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-1.9.0.20241227.120450.tar";
        sha256 = "1vkd4j913kw9lfc4hwzlklhxxfdx0whfywhpzvc8n14f05pq0592";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "1.6.0.20241227.113734";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-1.6.0.20241227.113734.tar";
        sha256 = "1xiyv1z4y5xkdng26ldrrw9zyipc20w55vm0f8rq0lvnffvkv5kv";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.17.0.20241228.83031";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.17.0.20241228.83031.tar";
        sha256 = "0n1kv5xfzffgz8k158y7sp0xard7is6c81in9lsdxz1jp21kpahl";
      };
      packageRequires = [
        compat
        eldoc
  ...
  erc = callPackage (
    ...
    elpaBuild {
      pname = "erc";
      ename = "erc";
      version = "5.6.1snapshot0.20241228.83031";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/erc-5.6.1snapshot0.20241228.83031.tar";
        sha256 = "0lpm0z1wklc3hl8x0j9wkkllwqcjnic0w5xipxd7grmalxj7kk3v";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  flymake = callPackage (
    ...
    elpaBuild {
      pname = "flymake";
      ename = "flymake";
      version = "1.3.7.0.20241228.83031";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/flymake-1.3.7.0.20241228.83031.tar";
        sha256 = "0mp7i3qvk8jxmiy5w67nambkkdf8y942a4as6a5fbwq8r723idcs";
      };
      packageRequires = [
        eldoc
        project
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20241228.114120";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20241228.114120.tar";
        sha256 = "0qjv66l0qvq62624r3xypzqr2mi2s2w9lhpda5jgv0m2lx8wl72b";
      };
      packageRequires = [ ];
      meta = {
  ...
  relint = callPackage (
    ...
    elpaBuild {
      pname = "relint";
      ename = "relint";
      version = "2.0.0.20241228.202137";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/relint-2.0.0.20241228.202137.tar";
        sha256 = "1mf0glkrg7rcfpcnss5gf5ifp9hcs61b5jflzmqfbd2da73vy08j";
      };
      packageRequires = [ xr ];
      meta = {
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.1.0.0.20241228.104925";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-2.1.0.0.20241228.104925.tar";
        sha256 = "0m69cn850ab5nzb508prhjh8i2hq8z41klwyga4a67af38b794p3";
      };
      packageRequires = [ ];
      meta = {
  ...
  verilog-mode = callPackage (
    ...
    elpaBuild {
      pname = "verilog-mode";
      ename = "verilog-mode";
      version = "2024.10.9.140346409.0.20241228.83031";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/verilog-mode-2024.10.9.140346409.0.20241228.83031.tar";
        sha256 = "0ljkcdvnzg2r8k6lj4jiiwma7xhfkdjj5vjgwx4sz2vs2k0skq58";
      };
      packageRequires = [ ];
      meta = {
  ...
  which-key = callPackage (
    ...
    elpaBuild {
      pname = "which-key";
      ename = "which-key";
      version = "3.6.1.0.20241228.83031";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/which-key-3.6.1.0.20241228.83031.tar";
        sha256 = "0dnzswz77w368ypv3dys8kg8cshhgi3r4763z7vi7bqs0v8hzj6p";
      };
      packageRequires = [ ];
      meta = {
