{ callPackage }:
{
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "1.8.0.20241105.213352";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-1.8.0.20241105.213352.tar";
        sha256 = "0lkj5p0ymkpbk7jc2lxglxwx7pblhphb6l56zpng9zrasxb41yc3";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "1.5.0.20241105.213155";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-1.5.0.20241105.213155.tar";
        sha256 = "0cyfwyxplc30j2wkcmjzr51ydvvczy70g4851bjllbhdcz96zpvl";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "3.1.0.0.20241110.55801";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-3.1.0.0.20241110.55801.tar";
        sha256 = "0n91ykgymzbvp269d27dafmypv050iwf4bdsgr18v2kavy895yvy";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.8.0.0.20241106.55107";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.8.0.0.20241106.55107.tar";
        sha256 = "1a6b9njmwpm61pf4b9rd9bxk6ccv03bvahp6g4qq0c7wh3ad9nl7";
      };
      packageRequires = [ ];
      meta = {
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "1.4.0.20241105.213251";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-1.4.0.20241105.213251.tar";
        sha256 = "0a4af154xsa3cm62cnwhz4f63nbkhrngpxmai4v3g4g2s8l0f3k5";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  spacious-padding = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.5.0.0.20241022.54117";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/spacious-padding-0.5.0.0.20241022.54117.tar";
        sha256 = "0ay8p0ammhsnxigv4qrwnwwqgqzvhcm9200xnzma6qlxa3fck0ji";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.7.9.0.20241106.170325";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.7.9.0.20241106.170325.tar";
        sha256 = "0rm1219qn2jf46pc629s4byflcpfrbvzs3ddh8xqp4krsd8dawg9";
      };
      packageRequires = [
        compat
        seq
  ...
  which-key = callPackage (
    ...
    elpaBuild {
      pname = "which-key";
      ename = "which-key";
      version = "3.6.1.0.20241103.62529";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/which-key-3.6.1.0.20241103.62529.tar";
        sha256 = "12ifz14mhkyffg9z5l49nwvg20bnvxif4b6gfqiyxfb17cpmmlzg";
      };
      packageRequires = [ ];
      meta = {
  ...
  xref = callPackage (
    ...
    elpaBuild {
      pname = "xref";
      ename = "xref";
      version = "1.7.0.0.20241024.85007";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/xref-1.7.0.0.20241024.85007.tar";
        sha256 = "1mfacr80vx8dcmwyryx199v5rrz6w1njdjy1x56hsm0qwnqvqly2";
      };
      packageRequires = [ ];
      meta = {
