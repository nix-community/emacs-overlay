{ callPackage }:
{
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.2.3.0.20260828.24";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.2.3.0.20260828.24.tar";
        sha256 = "1hasgq010ql9v993c0qsay17hvl2frhqhdcislhpfspkfsk4lh0r";
      };
      packageRequires = [ ];
      meta = {
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.11.1.0.20260830.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.11.1.0.20260830.0.tar";
        sha256 = "08npynqki8gqa0w7ffqdizq7jjfscjpk3vlkzw6hjxvx5bmpg181";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  eev = callPackage (
    ...
    elpaBuild {
      pname = "eev";
      ename = "eev";
      version = "20260903.0.20260903.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eev-20260903.0.20260903.0.tar";
        sha256 = "1llaw01s3in9jpk64mh463jbxy0fmpi8nsfg7wwcvvhq9qffxrki";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.1.0.0.20260830.48";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.1.0.0.20260830.48.tar";
        sha256 = "16720hkl5liwkiyfxv970cxsbi79q0fnphlm069r5dj0qrq0ginb";
      };
      packageRequires = [ ];
      meta = {
  ...
  orderless = callPackage (
    ...
    elpaBuild {
      pname = "orderless";
      ename = "orderless";
      version = "1.7.0.20260830.6";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/orderless-1.7.0.20260830.6.tar";
        sha256 = "1srx0hyk1dp9zv7scn29bzfzm6gps5aywxx64x2ldw7w4mxa2mlb";
      };
      packageRequires = [ compat ];
      meta = {
