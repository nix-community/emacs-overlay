{ callPackage }:
{
  ...
  matlab-mode = callPackage (
    ...
    elpaBuild {
      pname = "matlab-mode";
      ename = "matlab-mode";
      version = "7.1.2.0.20251016.164406";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/matlab-mode-7.1.2.0.20251016.164406.tar";
        sha256 = "0gvp3cfx4nk6ynr9n8vrrrw02amcc2wcr7z3jcqp9h6sqmr93cz1";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.8.1.0.20251013.51246";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.8.1.0.20251013.51246.tar";
        sha256 = "0s38q1l4yba7cxlf8avc37szxjfiblnd65bnn5c6xnwyfqyy7fd0";
      };
      packageRequires = [ ];
      meta = {
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "1.8.0.20251013.102018";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-1.8.0.20251013.102018.tar";
        sha256 = "1rik27vi0vliwg0xxmwgk08rd684yb3f1sf2qqicsfnlxqkv69w1";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  xelb = callPackage (
    ...
    elpaBuild {
      pname = "xelb";
      ename = "xelb";
      version = "0.21.0.20251016.92144";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/xelb-0.21.0.20251016.92144.tar";
        sha256 = "1crfr2h1g8vz5208gp2s1r0p1c0c6391zbm1p8a5mizma150wx0h";
      };
      packageRequires = [ compat ];
      meta = {
