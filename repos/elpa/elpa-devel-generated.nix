{ callPackage }:
{
  ...
  bicep-ts-mode = callPackage (
    ...
    elpaBuild {
      pname = "bicep-ts-mode";
      ename = "bicep-ts-mode";
      version = "0.1.3.0.20250222.221719";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/bicep-ts-mode-0.1.3.0.20250222.221719.tar";
        sha256 = "17yijzykpb2hxvjgxhwmbv4jl5m27zcqiazpm6794sznnns8sjwd";
      };
      packageRequires = [ ];
      meta = {
  ...
  company = callPackage (
    ...
    elpaBuild {
      pname = "company";
      ename = "company";
      version = "1.0.2.0.20250223.35229";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/company-1.0.2.0.20250223.35229.tar";
        sha256 = "1mm4pmmnpzl1snz0zz2v1fbci3jy989792nwapi1mqa8vhd2vd54";
      };
      packageRequires = [ ];
      meta = {
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.22.0.0.20250223.4543";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.22.0.0.20250223.4543.tar";
        sha256 = "02r22paiynpc043sv19pj4p7la828ajjvmbd8d0cb91lz3wngylm";
      };
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.10.0.0.20250220.101";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.10.0.0.20250220.101.tar";
        sha256 = "1dk4lyir7s590r71n7x5bxks04qylf2s0191qfssxkzy4fp4i31w";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  eldoc = callPackage (
    ...
    elpaBuild {
      pname = "eldoc";
      ename = "eldoc";
      version = "1.15.0.0.20250222.233822";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eldoc-1.15.0.0.20250222.233822.tar";
        sha256 = "1jm86l0gah6fb2scc2w2dgn4mwx7hf4mxswxsgzgbf6vn5kc3d4k";
      };
      packageRequires = [ ];
      meta = {
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.3.0.0.20250222.141653";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.3.0.0.20250222.141653.tar";
        sha256 = "17khnkkvja9sgsv1r1frdihk51cnd4h6iz6xckcc4lqaibaqsjrs";
      };
      packageRequires = [
        compat
        llm
  ...
  hiddenquote = callPackage (
    ...
    elpaBuild {
      pname = "hiddenquote";
      ename = "hiddenquote";
      version = "1.2.0.20250222.185855";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hiddenquote-1.2.0.20250222.185855.tar";
        sha256 = "18dl98xj67r5jyg8pv1rawvawrla263y0vljmnl288662s89ah68";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250221.80824";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250221.80824.tar";
        sha256 = "04smcahcy3qd58ibbamyfdir3ahpb1y0mw107i03m5bqry7x3kph";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.23.0.0.20250218.223125";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.23.0.0.20250218.223125.tar";
        sha256 = "1yi2am7m16gsmny20vq48gz8511wcv4w6jis2m4m97xd1ispi4d0";
      };
      packageRequires = [
        plz
        plz-event-source
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250222.144116";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250222.144116.tar";
        sha256 = "0fziwr6dadh3i07r8rifypb2sflmhkzkmjdhgavqbp6fpkb7a5j0";
      };
      packageRequires = [ ];
      meta = {
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.28.0.20250222.134829";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.28.0.20250222.134829.tar";
        sha256 = "0j3lgwwlvvmi55fjihnkzqm8piy9w3n8ayd3d6swzj46250bx63z";
      };
      packageRequires = [
        compat
        seq
