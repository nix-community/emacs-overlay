{ callPackage }:
{
  ...
  indent-bars = callPackage (
    ...
    elpaBuild {
      pname = "indent-bars";
      ename = "indent-bars";
      version = "0.8.4.0.20250603.125246";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/indent-bars-0.8.4.0.20250603.125246.tar";
        sha256 = "17n95zs7bjsn1sqhmpag3y0cbh8gb31c9gc5v0zmsx0parzsgm7x";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  jinx = callPackage (
    ...
    elpaBuild {
      pname = "jinx";
      ename = "jinx";
      version = "2.2.0.20250617.112630";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jinx-2.2.0.20250617.112630.tar";
        sha256 = "1ff852dxynxhj6h2yyydh1jr1s6w1l2xbgkp0dyhkrf6mzhazfbm";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  kubed = callPackage (
    ...
    elpaBuild {
      pname = "kubed";
      ename = "kubed";
      version = "0.5.0.0.20250611.170006";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/kubed-0.5.0.0.20250611.170006.tar";
        sha256 = "12ka5dhb61j25w4l9cjasf79aiazwv55zm7xn07qskrnq5y5b89z";
      };
      packageRequires = [ ];
      meta = {
  ...
  minuet = callPackage (
    ...
    elpaBuild {
      pname = "minuet";
      ename = "minuet";
      version = "0.5.4.0.20250617.131903";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minuet-0.5.4.0.20250617.131903.tar";
        sha256 = "09fdgrzmxd4raf24d5vvnngwm6fpkbrhw7q1i9nc9lf6hiv55cv1";
      };
      packageRequires = [
        dash
        plz
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.9.2.0.20250616.183044";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.9.2.0.20250616.183044.tar";
        sha256 = "1i0k015zfbpmnafsca2yzywmaxrs1imwmiiizqyb80d4ps9bi2vq";
      };
      packageRequires = [
        compat
        seq
  ...
  vc-jj = callPackage (
    ...
    elpaBuild {
      pname = "vc-jj";
      ename = "vc-jj";
      version = "0.3.0.20250617.134817";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vc-jj-0.3.0.20250617.134817.tar";
        sha256 = "1lyydmpa6zp3hk2mahlvfy43jcsrk3xnf1hxvmfrbz3gm4rypyv2";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  xelb = callPackage (
    ...
    elpaBuild {
      pname = "xelb";
      ename = "xelb";
      version = "0.20.0.20250605.72834";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/xelb-0.20.0.20250605.72834.tar";
        sha256 = "1qfhybkc7m1g60rq53s6qfdz8nzn913zksvq43lss7h097gb668s";
      };
      packageRequires = [ compat ];
      meta = {
