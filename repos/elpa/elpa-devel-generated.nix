{ callPackage }:
  {
    ...
    embark = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "1.0.0.20240319.201003";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-1.0.0.20240319.201003.tar";
          sha256 = "1b1a28g5rl15maqk4kr1lg513r55kxiskd9j2l6r8pxyl6vrva3q";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ compat
      ...
      elpaBuild {
        ...
        version = "1.0.0.20240319.201003";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-1.0.0.20240319.201003.tar";
          sha256 = "0h4c4lnx2w77g3aqrivzzq0nznilnwz5dpy4h59f234mmxfaf4qc";
        };
    ...
    listen = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "listen";
        ename = "listen";
        version = "0.8pre0.20240318.4141";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/listen-0.8pre0.20240318.4141.tar";
          sha256 = "1wx4drhswnqc0sn8nz71b9v8484l3rxnp41wjr5d3fk14y6cv8b3";
        };
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "modus-themes";
        ename = "modus-themes";
        version = "4.4.0.0.20240320.65547";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/modus-themes-4.4.0.0.20240320.65547.tar";
          sha256 = "1dkb8bmi9aby0z2ml2c0c05x2a4x62884y5b1spxisfd15p6piy1";
        };
        packageRequires = [ emacs ];
        meta = {
