{ callPackage }:
{
  ...
  bnf-mode = callPackage (
    ...
    elpaBuild {
      pname = "bnf-mode";
      ename = "bnf-mode";
      version = "0.4.5.0.20240915.125256";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/bnf-mode-0.4.5.0.20240915.125256.tar";
        sha256 = "02z2s3dvmiaw8xhcl9lplhzjjhalb8ps5skjbh0gpg13y77flbal";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "1.5.0.20240912.173137";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-1.5.0.20240912.173137.tar";
        sha256 = "1rx7d1yzsq3xzlpyqlfc4jhbq5za1rb6kn3c4ny50lld6if65fkr";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "3.1.0.0.20240913.70608";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-3.1.0.0.20240913.70608.tar";
        sha256 = "0ab5kjlgbr3g078xcrba41cykprvhq2qiv5rc9n66bv9ssd58cpk";
      };
      packageRequires = [ ];
      meta = {
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.2.0.0.20240913.70752";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.2.0.0.20240913.70752.tar";
        sha256 = "16pb60z74vzzzl5q62xjddlb58rp4nzv4h9kwh8a37x39i3lj0x9";
      };
      packageRequires = [ ];
      meta = {
  ...
  eev = callPackage (
    ...
    elpaBuild {
      pname = "eev";
      ename = "eev";
      version = "20240811.0.20240905.54022";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eev-20240811.0.20240905.54022.tar";
        sha256 = "14diwab68kzbgcwgnwv8ii29gpk663fy9sbhy7c5ikc6cdm3h9ki";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "1.8.0.0.20240915.52105";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-1.8.0.0.20240915.52105.tar";
        sha256 = "0xhnp3awgiw00hbld6xywpa3v9z69f72arwaz1ry4d5jq0sw9zn6";
      };
      packageRequires = [ ];
      meta = {
  ...
  ement = callPackage (
    ...
    elpaBuild {
      pname = "ement";
      ename = "ement";
      version = "0.16pre0.20240910.194859";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ement-0.16pre0.20240910.194859.tar";
        sha256 = "0pdc89x9d4k1n4b440m21pmpx4f1kwkqr6p5gw7ci1hymsbvr0m1";
      };
      packageRequires = [
        map
        persist
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.5.0.0.20240908.43927";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.5.0.0.20240908.43927.tar";
        sha256 = "1dfad1hsdsaa67n0184lihc6bihb7dlsbzcsk4d9nr3kdfl6cd7i";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20240915.141059";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20240915.141059.tar";
        sha256 = "1bg7apxa350rvcgqas5nj6c6p0fz4rdfbn25hb8ai6dqvmk0jc5d";
      };
      packageRequires = [ ];
      meta = {
  ...
  pulsar = callPackage (
    ...
    elpaBuild {
      pname = "pulsar";
      ename = "pulsar";
      version = "1.1.0.0.20240913.71248";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/pulsar-1.1.0.0.20240913.71248.tar";
        sha256 = "0ld27ddca86zq7pmzzwjmqxd668s2w629zjfx7l64jqnp1rksqsa";
      };
      packageRequires = [ ];
      meta = {
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.28.0.20240908.161748";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.28.0.20240908.161748.tar";
        sha256 = "0lwcwiaf75fz9f7kcfbancg75yvcrcfyircdmgpzayw4l43s6ciy";
      };
      packageRequires = [
        compat
        seq
  ...
  taxy-magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.14.1.0.20240908.40452";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/taxy-magit-section-0.14.1.0.20240908.40452.tar";
        sha256 = "0qx8ylgfqibp8lqh4v4bajd1dyja73v6bq3fblfzd9vykqb2y44a";
      };
      packageRequires = [
        magit-section
        taxy
  ...
  tex-parens = callPackage (
    ...
    elpaBuild {
      pname = "tex-parens";
      ename = "tex-parens";
      version = "0.4.0.20240915.183749";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tex-parens-0.4.0.20240915.183749.tar";
        sha256 = "1wf3dzwv1nqv85v26zrklqdy2n4vfd0c4s6vllcg3l4wf5p4nv9r";
      };
      packageRequires = [ ];
      meta = {
