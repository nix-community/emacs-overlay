{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.6.0.20240904.183834";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.6.0.20240904.183834.tar";
        sha256 = "19kwvi23kyw8s7ic6kb8gh6cpphkjmlw20fc79ns4dz1jzvkijyr";
      };
      packageRequires = [ ];
      meta = {
  ...
  company = callPackage (
    ...
    elpaBuild {
      pname = "company";
      ename = "company";
      version = "0.10.2.0.20240906.162633";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/company-0.10.2.0.20240906.162633.tar";
        sha256 = "117bpq7swfcmdlqw46kxlsjhzka2g9mhw4qfxarx5jb2kmvj7iyv";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20240901.204705";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20240901.204705.tar";
        sha256 = "166860ggkaxybflv2d7vylniffgnb3488g9klxvr9scw5xn0m16m";
      };
      packageRequires = [ ];
      meta = {
  ...
  jinx = callPackage (
    ...
    elpaBuild {
      pname = "jinx";
      ename = "jinx";
      version = "1.10.0.20240824.81752";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jinx-1.10.0.20240824.81752.tar";
        sha256 = "0fxkmxnligbmwl0fcv80igvrk5n4w5zi48d3zlkqq2m4vk199irv";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.17.3.0.20240906.4239";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.17.3.0.20240906.4239.tar";
        sha256 = "0hqb83ml9slg9hjlhknfkz295m2j0wamjww4lrlrkxyz40mkzmi3";
      };
      packageRequires = [ plz ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.5.0.0.20240905.85755";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.5.0.0.20240905.85755.tar";
        sha256 = "1zxvwjiq7nwzc4z8y66hbzpjrsyyf50l467ryas5rhncjrf423bb";
      };
      packageRequires = [ ];
      meta = {
  ...
  phpinspect = callPackage (
    ...
    elpaBuild {
      pname = "phpinspect";
      ename = "phpinspect";
      version = "2.0.1.0.20240903.161704";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/phpinspect-2.0.1.0.20240903.161704.tar";
        sha256 = "1v4m5qz5vqwclf0y38m6zwlq31dpms8ad88kcm57p1ipz2nglfrv";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20240906.174333";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20240906.174333.tar";
        sha256 = "1m1ag9y0ljqb98mxlfk5rgpqz776s5l3dz8zrp2n7ns5ycc2za7n";
      };
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.28.0.20240831.81414";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.28.0.20240831.81414.tar";
        sha256 = "0dxil4xa82z9s5rnsic2yha329x7zxjslap7czxjl7pixfpv04wc";
      };
      packageRequires = [
        compat
        seq
