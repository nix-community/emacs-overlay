{ callPackage }:
{
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "10.0pre0.20260516.74412";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-10.0pre0.20260516.74412.tar";
        sha256 = "0zxpgqj5d0h79khd9llhmgnw3bg9rw7jqvm732nkicw8dxqf2hqx";
      };
      packageRequires = [ ];
      meta = {
