{ callPackage }:
{
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20241015.184810";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20241015.184810.tar";
        sha256 = "1blss5d2afd05fzy2xchvcy8b4qyfh287ybkg6kggdbmlaq6jpk9";
      };
      packageRequires = [ ];
      meta = {
