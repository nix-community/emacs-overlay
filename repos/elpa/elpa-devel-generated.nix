{ callPackage }:
{
  ...
  hiddenquote = callPackage (
    ...
    elpaBuild {
      pname = "hiddenquote";
      ename = "hiddenquote";
      version = "1.2.0.20250222.63202";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hiddenquote-1.2.0.20250222.63202.tar";
        sha256 = "1w0ijv51yd68sppyfzp8wdg017wj02pvsxkjdqjz8ckp581c55mf";
      };
      packageRequires = [ ];
      meta = {
