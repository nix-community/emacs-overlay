{ callPackage }:
{
  ...
  consult-denote = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.3.0.0.20250415.141824";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-denote-0.3.0.0.20250415.141824.tar";
        sha256 = "048c3ivbqaqq4j6caf7j78ydr8dwhydbazazp33i2qs81miryg8m";
      };
      packageRequires = [
        consult
        denote
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "2.0.0.20250415.61008";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-2.0.0.20250415.61008.tar";
        sha256 = "1cm7vk86lvrwih6sanjlr4lzmlvqql70cydwh7x5gnvz8cdjrmij";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.0.0.0.20250415.143211";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.0.0.0.20250415.143211.tar";
        sha256 = "085l0xdxbxhn39yx0v0frlcsq0fhyqzr3p3r9yza9nqpwrpzldhl";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote-journal = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.0.0.20250415.141342";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-journal-0.1.0.0.20250415.141342.tar";
        sha256 = "1bf6pvkhr6kcafyjasfjspz7nrjvqdn16gj1p54yhb6y1zd01jy0";
      };
  ...
  denote-markdown = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.0.0.20250415.141716";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-markdown-0.1.0.0.20250415.141716.tar";
        sha256 = "1qn60frfky5nvci4jh94d7n9022xnr7vpz0cb930nlvx4sybk91k";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  denote-org = callPackage (
    ...
    elpaBuild {
      pname = "denote-org";
      ename = "denote-org";
      version = "0.1.0.0.20250415.141604";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-org-0.1.0.0.20250415.141604.tar";
        sha256 = "1dd4qabq5z7gnl80p879q0sdm036xm9ariy6gvmnvlwc73mk248l";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  denote-sequence = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.0.0.20250415.141354";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-sequence-0.1.0.0.20250415.141354.tar";
        sha256 = "0n1v2crsiyjzw1sbwjrifn76rnfkf9vi4l3qgw50wgzjf53z89w7";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  denote-silo = callPackage (
    ...
    elpaBuild {
      pname = "denote-silo";
      ename = "denote-silo";
      version = "0.1.0.0.20250415.141146";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-silo-0.1.0.0.20250415.141146.tar";
        sha256 = "0pdj18prjqmncril8gxxl2zj5bck8hyh1qnij1zplsh88q304abv";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.5.1.0.20250418.45438";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.5.1.0.20250418.45438.tar";
        sha256 = "1ywv2ddjz5vd3f0802gakfg8s9am45fla45hja6kqgqiqrgbx1k9";
      };
      packageRequires = [ ];
      meta = {
  ...
  elisp-benchmarks = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.16.0.20250413.231914";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/elisp-benchmarks-1.16.0.20250413.231914.tar";
        sha256 = "07ph945j3is35jjhp359zyffx58h9g3wsm0gk7zgbmy37fy31p40";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250417.80204";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250417.80204.tar";
        sha256 = "14azd3wj8c9kz8p08p18qf49pav9w7pxxh03qrqyvakfkmrcyd8v";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.24.2.0.20250414.11130";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.24.2.0.20250414.11130.tar";
        sha256 = "057wcvxxp86bkhg73x6y9k8ix7pmjja9mxbdpq78l5msik9vs26h";
      };
      packageRequires = [
        plz
        plz-event-source
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "4.7.0.0.20250417.70615";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-4.7.0.0.20250417.70615.tar";
        sha256 = "1vzj4ja7zqyicwgyig2hkh6rvav26jfnrgxmfwgrc3n6sh0gyxqn";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250418.64419";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250418.64419.tar";
        sha256 = "01dilh4wyflx9agr0gcpsp164gqn861jqcjdlmv7syf3j6glingg";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-modern = callPackage (
    ...
    elpaBuild {
      pname = "org-modern";
      ename = "org-modern";
      version = "1.7.0.20250418.81443";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-modern-1.7.0.20250418.81443.tar";
        sha256 = "0cbg7nxz72rmlc4h97h7nm2rl6k94z4bf97c9h7jcp11ad3rkf6j";
      };
      packageRequires = [
        compat
        org
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.30.0.20250417.125649";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.30.0.20250417.125649.tar";
        sha256 = "0h199n9jhnzz9dp1kdp3g50ia1mn9kzviiilx45qixsazhigc0hb";
      };
      packageRequires = [
        compat
        flymake
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.1.0.0.20250418.54014";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.1.0.0.20250418.54014.tar";
        sha256 = "0bs6v2j3s3sh1zk8dh3im1ab3jjkms0wsl6pw1dy9zw4845qxd5a";
      };
      packageRequires = [ ];
      meta = {
  ...
  vc-jj = callPackage (
    ...
    elpaBuild {
      pname = "vc-jj";
      ename = "vc-jj";
      version = "0.2.0.20250418.135625";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vc-jj-0.2.0.20250418.135625.tar";
        sha256 = "0bn6f7al9z3y2clc5nsm7bvyzf5hli0c7mvghmjj456p6b541jkx";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  vertico = callPackage (
    ...
    elpaBuild {
      pname = "vertico";
      ename = "vertico";
      version = "2.0.0.20250415.60938";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vertico-2.0.0.20250415.60938.tar";
        sha256 = "1wnmdjahcqb618y6fs359jq1id9yzx95q61bhxs21jvz9h5k7x53";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  xeft = callPackage (
    ...
    elpaBuild {
      pname = "xeft";
      ename = "xeft";
      version = "3.4.0.20250417.163145";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/xeft-3.4.0.20250417.163145.tar";
        sha256 = "16rlz1yy4y5l2j5n0k5d5vsby3mxn3q2l8cyml6i5brma7nxsx4y";
      };
      packageRequires = [ ];
      meta = {
