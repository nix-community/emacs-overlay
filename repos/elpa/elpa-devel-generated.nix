{ callPackage }:
{
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.4.0.0.20250405.54921";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.4.0.0.20250405.54921.tar";
        sha256 = "1qx0nnz9afsn70rf1i5vb1rp93y8hggykq30a1x009hlnja15wxi";
      };
      packageRequires = [ ];
      meta = {
