{ callPackage }:
  {
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.12.0.0.20240603.162827";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.12.0.0.20240603.162827.tar";
          sha256 = "0fzrx1slpnz5vvksh0sysjjhgrwb3bbccaixni1q6kzsmyl2j4nw";
        };
    ...
    eglot = callPackage ({ compat
      ...
      elpaBuild {
        pname = "eglot";
        ename = "eglot";
        version = "1.17.0.20240603.155516";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eglot-1.17.0.20240603.155516.tar";
          sha256 = "0r2hhpzmxl4a2qkq296qpr1fdj9f60fxli9i6bz8dvbik5jh4qfd";
        };
        packageRequires = [
          compat
          eldoc
    ...
    ement = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ement";
        ename = "ement";
        version = "0.16pre0.20240530.230650";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ement-0.16pre0.20240530.230650.tar";
          sha256 = "017sgynx4f0b48d0whlkcymgvs02d3rcqsn979iqqwwgwhi3jwv0";
        };
        packageRequires = [
          emacs
          map
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6snapshot0.20240605.120638";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6snapshot0.20240605.120638.tar";
          sha256 = "0zp7klww043f0pcs4ic13lnz941r51gm1pn2caynpnvss4gwrj1z";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    jinx = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "jinx";
        ename = "jinx";
        version = "1.7.0.20240528.65240";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jinx-1.7.0.20240528.65240.tar";
          sha256 = "0qv1myad7maas5q7q6k0bp3y7khwj6wv2vwhnn6wrj6ghljcl3ns";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "modus-themes";
        ename = "modus-themes";
        version = "4.4.0.0.20240603.155416";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/modus-themes-4.4.0.0.20240603.155416.tar";
          sha256 = "1vwinqshwjyy8zvrff6rxxyk7r21wbdwa8agg7imnnfqks80c22h";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.8pre0.20240605.151110";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.8pre0.20240605.151110.tar";
          sha256 = "15nv4l644c2hmsaks5c8y94yp8i2r5crrfc9pzlx08p69x86dhv8";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    plz = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "plz";
        ename = "plz";
        version = "0.9pre0.20240603.162226";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/plz-0.9pre0.20240603.162226.tar";
          sha256 = "1c83x94qnls9jhii6cxp1b4fr8lb5zy3y00bwm1s4fjrrq0c5q9y";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    python = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        pname = "python";
        ename = "python";
        version = "0.28.0.20240526.82312";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/python-0.28.0.20240526.82312.tar";
          sha256 = "0xnp9n006yl123fig2fm8m26g7yd5m6md7a1h6p8nrqykp5fdysn";
        };
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.6.0.0.20240603.220034";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.6.0.0.20240603.220034.tar";
          sha256 = "00dlwz113hdqj4j8jg9z006v2gmz5gbrzdzbvpz06npgf1nv41w9";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
