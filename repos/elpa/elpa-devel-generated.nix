{ callPackage }:
{
  ...
  consult-denote = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.4.2.0.20251201.45705";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-denote-0.4.2.0.20251201.45705.tar";
        sha256 = "0rvqzl3n57143banam87xm1bqbrbb9xxzfrqr0j8v5dnf6l6f2s5";
      };
      packageRequires = [
        consult
        denote
  ...
  corfu = callPackage (
    ...
    elpaBuild {
      pname = "corfu";
      ename = "corfu";
      version = "2.6.0.20251207.172918";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/corfu-2.6.0.20251207.172918.tar";
        sha256 = "1899712s34hzbrf7dyw2b48jn9d9gxmgcgy4hnp4lgxx4z2i6n5m";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20251129.50811";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20251129.50811.tar";
        sha256 = "1d76lj2xrzb255904gamh7x3dqybxr09vpl7bmpggmpyvysywq15";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote-journal = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.2.0.20251201.50224";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-journal-0.2.2.0.20251201.50224.tar";
        sha256 = "1hd0z4dnd3iq8k3pnifz7wn7xka57jyykq2ggplspd1wmgmv9v4h";
      };
  ...
  denote-org = callPackage (
    ...
    elpaBuild {
      pname = "denote-org";
      ename = "denote-org";
      version = "0.2.1.0.20251201.50049";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-org-0.2.1.0.20251201.50049.tar";
        sha256 = "01vclgrgvrxhp07j7b0cdhiclxg203sv8zf73s3kja37siv1bvmi";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  denote-sequence = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.0.0.20251201.151726";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-sequence-0.2.0.0.20251201.151726.tar";
        sha256 = "16wy720yn63iq2szn1m7a7wjj9kx1q2h7njqw17yava3bvqzx5s8";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  denote-silo = callPackage (
    ...
    elpaBuild {
      pname = "denote-silo";
      ename = "denote-silo";
      version = "0.2.0.0.20251129.150806";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-silo-0.2.0.0.20251129.150806.tar";
        sha256 = "08s7n097bqr4ma6add25lcfi3p9phjkkv3mr89rxj367bf00frrb";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  eglot = callPackage (
    ...
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.19.0.20251130.135230";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eglot-1.19.0.20251130.135230.tar";
        sha256 = "1nnx1imid5yyrsx48a203dg4rx0d41lzh8jla8glghy1vfg3kxav";
      };
      packageRequires = [
        eldoc
        external-completion
  ...
  ess = callPackage (
    ...
    elpaBuild {
      pname = "ess";
      ename = "ess";
      version = "25.1.0.0.20251129.104426";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ess-25.1.0.0.20251129.104426.tar";
        sha256 = "0q2b7xi53d9j00rcw5amdn9dlv056k8xmvhmn3c9s1bf43h07b9s";
      };
      packageRequires = [ ];
      meta = {
  ...
  exwm = callPackage (
    ...
    elpaBuild {
      pname = "exwm";
      ename = "exwm";
      version = "0.34.0.20251204.204418";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/exwm-0.34.0.20251204.204418.tar";
        sha256 = "1g2qcz3xaanpq3qqln89b54gw5dhhp7lbz2xmnr1afwgbhfnn55f";
      };
      packageRequires = [
        compat
        xelb
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20251206.230314";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20251206.230314.tar";
        sha256 = "1jkq4brj8wjdma68ik94zmk940d1nvhk12bvh40yv5dr4yx5x9p9";
      };
      packageRequires = [ ];
      meta = {
  ...
  listen = callPackage (
    ...
    elpaBuild {
      pname = "listen";
      ename = "listen";
      version = "0.10pre0.20251129.115339";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/listen-0.10pre0.20251129.115339.tar";
        sha256 = "16famlqja7qgwgj4af4nb4hyyc0npydddzlah4rylq2irhxljg2h";
      };
      packageRequires = [
        persist
        taxy
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.28.0.0.20251207.112237";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.28.0.0.20251207.112237.tar";
        sha256 = "1am3mv2jh0l0klas3sz3hm5ckv7pgrp0a6civmfnifga4rpsh8p7";
      };
      packageRequires = [
        compat
        plz
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.1.0.0.20251206.75942";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.1.0.0.20251206.75942.tar";
        sha256 = "0sgr4nrjrs87i7yczchpfqw48r7iwgjgx5c7vz5l36dj6zzm4gv8";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20251207.195940";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20251207.195940.tar";
        sha256 = "1ivwl38rc15mhnbxink0l41rbv21kaf0ax3bmaj797yc1prxyiy8";
      };
      packageRequires = [ ];
      meta = {
  ...
  org-modern = callPackage (
    ...
    elpaBuild {
      pname = "org-modern";
      ename = "org-modern";
      version = "1.10.0.20251130.104412";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-modern-1.10.0.20251130.104412.tar";
        sha256 = "1pkakp770mn4b4p0dl8zl3jk3z8qpx08lwd1w8cf9yj1wr7hpgpd";
      };
      packageRequires = [
        compat
        org
  ...
  org-transclusion = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.4.0.0.20251208.45108";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-transclusion-1.4.0.0.20251208.45108.tar";
        sha256 = "0q7r01ys9rspr6fk5vxx3im5h5vq0sh5i6ak1mkrdqq3ph5byfyv";
      };
      packageRequires = [ org ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20251130.183251";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20251130.183251.tar";
        sha256 = "0x00krw83z5h3n1ic592qn4n44g7wkvbani1f2dbvajkpbcsh83h";
      };
  ...
  substitute = callPackage (
    ...
    elpaBuild {
      pname = "substitute";
      ename = "substitute";
      version = "0.4.0.0.20251129.90529";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/substitute-0.4.0.0.20251129.90529.tar";
        sha256 = "10jpsgn1nkhnyc429a2mf7kbxg5p000khri1vp51xwgyh8z50dzb";
      };
      packageRequires = [ ];
      meta = {
  ...
  termint = callPackage (
    ...
    elpaBuild {
      pname = "termint";
      ename = "termint";
      version = "0.2.0.20251130.152027";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/termint-0.2.0.20251130.152027.tar";
        sha256 = "04a7qa6p75g72r4is5p33bhxqc2n3assqbslx3ylc891k2pyag0b";
      };
      packageRequires = [ ];
      meta = {
  ...
  tramp-hlo = callPackage (
    ...
    elpaBuild {
      pname = "tramp-hlo";
      ename = "tramp-hlo";
      version = "0.0.1.0.20251207.5705";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tramp-hlo-0.0.1.0.20251207.5705.tar";
        sha256 = "1i7m2v89lmc8rkk1l9xamsfn7i779csdwb3p2vhc6zbry5xp7hqk";
      };
  ...
  vc-jj = callPackage (
    ...
    elpaBuild {
      pname = "vc-jj";
      ename = "vc-jj";
      version = "0.4.0.20251207.43717";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vc-jj-0.4.0.20251207.43717.tar";
        sha256 = "0gbcayknvc0nhjsrfygpvrwww7vcqdhbwr3w7yviz3swv74skfwq";
      };
      packageRequires = [ compat ];
      meta = {
