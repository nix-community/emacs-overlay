{ callPackage }:
  {
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "consult";
        ename = "consult";
        version = "1.2.0.20240214.122908";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/consult-1.2.0.20240214.122908.tar";
          sha256 = "1ppfsng65bcfa2cq0n0fn56p6fqhirj25gmpl6hplhcrq5aamrll";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "eev";
        ename = "eev";
        version = "20240205.0.20240218.215933";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eev-20240205.0.20240218.215933.tar";
          sha256 = "0jlqyvqwsnqy86gxjxrls2xybsj2h3386ry54wfnac1nfmc193rx";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ellama = callPackage ({ dash
      ...
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.8.4.0.20240218.134236";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.8.4.0.20240218.134236.tar";
          sha256 = "1a6rc8lm68jly87jc7wd1swh0g497clcj184rjcwqjnlk0199g6x";
        };
    ...
    embark = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "1.0.0.20240218.144436";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-1.0.0.20240218.144436.tar";
          sha256 = "1h88v999drgw52vama2wh4scb4sjcyaja85xpyhdl45rd5xs2hr6";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ compat
      ...
      elpaBuild {
        ...
        version = "1.0.0.20240218.144436";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-1.0.0.20240218.144436.tar";
          sha256 = "07q8kn0lh2sxjwzdnfyjvzqdr58dz4i99p9nwagh0adjqbx0dc5p";
        };
    ...
    filechooser = callPackage ({ compat
      ...
      elpaBuild {
        pname = "filechooser";
        ename = "filechooser";
        version = "0.1.1.0.20240218.215614";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/filechooser-0.1.1.0.20240218.215614.tar";
          sha256 = "1jimnv78kr5dxfzwv8zwmkcsinkhdqyhldbl9ahz651c1fsqfwih";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    fontaine = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "fontaine";
        ename = "fontaine";
        version = "1.0.0.0.20240219.61437";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/fontaine-1.0.0.0.20240219.61437.tar";
          sha256 = "1g16kzvhaj3ph04zn2fkdzdvrjq33la44nnfipha84ir8k2gmdbw";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240219.82806";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240219.82806.tar";
          sha256 = "0ji2i74bc9in4sar2x6wg9zfbhbh7ywcnhijj8anh5msk1g5d3wi";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    which-key = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "which-key";
        ename = "which-key";
        version = "3.6.0.0.20240208.213645";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/which-key-3.6.0.0.20240208.213645.tar";
          sha256 = "0n2nry2xvl8xkbf9nmibc6lj1i1nnzljcni6zvz7nhnnnmwhn6iy";
        };
        packageRequires = [ emacs ];
        meta = {
