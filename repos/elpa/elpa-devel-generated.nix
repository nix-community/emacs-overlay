{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.1.2.0.20260311.14839";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.1.2.0.20260311.14839.tar";
        sha256 = "0a70vp7midrsi7scl63cfv6b7vqf29d0wjnb30ah6majyw1jb8nr";
      };
      packageRequires = [ ];
      meta = {
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "1.2.0.20260314.230536";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-1.2.0.20260314.230536.tar";
        sha256 = "0jyqhbs52rank430748v08smfgivvfrwra49kw3k1ag5a9fxv5bv";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20260314.202139";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20260314.202139.tar";
        sha256 = "1f5k2fj9i76im6y53gbiri7wkxar9vdpp6j1sz3fkamhd3ajxj0y";
      };
      packageRequires = [ ];
      meta = {
  ...
  modus-themes = callPackage (
    ...
    elpaBuild {
      pname = "modus-themes";
      ename = "modus-themes";
      version = "5.2.0.0.20260314.85729";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/modus-themes-5.2.0.0.20260314.85729.tar";
        sha256 = "1jkv8y9f1aqrsi9xy6jf0java7m89ijna7k3p0vxw21rwh5rfw39";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.12.0.0.20260310.203658";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.12.0.0.20260310.203658.tar";
        sha256 = "144irjj47xqwpy0469jzbzkhilb9yspz05bmwkkzzpjfn5qhxqcj";
      };
      packageRequires = [
        compat
        cond-let
  ...
  use-package = callPackage (
    ...
    elpaBuild {
      pname = "use-package";
      ename = "use-package";
      version = "2.4.6.0.20260313.225005";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/use-package-2.4.6.0.20260313.225005.tar";
        sha256 = "1zxgi6pwpazm22r2rjq20506szl98fq0qmg3bp2wfry1svadrlzm";
      };
