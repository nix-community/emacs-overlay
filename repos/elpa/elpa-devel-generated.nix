{ callPackage }:
  {
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "consult";
        ename = "consult";
        version = "0.35.0.20231110.92639";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/consult-0.35.0.20231110.92639.tar";
          sha256 = "13nb32x34318r2cys6nhzxzs9ywlzq2kw7bqz0rcn15nn4rjmgrz";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "0.23.0.20231111.182732";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-0.23.0.20231111.182732.tar";
          sha256 = "1nfa17prc5iz42dkn2yyy2445agm8vg2lfm1if6cwnks8qhsqqkg";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ consult
      ...
      elpaBuild {
        ...
        version = "0.8.0.20231111.182732";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-0.8.0.20231111.182732.tar";
          sha256 = "1yjpkng35pw120k3ihdk4pq9kllw3gn8kkzkknfcizlgvc4b940q";
        };
    ...
    srht = callPackage ({ elpaBuild, emacs, fetchurl, lib, plz }:
      elpaBuild {
        pname = "srht";
        ename = "srht";
        version = "0.3.0.20231111.235341";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/srht-0.3.0.20231111.235341.tar";
          sha256 = "03yz3yfh3idwvnx4py6dxvwvw9dxdxjfw5grv6fnlhzba9n8cj31";
        };
        packageRequires = [ emacs plz ];
        meta = {
    ...
    vertico = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vertico";
        ename = "vertico";
        version = "1.4.0.20231112.81633";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vertico-1.4.0.20231112.81633.tar";
          sha256 = "1bd09rynkgcib98sd7jgcbmgdqhg1gq89lckvyz4dy4z45lndcdr";
        };
        packageRequires = [ compat emacs ];
        meta = {
