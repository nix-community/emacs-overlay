{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.6.0.20240907.215717";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.6.0.20240907.215717.tar";
        sha256 = "0x718y580xn86qkgfv80xn7jbc6lyvc0832jplz0dqi5h6v3kmbx";
      };
      packageRequires = [ ];
      meta = {
  ...
  cape = callPackage (
    ...
    elpaBuild {
      pname = "cape";
      ename = "cape";
      version = "1.7.0.20240826.165046";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/cape-1.7.0.20240826.165046.tar";
        sha256 = "1h5296fncb2lqnbpxb6n37xvkj5h3zavdvm7d10halv7yj6vg8p8";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  company = callPackage (
    ...
    elpaBuild {
      pname = "company";
      ename = "company";
      version = "0.10.2.0.20240909.115835";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/company-0.10.2.0.20240909.115835.tar";
        sha256 = "1w7a2y31bcbbypbyn2d4kgshi3vms8zmm3vxa9ll6l5hh50wch9z";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "1.8.0.20240824.80054";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-1.8.0.20240824.80054.tar";
        sha256 = "0rcj75y6z7rn7is0nbhbfj2db0jppz051ypxjmmcbkg7x718pfq6";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  debbugs = callPackage (
    ...
    elpaBuild {
      pname = "debbugs";
      ename = "debbugs";
      version = "0.40.0.20240905.111828";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/debbugs-0.40.0.20240905.111828.tar";
        sha256 = "0jpgy5mzbn81zgkrgifshzny875grizxg61jyh6r1jim5sdaamjs";
      };
  ...
  ement = callPackage (
    ...
    elpaBuild {
      pname = "ement";
      ename = "ement";
      version = "0.16pre0.20240909.35000";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ement-0.16pre0.20240909.35000.tar";
        sha256 = "1cc5wvp37cwagnjc4s4g2289jl37ldn97di58l8ydhv8piwhmvhq";
      };
      packageRequires = [
        map
        persist
  ...
  fontaine = callPackage (
    ...
    elpaBuild {
      pname = "fontaine";
      ename = "fontaine";
      version = "2.1.0.0.20240902.75748";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/fontaine-2.1.0.0.20240902.75748.tar";
        sha256 = "1fbw9rlgrs7b16mgj0hyz5w4l8zjz3kx7mh67dcsx5kcycnsj354";
      };
      packageRequires = [ ];
      meta = {
  ...
  lin = callPackage (
    ...
    elpaBuild {
      pname = "lin";
      ename = "lin";
      version = "1.1.0.0.20240905.154128";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/lin-1.1.0.0.20240905.154128.tar";
        sha256 = "1xf69cdmxif8q6b8id2mv3d358kb3gz97i44ga950l5y9nln23rz";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20240831.133113";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20240831.133113.tar";
        sha256 = "0ig84pn2hjl3l31v7j09b3yag3nxjwrp2hb928d0y6ylgn51knn9";
      };
      packageRequires = [ ];
      meta = {
  ...
  preview-auto = callPackage (
    ...
    elpaBuild {
      pname = "preview-auto";
      ename = "preview-auto";
      version = "0.3.0.20240906.80544";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/preview-auto-0.3.0.20240906.80544.tar";
        sha256 = "0qjbni9a40sbizq0bklkqd0aqjgj10idkvgmrnh9hpxsy56kgbxn";
      };
      packageRequires = [ auctex ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20240909.174321";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20240909.174321.tar";
        sha256 = "1g869plsgbnfixz4ikdcal02qi06xchjf993blhj2v8sfkqvdaca";
      };
  ...
  pulsar = callPackage (
    ...
    elpaBuild {
      pname = "pulsar";
      ename = "pulsar";
      version = "1.1.0.0.20240829.181935";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/pulsar-1.1.0.0.20240829.181935.tar";
        sha256 = "0963zniiyshb31zb0yary1fm58kqv7cdc7gkpl26xmkvvd9gw701";
      };
      packageRequires = [ ];
      meta = {
  ...
  show-font = callPackage (
    ...
    elpaBuild {
      pname = "show-font";
      ename = "show-font";
      version = "0.1.1.0.20240910.61712";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/show-font-0.1.1.0.20240910.61712.tar";
        sha256 = "0z6xx5vplsvgi7fmdczhfn1363gygr36vfh1swm5q7dn74a5q560";
      };
      packageRequires = [ ];
      meta = {
