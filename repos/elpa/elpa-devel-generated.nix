{ callPackage }:
{
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250721.185554";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250721.185554.tar";
        sha256 = "1rym2bzw0iafihnj83cy1qv8zcmchfd3ily3xaqq3p25c0wilgxa";
      };
      packageRequires = [ ];
      meta = {
