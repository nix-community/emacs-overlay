{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.0.6.0.20240824.210653";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.0.6.0.20240824.210653.tar";
        sha256 = "19l64qrlzk5jl1lk186hvh00rkanmvvgmiyagnfyaqali10c19sj";
      };
      packageRequires = [ ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20240824.201406";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20240824.201406.tar";
        sha256 = "1h14v3dxhsd1irz667515i0n267xqb3p71fd9qizld5wc95zbrxq";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20240822.123715";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20240822.123715.tar";
        sha256 = "1bfm0v59bjbak269hsrycmdwhywm6m854x67h5qvcbzimnpxk9wr";
      };
      packageRequires = [ ];
      meta = {
  ...
  use-package = callPackage (
    ...
    elpaBuild {
      pname = "use-package";
      ename = "use-package";
      version = "2.4.6.0.20240824.60447";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/use-package-2.4.6.0.20240824.60447.tar";
        sha256 = "0dlgl3yxk9acxg6fxv1h23dn6i27cjfgysxp44jv10p9y42777yd";
      };
