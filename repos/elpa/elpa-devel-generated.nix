{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.17.4.0.20241109.95059";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.17.4.0.20241109.95059.tar";
        sha256 = "0wmlhm7hzywg1kg80k20vymhk4kbcsqr5yqjcw998hs153qy6r1z";
      };
      packageRequires = [
        plz
        plz-event-source
