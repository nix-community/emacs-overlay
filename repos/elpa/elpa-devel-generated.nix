{ callPackage }:
  {
    ...
    brief = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib, nadvice }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1il64cb6gklsv66dcw0ays9i8cmzip4in8m2h8fdw639vz4jx6n8";
        };
    ...
    cape = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "cape";
        ename = "cape";
        version = "1.4.0.20240331.3042";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/cape-1.4.0.20240331.3042.tar";
          sha256 = "0hp3h2xgxf3ygmgnggzyyppac2pxrqz1dbdzwaxdm6rcqcjz2d97";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    comint-mime = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0iqch1cwvzbhwr1pa5jqzbnfxp4czq57hlj1q2b5vr129rqcygqx";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    compat = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0zfrwhmspqdlrjdgp1apxx0mz2hip9zgwm8zdmh91jzd9sx8bqq0";
        };
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1djln9il7660b3ijydbhwaxqfgywz72dalmqxpq3bgxal6ck123q";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    context-coloring = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1d1q8ssi6rfscxhhr45w2rgj7fpjvn3kc58106qfij19d34l31zh";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    counsel = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0zgl6id332vpsm2j82ryzgwh5wkz47s3pi6xp6pwni1hbnncqlc1";
        };
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0hf2nnk0zh9jjmd09bqsbmki19df4ajcqfijf4i90r8ypl2z6lb2";
        };
    ...
    dash = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1qj7h40nnghyl7hf3w2jxw6c6djxizd3xpshgy70pbm9q9zdkda8";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    dired-preview = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "068rh7mn4cjkd3c5rg6m3zr4wpknnism7ivl7n9dsrrdls7jai09";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    drepl = callPackage ({ comint-mime, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0fs67fd6pqnj8dks4abqszhzg338f16mxq87nvgssx6mv43pf02k";
        };
    ...
    ef-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "15vnn1r2lxw8ss5k82ff2r3nwjqa75r4mmpgj4h7hgxnk1rii4n7";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    elisp-benchmarks = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "13jic5jpp3a1lmnmgdpb7894yjxgkldhqnh86flqnk2iab335rrf";
        };
        packageRequires = [];
        meta = {
    ...
    embark = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "embark";
        ename = "embark";
        version = "1.0.0.20240327.80802";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-1.0.0.20240327.80802.tar";
          sha256 = "1zixjry4njzahgcl0d90vjgsjb3bmlxkxvjpqxyyizr6jq38iqzc";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    embark-consult = callPackage ({ compat
      ...
      elpaBuild {
        ...
        version = "1.0.0.20240327.80802";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/embark-consult-1.0.0.20240327.80802.tar";
          sha256 = "0j116xhjbwwij3lzm001f5y830g7ifk5cn89d2lqhz1x314aacw5";
        };
    ...
    ement = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ement";
        ename = "ement";
        version = "0.15pre0.20240331.144417";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ement-0.15pre0.20240331.144417.tar";
          sha256 = "1n6bslciwa82kd6afff68xi8x521xfgpmq5zwsi5qwyygvmkhwvr";
        };
        packageRequires = [
          emacs
          map
    ...
    flymake = callPackage ({ eldoc
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "089xsp6ix46vi2n0xb9i9vjwg7g791m6m1lgzii1dr15pf6yhf77";
        };
    ...
    gtags-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1s2nfrg5axriq9bn6lazb4hw72fsk084p9dm4qy8b8mk9p9f232h";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    hyperbole = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "hyperbole";
        ename = "hyperbole";
        version = "9.0.2pre0.20240331.172630";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20240331.172630.tar";
          sha256 = "1pkld95mg02pyp6nmbvw1af039vsx4jibg341w70lwnhz79kysk1";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    js2-mode = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "18l5nrcnhwzl7yhvzwdificswmslkhdml47xh15zdwqw4vvi3y9v";
        };
        packageRequires = [ cl-lib emacs ];
        meta = {
    ...
    jsonrpc = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1jairhc5x00k72aybyzj9nkrx7ba8cpcs1x9a9jd530xxc6q0ji0";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    modus-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "06bhkcpqz2hq1hdprd4hsxjd4ji67xsfy80wpykvm0h72zyzzbqy";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    mpdired = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "mpdired";
        ename = "mpdired";
        version = "2pre0.20240329.151739";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/mpdired-2pre0.20240329.151739.tar";
          sha256 = "06zs97p45qjiqnbi58s2j9c3gfs2s0803sf60n9hkhcj1f5diaxi";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    orderless = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "13fzbcavf179qz2z48q7ip0k8yy5w1fzxnvam0z9vbxg1fpzzfc4";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240331.115049";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240331.115049.tar";
          sha256 = "1bz4iqg8kcb9yx6r0wp288sfrrh7rpk6bwvwqlpiagvwcyqh6qpf";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    phps-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0giba07kkkiylmx1v5scgyaldn0vknlkf4yck16sg1y5wlk40358";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    python = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "17wlgmjmkig4farfv0lhnqg937szcys6phgnvbhwwd472ldrw2a9";
        };
    ...
    relint = callPackage ({ elpaBuild, emacs, fetchurl, lib, xr }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0420sglfq7rgmcrb6ccbaxmm5h6cr5ckc68rc7xbkdcqih43ls9w";
        };
    ...
    sm-c-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "0gz7brgf1hpdlnnxg3qxzgxr9hajd1l4ak9hnaab3qp1jw2dhf75";
        };
        packageRequires = [];
        meta = {
    ...
    standard-themes = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1cfnv2wnpxhbbcaiijv133nqh7an655a727wcg88637b4vqi8b7j";
        };
        packageRequires = [ emacs ];
        meta = {
