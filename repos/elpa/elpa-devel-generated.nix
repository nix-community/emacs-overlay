{ callPackage }:
{
  ...
  ellama = callPackage (
    ...
    elpaBuild {
      pname = "ellama";
      ename = "ellama";
      version = "1.0.3.0.20250213.84044";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ellama-1.0.3.0.20250213.84044.tar";
        sha256 = "0cn6c52vpjfqxfyv8ibvlk41d40a85r3xpzvc5lxlpgfndxsf4q1";
      };
      packageRequires = [
        compat
        llm
