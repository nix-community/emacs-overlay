{ callPackage }:
{
  ...
  consult-denote = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.3.1.0.20251014.84316";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-denote-0.3.1.0.20251014.84316.tar";
        sha256 = "18z8rcxi81hg2vzpg2266cbnrzazk8mj5qc8byhl99vjkq4s4ly6";
      };
      packageRequires = [
        consult
        denote
  ...
  exwm = callPackage (
    ...
    elpaBuild {
      pname = "exwm";
      ename = "exwm";
      version = "0.34.0.20251014.123634";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/exwm-0.34.0.20251014.123634.tar";
        sha256 = "1s1204sqrljnkqqnbyjva8q1adznfpcskg9hq6yiqgh99xypadc7";
      };
      packageRequires = [
        compat
        xelb
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20251014.80402";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20251014.80402.tar";
        sha256 = "189xlq30hzryjaklfx3bdznzs90sig2zalml5h411sppy7fddkh6";
      };
      packageRequires = [ ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.27.2.0.20251012.204133";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.27.2.0.20251012.204133.tar";
        sha256 = "0pkaik92sgjlch1iq41rqrr1xisksqy8zba615whzp1jww1k3mrx";
      };
      packageRequires = [
        compat
        plz
