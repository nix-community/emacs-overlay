{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.29.0.0.20260402.142127";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.29.0.0.20260402.142127.tar";
        sha256 = "0pc8vli2n8gsynjvw5a8ynjaahbc0yi6lrp6d5900kg8bca5k1x3";
      };
      packageRequires = [
        compat
        plz
