{ callPackage }:
  {
    ...
    async = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "async";
        ename = "async";
        version = "1.9.8.0.20240617.60448";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/async-1.9.8.0.20240617.60448.tar";
          sha256 = "1f4lggg23jnhrlawc67bpp91ix1vikkvhf0qdjfjqm8n76kz66in";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6.1snapshot0.20240627.63618";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6.1snapshot0.20240627.63618.tar";
          sha256 = "087ki7agz54arqaf3gg33kir7552fg3df7cq6dmfd7rgiyr5ix8p";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.8pre0.20240627.130719";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.8pre0.20240627.130719.tar";
          sha256 = "1kaagpa8j4igidl4c6xa0jgrp4ny6a9wm1yl1diiciawipzrqp29";
        };
        packageRequires = [ emacs ];
        meta = {
