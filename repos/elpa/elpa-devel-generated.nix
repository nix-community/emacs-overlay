{ callPackage }:
{
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.28.3.0.20251225.95738";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.28.3.0.20251225.95738.tar";
        sha256 = "0dgyvl12jgl3xvy3cmnwz5m9p8y9dx47nphn5gaxb18x96vyspdc";
      };
      packageRequires = [
        compat
        plz
