{ callPackage }:
  {
    ...
    compat = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "compat";
        ename = "compat";
        version = "29.1.4.5.0.20240708.50127";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/compat-29.1.4.5.0.20240708.50127.tar";
          sha256 = "0gpqhvjnymcza35xwrmwl68ics9p7x6n2fjrxz1djqavx9lfwhwf";
        };
