{ callPackage }:
{
  ...
  auctex = callPackage (
    ...
    elpaBuild {
      pname = "auctex";
      ename = "auctex";
      version = "14.1.0.0.20260107.114117";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auctex-14.1.0.0.20260107.114117.tar";
        sha256 = "1f3bl9rryhf9vikp1zqv3q9v1k2l8768y57znsyciqwraxi2fmdy";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "3.1.0.20260105.162457";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-3.1.0.20260105.162457.tar";
        sha256 = "1rxnppjs2zblkl0147rwpdcjspm6c42r8z4i5mm21ldyjk0c2klv";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.28.5.0.20260106.233129";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.28.5.0.20260106.233129.tar";
        sha256 = "1n1a00xg9jqvnk57jchhbcn4j3sal1li0dk1jzbm917k4xw2kjw0";
      };
      packageRequires = [
        compat
        plz
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "2.1.0.20260109.181725";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-2.1.0.20260109.181725.tar";
        sha256 = "0i85k0asj7f0hpblvv01mnllab1y3iinl9504pyi17s9wiyh3w0w";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.2.0.20260109.135133";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.2.0.20260109.135133.tar";
        sha256 = "0bssq6300fnyrbw52nfz7h59qg5qi78i1rk7dj0cd99mza8jjcr8";
      };
  ...
  standard-themes = callPackage (
    ...
    elpaBuild {
      ...
      version = "3.0.2.0.20260109.170200";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/standard-themes-3.0.2.0.20260109.170200.tar";
        sha256 = "0ghfmck0dszvi6fb1g488jm3pyl8m9ri156zgzhn7nr0zqkwicz1";
      };
      packageRequires = [ modus-themes ];
      meta = {
  ...
  vc-jj = callPackage (
    ...
    elpaBuild {
      pname = "vc-jj";
      ename = "vc-jj";
      version = "0.5.0.20260109.135413";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/vc-jj-0.5.0.20260109.135413.tar";
        sha256 = "0gqmn60pn61grxba8qm87a5aknyvfld43lpb23m18v188lck1vw3";
      };
      packageRequires = [ compat ];
      meta = {
