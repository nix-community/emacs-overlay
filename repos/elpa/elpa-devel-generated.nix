{ callPackage }:
  {
    ...
    async = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "async";
        ename = "async";
        version = "1.9.8.0.20240629.55006";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/async-1.9.8.0.20240629.55006.tar";
          sha256 = "1jk3z2z6avgsrxza25c45yhbssl74b29sbhzsi4zdipq5k3l6civ";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    auctex = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "auctex";
        ename = "auctex";
        version = "14.0.5.0.20240627.121349";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/auctex-14.0.5.0.20240627.121349.tar";
          sha256 = "0fsayhmzxdblm7jq3mi4vgiyql062s8l1vsjz3hsxw2yb7c1irr3";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    dape = callPackage ({ elpaBuild, emacs, fetchurl, jsonrpc, lib }:
      elpaBuild {
        pname = "dape";
        ename = "dape";
        version = "0.12.0.0.20240629.180135";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/dape-0.12.0.0.20240629.180135.tar";
          sha256 = "14znflr65l24xpf4s6rzy007sbwkn51c19j15pc42h0lpz9gw6ra";
        };
    ...
    denote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "denote";
        ename = "denote";
        version = "2.3.5.0.20240625.83828";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/denote-2.3.5.0.20240625.83828.tar";
          sha256 = "0rm0y32g5zwh20xzz77vk8zlz9azknnkwwj8wsfhv68rg04wqh24";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "eev";
        ename = "eev";
        version = "20240513.0.20240530.51811";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eev-20240513.0.20240530.51811.tar";
          sha256 = "0jfdr7l6l71fxbwrmvcxiwvl5g43yz8fzdmlfx39li3s62xlkgkk";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    eglot = callPackage ({ compat
      ...
      elpaBuild {
        pname = "eglot";
        ename = "eglot";
        version = "1.17.0.20240622.94636";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/eglot-1.17.0.20240622.94636.tar";
          sha256 = "1f3gvcwx53b0qbsfzjsl3hcbqdwja2pwy02dza9s2vgc6s6cf9nx";
        };
        packageRequires = [
          compat
          eldoc
    ...
    ellama = callPackage ({ elpaBuild, emacs, fetchurl, lib, llm, spinner }:
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.10.0.0.20240629.92142";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.10.0.0.20240629.92142.tar";
          sha256 = "0l4dpxa03l6vsrfcqx04fmn0w2a4xfshkb2xhrsdh91yvknp8vlj";
        };
    ...
    ement = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ement";
        ename = "ement";
        version = "0.16pre0.20240606.124442";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ement-0.16pre0.20240606.124442.tar";
          sha256 = "0qx78zm0w7jx9pgw1lh02mr59bh0lzkvs0wkycnj6y6p1pijlqfk";
        };
        packageRequires = [
          emacs
          map
    ...
    emms = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        pname = "emms";
        ename = "emms";
        version = "20.0.20240612.182324";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/emms-20.0.20240612.182324.tar";
          sha256 = "1ab1klixgzgkjj9jp8jwk2l452ipr2q6pf60ilnf38wp9kvfv5q9";
        };
    ...
    erc = callPackage ({ compat
      ...
      elpaBuild {
        pname = "erc";
        ename = "erc";
        version = "5.6.1snapshot0.20240628.64658";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/erc-5.6.1snapshot0.20240628.64658.tar";
          sha256 = "1z8hc43wayb4iqg2bklcpr37hyr9i3fww9ir5n2f7qnfgnrqf5fv";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    greader = callPackage ({ compat
      ...
      elpaBuild {
        pname = "greader";
        ename = "greader";
        version = "0.11.9.0.20240629.113848";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/greader-0.11.9.0.20240629.113848.tar";
          sha256 = "05wi4bm5glgrf89hrd0nzrz0afydwiva29m64brdfwf5r4bz41qy";
        };
    ...
    hyperbole = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "hyperbole";
        ename = "hyperbole";
        version = "9.0.2pre0.20240623.2532";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20240623.2532.tar";
          sha256 = "1zibllp6r3cjas7mgv549srccjlnydg9izj6wvh17x655wnwwap4";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    jinx = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "jinx";
        ename = "jinx";
        version = "1.9.0.20240629.85829";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/jinx-1.9.0.20240629.85829.tar";
          sha256 = "17c29am1j5i1ifjk7r2szi9h4an2crxvj0hmjhlc12yg3lmlr8r8";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    llm = callPackage ({ elpaBuild, emacs, fetchurl, lib, plz }:
      elpaBuild {
        pname = "llm";
        ename = "llm";
        version = "0.16.1.0.20240609.224731";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/llm-0.16.1.0.20240609.224731.tar";
          sha256 = "0sb9ahfgxcr7rjq78bgyiwivrg5p87pha9cv7b2dfj30c2vgdvk5";
        };
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.8pre0.20240628.94240";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.8pre0.20240628.94240.tar";
          sha256 = "1nimws86gacidnfmn992d46g569rg60sjk9qpws6lk48kgqqic2i";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    python = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        pname = "python";
        ename = "python";
        version = "0.28.0.20240629.193724";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/python-0.28.0.20240629.193724.tar";
          sha256 = "11ax1jpy6ymc421w9gjzh0hq5fcfmpwr3gyql75r0glqdw3cmppp";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    tex-parens = callPackage ({ auctex
      ...
      elpaBuild {
        pname = "tex-parens";
        ename = "tex-parens";
        version = "0.3.0.20240629.14342";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/tex-parens-0.3.0.20240629.14342.tar";
          sha256 = "0ql42hb79pkx270q5xvzsl8yhmkpl17kp9lzhq8vzabgghqdwrcz";
        };
        packageRequires = [ auctex emacs ];
        meta = {
    ...
    transient = callPackage ({ compat
      ...
      elpaBuild {
        pname = "transient";
        ename = "transient";
        version = "0.7.2.0.20240629.115609";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/transient-0.7.2.0.20240629.115609.tar";
          sha256 = "066l7m05lvhndmviv2hci38nzaj2scmcw1iha5piw7i1ggrm0zjk";
        };
        packageRequires = [ compat emacs seq ];
        meta = {
    ...
    vertico = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "vertico";
        ename = "vertico";
        version = "1.8.0.20240629.92116";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/vertico-1.8.0.20240629.92116.tar";
          sha256 = "142bh2pd27lxqxdcg7y8cyshmvg7ry26qm3g6jdksgbvp9qnycl6";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    xref = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "xref";
        ename = "xref";
        version = "1.7.0.0.20240627.64234";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/xref-1.7.0.0.20240627.64234.tar";
          sha256 = "1zpzbyaam0hra0d5lr7wf3bn98y221aa9xhagf98gj2pi6mgj003";
        };
        packageRequires = [ emacs ];
        meta = {
