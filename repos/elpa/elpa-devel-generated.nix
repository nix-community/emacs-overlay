{ callPackage }:
{
  ...
  bicep-ts-mode = callPackage (
    ...
    elpaBuild {
      pname = "bicep-ts-mode";
      ename = "bicep-ts-mode";
      version = "0.1.4.0.20250313.105706";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/bicep-ts-mode-0.1.4.0.20250313.105706.tar";
        sha256 = "0gp0w02j1klva4cnbx2cn5vskbjl3a28ib0kvhpwh9h9iip9yacr";
      };
      packageRequires = [ ];
      meta = {
