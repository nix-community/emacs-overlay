{ callPackage }:
  {
    ...
    denote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "denote";
        ename = "denote";
        version = "2.2.4.0.20240214.80233";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/denote-2.2.4.0.20240214.80233.tar";
          sha256 = "1q9iq6vxr9z16dfwlfwrgqjkwz34frnkkikdcsi22rg5zyqhw4ms";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    ilist = callPackage ({ elpaBuild, fetchurl, lib }:
      elpaBuild {
        pname = "ilist";
        ename = "ilist";
        version = "0.2.0.20240213.134157";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ilist-0.2.0.20240213.134157.tar";
          sha256 = "1mfrwvf50wd3z9sa52dfc4kz6yndz5lr8khf955n2ai61hq2fs12";
        };
        packageRequires = [];
        meta = {
    ...
    org = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "org";
        ename = "org";
        version = "9.7pre0.20240213.115938";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-9.7pre0.20240213.115938.tar";
          sha256 = "1z7gdmxbq2mz5ylbd8gdj9gmwz9vilwd0pwsmzh00kz7d73xjafw";
        };
        packageRequires = [ emacs ];
        meta = {
