{ callPackage }:
{
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.17.0.0.20241130.161407";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.17.0.0.20241130.161407.tar";
        sha256 = "0sf1q3jqy3i58mjb9whbx5p39mcxag3ng1i8vqk6y8n6hxva6z3c";
      };
