{ callPackage }:
{
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.0.0.0.20250503.122017";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.0.0.0.20250503.122017.tar";
        sha256 = "17n8nqghgfxxqqs2hmjx88wnwg4j1hrwvgzw5cz6z2pr3kii3kz3";
      };
      packageRequires = [ ];
      meta = {
  ...
  denote-org = callPackage (
    ...
    elpaBuild {
      pname = "denote-org";
      ename = "denote-org";
      version = "0.1.1.0.20250503.122045";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-org-0.1.1.0.20250503.122045.tar";
        sha256 = "0in02zn18dbxfi3x2qzp89c9cgy4z5fwi7snyvkn03rw0h7406ih";
      };
      packageRequires = [ denote ];
      meta = {
  ...
  diff-hl = callPackage (
    ...
    elpaBuild {
      pname = "diff-hl";
      ename = "diff-hl";
      version = "1.10.0.0.20250503.21033";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/diff-hl-1.10.0.0.20250503.21033.tar";
        sha256 = "1wj8d72vl7ki5qds5x6v7i2jxpdiwkzsa81nvb1jlyjcl91qh59c";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20250502.132545";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20250502.132545.tar";
        sha256 = "1slw6g9m7555cpywm60ymlpgsslgv6a4zm54l7i5k85i44nx3y2j";
      };
      packageRequires = [ ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "9.8pre0.20250503.180801";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-9.8pre0.20250503.180801.tar";
        sha256 = "127ig0b9a4f9gmr832r9fmhm290h33d8n697ihd88ghzk24694ai";
      };
      packageRequires = [ ];
      meta = {
