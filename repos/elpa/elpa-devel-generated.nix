{ callPackage }:
  {
    ...
    consult = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        pname = "consult";
        ename = "consult";
        version = "1.7.0.20240702.43048";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/consult-1.7.0.20240702.43048.tar";
          sha256 = "0qxw5qcv5dyisxy181w567qf2dwq2qx2jd1bzasf3fhhkr6s3nqs";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    ellama = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "ellama";
        ename = "ellama";
        version = "0.11.2.0.20240705.212012";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/ellama-0.11.2.0.20240705.212012.tar";
          sha256 = "19a7cpa5zwpf7k7wqwk0m8w89srhncqkr73f2clqv6j0q8krcdly";
        };
    ...
    llm = callPackage ({ elpaBuild, emacs, fetchurl, lib, plz }:
      elpaBuild {
        pname = "llm";
        ename = "llm";
        version = "0.16.1.0.20240705.231922";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/llm-0.16.1.0.20240705.231922.tar";
          sha256 = "18wpdwcqjba2inm80vlkmq5d4zrrhs1qqwl0xav0s5pkca88ynvx";
        };
    ...
    org-modern = callPackage ({ compat
      ...
      elpaBuild {
        pname = "org-modern";
        ename = "org-modern";
        version = "1.3.0.20240702.142305";
        src = fetchurl {
          url = "https://elpa.gnu.org/devel/org-modern-1.3.0.20240702.142305.tar";
          sha256 = "0fyyk8wa7d9f28wga7x25xbvrqxj8l0rh182w81156abci634dig";
        };
        packageRequires = [ compat emacs ];
        meta = {
