{ callPackage }:
{
  ...
  dirvish = callPackage (
    ...
    elpaBuild {
      pname = "dirvish";
      ename = "dirvish";
      version = "2.2.7.0.20250415.70601";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dirvish-2.2.7.0.20250415.70601.tar";
        sha256 = "10kwi0anh2wiid8mn9ii81j5x7vb926naadws1jir99amw7w8dl9";
      };
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250418.111210";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250418.111210.tar";
        sha256 = "0bli29pndg2rr8rlq0ip1jxyvpfw1bdn7gcvv4b6kz3qpj9727y0";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.2.0.20250418.194417";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.2.0.20250418.194417.tar";
        sha256 = "1vs2r1ws9girq8whi5g81amfd93z1yd62a1y8xxslg0gym4x3513";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.2.0.20250418.194417";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.2.0.20250418.194417.tar";
        sha256 = "0ir957gpmkshxgz0pa0lrlcf7hzh6lgx22kk9kqsh1yj1410zma3";
      };
  ...
  proof-general = callPackage (
    ...
    elpaBuild {
      pname = "proof-general";
      ename = "proof-general";
      version = "4.6snapshot0.20250404.211622";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/proof-general-4.6snapshot0.20250404.211622.tar";
        sha256 = "1w7mcmd57kw8ayl1rdnm3kx5ml9zm0b4qlm30c17js4z3vwxm11g";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "26.11.20250418094205.0.20250418.94543";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-26.11.20250418094205.0.20250418.94543.tar";
        sha256 = "1rz749zx85lgipaajhw4fmhx29n0i9qjmvx35n41jfkk2xfzh7c5";
      };
      packageRequires = [ ];
      meta = {
