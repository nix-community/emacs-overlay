{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.2.0.20260618.21";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.2.0.20260618.21.tar";
        sha256 = "18fb8slgqr44pyq8njh9ix45nqgarnr6j76qxwahy9cim41lab9m";
      };
      packageRequires = [
        clojure-mode
        compat
