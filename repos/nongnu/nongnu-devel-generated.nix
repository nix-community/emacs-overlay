{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.15.1.0.20240909.195107";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.15.1.0.20240909.195107.tar";
        sha256 = "1cxx1d5ngn1vg4q1mwxss9nk2xypg4fi3snwfl8ll6al35810hg3";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.0.0.20240923.3543";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.0.0.20240923.3543.tar";
        sha256 = "02llwk744qkmvhnf2im3vlfiyqaxhgyanws5n6f617fgn6g5yvpk";
      };
      packageRequires = [
        compat
        transient
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.0.20240922.24808";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.0.20240922.24808.tar";
        sha256 = "117k222fpy016yl1yd45albm5jjjr2jazp9mcdhjx0mmim2w4iv5";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20240923.62033";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20240923.62033.tar";
        sha256 = "1ch3j8dz64w481asyhm8knp7xjk661ldncd8bf9l0cb3ikn1iqrd";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20240923.62033";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20240923.62033.tar";
        sha256 = "0ccggb3h2p981vp4sy45h10iqakrfisnp5xn3rk1lfzw2flq0k79";
      };
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.1.0.0.20240920.113516";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.1.0.0.20240920.113516.tar";
        sha256 = "05bmq9xr2p83mjcbkdnb8kmh5xf8z8vaczzws7sd1h6kff3bg3cj";
      };
      packageRequires = [
        compat
        dash
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.1.0.0.20240920.113516";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.1.0.0.20240920.113516.tar";
        sha256 = "1mdvdd5xpl9d0qi2kf2i7k2fwjj1kpjxnrpw3ivw6d0la2figvjh";
      };
      packageRequires = [
        compat
        dash
  ...
  package-lint = callPackage (
    ...
    elpaBuild {
      pname = "package-lint";
      ename = "package-lint";
      version = "0.23.0.20240919.164757";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/package-lint-0.23.0.20240919.164757.tar";
        sha256 = "0abiqc7p5c0dw9ikgnc2gacaki4gynj16xl524c8q5i9l5yi63a4";
      };
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20240921.204525.tar";
        sha256 = "0k9k70d5wh4zqin4l9csm3fcw61sz4lhnwmh1npi83aa762k0grw";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "26.1.20240916184601.0.20240916.191301";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-26.1.20240916184601.0.20240916.191301.tar";
        sha256 = "01wy7sn7ia0wwhj2lk0yyp6wjk7s83q4mvbpszr71w395wdfwrdn";
      };
      packageRequires = [ ];
      meta = {
