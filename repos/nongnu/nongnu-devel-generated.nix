{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.16.0.0.20241031.74951";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.16.0.0.20241031.74951.tar";
        sha256 = "0c4zq5xl3y5l63vwam9s79gg0qyis2wpybczni28w3pprv4kpv6n";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  hyperdrive = callPackage (
    ...
    elpaBuild {
      pname = "hyperdrive";
      ename = "hyperdrive";
      version = "0.5pre0.20241030.233214";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/hyperdrive-0.5pre0.20241030.233214.tar";
        sha256 = "1i80a3ax3i0n4645yhcjcr9l87cnw920lcbzs0l595rfmgfxxhz7";
      };
      packageRequires = [
        compat
        map
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20241030.84822.tar";
        sha256 = "1sgc124c8r2p006gqm1xkjf2xgj962q758wb1sd91q2qz0y4ipzw";
      };
      packageRequires = [ ];
      meta = {
  ...
  spacemacs-theme = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.0.20241025.153658";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/spacemacs-theme-0.2.0.20241025.153658.tar";
        sha256 = "0cyqf028q6gb02ikjvddcz4sxkrvjydsn7y0j5m5zavs0lqi8lhg";
      };
      packageRequires = [ ];
      meta = {
