{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.5.0.20260605.31";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.5.0.20260605.31.tar";
        sha256 = "1zm0ln4ypxmspx2jbj2vw0vnri4kbynzsgkg6b040bwwqf6k2gr5";
      };
      packageRequires = [
        compat
        transient
