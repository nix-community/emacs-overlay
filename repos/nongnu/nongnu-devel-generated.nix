{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250605.113509";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250605.113509.tar";
        sha256 = "04428d41brvrkvm6pnfg5vp10rmcr500brkkwjk7rhkixaz988yh";
      };
      packageRequires = [
        compat
        transient
