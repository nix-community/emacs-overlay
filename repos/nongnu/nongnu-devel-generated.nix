{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20250208.115900";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20250208.115900.tar";
        sha256 = "1fhb638il45l6486z8gi4y18s270003x5asb7pp94x9hn2gc8mf5";
      };
      packageRequires = [
        compat
        transient
