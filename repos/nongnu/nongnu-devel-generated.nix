{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251002.112939";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251002.112939.tar";
        sha256 = "0pgg0pzksykgvm6kb118b67ikrsikzpdmssi38snmx41nlys1ph0";
      };
      packageRequires = [
        compat
        transient
