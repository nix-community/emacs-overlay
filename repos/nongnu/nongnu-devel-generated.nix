{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.0.20260616.162";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.0.20260616.162.tar";
        sha256 = "0xg0fyzfwjc6xjh6rd7b9kl83xx08x6c9dsjixch4h1q6hb9clfd";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "4.0.1.0.20260616.12";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-4.0.1.0.20260616.12.tar";
        sha256 = "0pkdg5mmkb69lzmbjidfn9r6fsz4iizqpby3cq7ycb6bv9mfa59y";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.5.0.20260614.41";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.5.0.20260614.41.tar";
        sha256 = "0yhibwmir3v9x9v1k732da7p6ymh5az2kpjzlsh620mnyswc0v0w";
      };
      packageRequires = [
        compat
        transient
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.11.0.0.20260614.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.11.0.0.20260614.1.tar";
        sha256 = "1r6ra2j9dvzrfzwy0lagcgjd946fxjgvpy054fndb6zkg6xxmik8";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260615.298";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260615.298.tar";
        sha256 = "098g9634bs3s0i45kmwnma4dh7jwbx39yia5advk9m4z1b0wcd0x";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260615.298";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260615.298.tar";
        sha256 = "1znksj461lsfv6aq3v8iw2s9q50nafj2xnfmbns1y9p78lzl4phg";
      };
      packageRequires = [
        compat
        cond-let
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.10.0.20260615.120";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.10.0.20260615.120.tar";
        sha256 = "09m9z7abgxyh2ybkwvj0q3hikn75mx2cvcvy9x75ychq7q2zz44n";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  sesman = callPackage (
    ...
    elpaBuild {
      pname = "sesman";
      ename = "sesman";
      version = "0.3.30.20260615.20";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/sesman-0.3.30.20260615.20.tar";
        sha256 = "0vq9iajg5908ivg2k9q66bd251micxxxhrj2cr3719p6ds264v2d";
      };
      packageRequires = [ ];
      meta = {
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.5.1.0.20260601.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.5.1.0.20260601.0.tar";
        sha256 = "1dsj78w2nnh227w42xcvr8hgsbfhdkh0ym4d2kmkf8cgm9q600lz";
      };
      packageRequires = [
        compat
        cond-let
