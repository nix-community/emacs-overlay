{ callPackage }:
{
  ...
  clojure-mode = callPackage (
    ...
    elpaBuild {
      pname = "clojure-mode";
      ename = "clojure-mode";
      version = "5.21.0.0.20260219.165015";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-mode-5.21.0.0.20260219.165015.tar";
        sha256 = "0r8n73mvr3r7fi4xw5vl0y6bcb6kxngdpwp6fafdaf495qrx0bbv";
      };
      packageRequires = [ ];
      meta = {
