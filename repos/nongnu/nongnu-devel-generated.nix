{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250407.11854";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250407.11854.tar";
        sha256 = "0889v60pgdxrld1gn3s5gdzwxyg03wgd4yx9qyw1cn16q3l7y0dy";
      };
      packageRequires = [
        compat
        transient
