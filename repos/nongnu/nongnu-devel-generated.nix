{ callPackage }:
{
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "3.9.9.0.20240807.162713";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-3.9.9.0.20240807.162713.tar";
        sha256 = "0b7jwncaa1pa0i1572p5ckb7vi0cxg1km0a55lbkzgz24647k3v0";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "3.9.9.0.20240807.162713";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-3.9.9.0.20240807.162713.tar";
        sha256 = "0lsf9k9wlmf9bjhd74n32y11iy6cxr1jlrgcmpfragvv2m5lm2f7";
      };
  ...
  hyperdrive = callPackage (
    ...
    elpaBuild {
      pname = "hyperdrive";
      ename = "hyperdrive";
      version = "0.4pre0.20240805.191942";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/hyperdrive-0.4pre0.20240805.191942.tar";
        sha256 = "003gp5xmyknz9szxzhwbhsr1arsq6a1b4kkwsznqyswh252w5yck";
      };
      packageRequires = [
        compat
        map
