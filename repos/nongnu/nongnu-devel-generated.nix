{ callPackage }:
{
  ...
  meow = callPackage (
    ...
    elpaBuild {
      pname = "meow";
      ename = "meow";
      version = "1.4.5.0.20241016.71820";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/meow-1.4.5.0.20241016.71820.tar";
        sha256 = "19p4sd9rhcx7zjbb3vwcqkhsfd02k139wsm0qkrl6d4zllsb2qk9";
      };
      packageRequires = [ ];
      meta = {
