{ callPackage }:
{
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.8.0.20260123.211017";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.8.0.20260123.211017.tar";
        sha256 = "1zi34dj8dcp0qdxhh48797nbiwwmdd63601k4xs2gwwjs3i0v3rq";
      };
      packageRequires = [
        compat
        emacsql
