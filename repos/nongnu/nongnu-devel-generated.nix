{ callPackage }:
{
  ...
  subed = callPackage (
    ...
    elpaBuild {
      pname = "subed";
      ename = "subed";
      version = "1.4.1.0.20260309.133148";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/subed-1.4.1.0.20260309.133148.tar";
        sha256 = "1m2h59p649w6kcnwlqmiy6y02pb52fj84mwbsfdqnwsfhk77i6dw";
      };
      packageRequires = [ ];
      meta = {
