{ callPackage }:
{
  adoc-mode = callPackage (
    ...
    elpaBuild {
      pname = "adoc-mode";
      ename = "adoc-mode";
      version = "0.8.0snapshot0.20260221.80845";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/adoc-mode-0.8.0snapshot0.20260221.80845.tar";
        sha256 = "1kqjlv38wfj93bd3ack3jvpdgx8qw8h1gj6rvhr12mj3zy17cwjp";
      };
      packageRequires = [ ];
      meta = {
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.6.0.0.20260220.71513";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.6.0.0.20260220.71513.tar";
        sha256 = "0h1226zpbdcscg1dliyyddxg92rvj846724q29x29pvnk081j3lj";
      };
      packageRequires = [ ];
      meta = {
