{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.0snapshot0.20260427.221856";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.0snapshot0.20260427.221856.tar";
        sha256 = "19c70rss1nzgsnwksgjwpjbxfik35jjk2p7f68qp33kj7mc4i3sq";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  geiser = callPackage (
    ...
    elpaBuild {
      pname = "geiser";
      ename = "geiser";
      version = "0.32.0.20260426.185045";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/geiser-0.32.0.20260426.185045.tar";
        sha256 = "0sg3cbsxnzkah7slh8hn55ysl2d9vi9zqw0hznpbbgf77w3x2rx3";
      };
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.10.0snapshot0.20260427.75828";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.10.0snapshot0.20260427.75828.tar";
        sha256 = "1rmmp4m18863i9sngqlfb4c064gwb3wgb7g8y6cij4xg57yr3scp";
      };
      packageRequires = [ compat ];
      meta = {
