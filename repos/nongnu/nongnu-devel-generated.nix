{ callPackage }:
{
  adoc-mode = callPackage (
    ...
    elpaBuild {
      pname = "adoc-mode";
      ename = "adoc-mode";
      version = "0.8.0.0.20260601.27";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/adoc-mode-0.8.0.0.20260601.27.tar";
        sha256 = "0095f88hf6z44mp7k8hgpyzl6wzlsfa9w0fwd8v2fpm9764qr9b3";
      };
      packageRequires = [ ];
      meta = {
