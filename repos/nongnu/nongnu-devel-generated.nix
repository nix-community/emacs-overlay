{ callPackage }:
{
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.0.20240916.133920";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.0.20240916.133920.tar";
        sha256 = "1w0mqvs0p3hql9b9p2r4dr6pc5lcr9ciks6ilml5ipav6xrs241v";
      };
      packageRequires = [ ];
      meta = {
