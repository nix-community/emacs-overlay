{ callPackage }:
{
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "4.1.0.0.20260730.11";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-4.1.0.0.20260730.11.tar";
        sha256 = "0jz2adygxb0p1hgglvrf1jghyfy36zdidgmzcz6az721qh7vmbwq";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.7.0.20260729.39";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.7.0.20260729.39.tar";
        sha256 = "1p6rkarzdpwm5zk0mifh351gkwrh4w1wp3ws425y65nclxsgx3f8";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.7.0.20260729.39";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.7.0.20260729.39.tar";
        sha256 = "09zf2a9j5vgrfalhcmx067xq3p1kmys189sa4vgfc5rdh88iyp9l";
      };
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.12.5.0.20260731.9";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.12.5.0.20260731.9.tar";
        sha256 = "0kv99a9lflav98y22drwnwj7i8p2m5dgqj70v7ywpk0s2pbyxjfl";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  orgit = callPackage (
    ...
    elpaBuild {
      pname = "orgit";
      ename = "orgit";
      version = "2.2.0.0.20260729.2";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/orgit-2.2.0.0.20260729.2.tar";
        sha256 = "1pl4acbin9ilcsjfkp87bx9m9yralyjgzzc51p3b4z42cg750y5l";
      };
      packageRequires = [
        compat
        cond-let
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.5.2.0.20260730.9";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.5.2.0.20260730.9.tar";
        sha256 = "1cm8l3clisn8lar9hfakq98xfvj22l79r0xad4fx62z7b8k2wm1l";
      };
      packageRequires = [
        compat
        cond-let
