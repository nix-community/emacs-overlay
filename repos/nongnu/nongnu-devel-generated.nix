{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.19.0snapshot0.20250702.110638";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.19.0snapshot0.20250702.110638.tar";
        sha256 = "14dk7sflj0q5pfwfpcqc14ysc21nb17a2f3lxpna4i26k2hban1q";
      };
      packageRequires = [
        clojure-mode
        parseedn
