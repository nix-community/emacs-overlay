{ callPackage }:
{
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20240825.80925";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20240825.80925.tar";
        sha256 = "1wdqzw5zckwglkpn1agvrsd6kjbqipvmjx0ccyd71109dpyrx0z5";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20240825.80925";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20240825.80925.tar";
        sha256 = "0qfm0mklrni35zb7g42c6xw15mq75gi0k2lajsix4zd6a08gq7aq";
      };
  ...
  hyperdrive = callPackage (
    ...
    elpaBuild {
      pname = "hyperdrive";
      ename = "hyperdrive";
      version = "0.4pre0.20240823.223236";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/hyperdrive-0.4pre0.20240823.223236.tar";
        sha256 = "0x5cjiw7vxcwb86z5vgy8n9zxxraqn3039lfxqjl885fvkgj22vf";
      };
      packageRequires = [
        compat
        map
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.9.0snapshot0.20240824.102915";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.9.0snapshot0.20240824.102915.tar";
        sha256 = "014k43mx6sln5003cmhvaciwrjfcr0yqszr9n88z5zsd9hn62jzm";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20240825.102113";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20240825.102113.tar";
        sha256 = "11s4xp56v8swg6q8fk6d7fxc811hnir40jajhpvlm4h73s0k4ng8";
      };
      packageRequires = [ ];
      meta = {
