{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.0.0.20250317.150639";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.0.0.20250317.150639.tar";
        sha256 = "1ix2vnbjsf92vhn0h5c6jfkf38bdjy9lyrl1xm1jrisfr7wi2rw4";
      };
      packageRequires = [
        compat
        transient
  ...
  dirvish = callPackage (
    ...
    elpaBuild {
      pname = "dirvish";
      ename = "dirvish";
      version = "2.2.7.0.20250316.103016";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dirvish-2.2.7.0.20250316.103016.tar";
        sha256 = "17gvxbqz107srgss9771ywbqbwwxjv8lfh3w53m3hwygn2qp49n5";
      };
      packageRequires = [ ];
      meta = {
  ...
  evil = callPackage (
    ...
    elpaBuild {
      pname = "evil";
      ename = "evil";
      version = "1.15.0.0.20250316.90803";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/evil-1.15.0.0.20250316.90803.tar";
        sha256 = "0q2cnrvfwxibklp55p0sx642jffipz43fvc0mqbzwy2jsf8bkv1b";
      };
      packageRequires = [
        cl-lib
        goto-chg
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250317.101615";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250317.101615.tar";
        sha256 = "0d0n56w9jifv86na52bzbi8mnkqs2a5r04f2d3563x7vg0b4kh9x";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.2.0.20250314.72024";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.2.0.20250314.72024.tar";
        sha256 = "034dq5xq5niy5hphf3b1fsvagy86jrkjh71hffc7fh2sv45ihdh2";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.2.0.20250314.72024";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.2.0.20250314.72024.tar";
        sha256 = "0jk7nk0g5d5acsa9nbb92bxzdsaqlh06vpabwd875igjapy0zzw9";
      };
  ...
  meow = callPackage (
    ...
    elpaBuild {
      pname = "meow";
      ename = "meow";
      version = "1.5.0.0.20250315.140727";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/meow-1.5.0.0.20250315.140727.tar";
        sha256 = "077qhyjby2mnaazpd8q54b9azdd00f880pidxj80hxz121cnzb6s";
      };
      packageRequires = [ ];
      meta = {
  ...
  slime = callPackage (
    ...
    elpaBuild {
      pname = "slime";
      ename = "slime";
      version = "2.31snapshot0.20250316.184323";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/slime-2.31snapshot0.20250316.184323.tar";
        sha256 = "00fpnx5a9lsvzaxfpxbkh7bh4nf18kbhgly3v1vr09vdpyxcc7m0";
      };
