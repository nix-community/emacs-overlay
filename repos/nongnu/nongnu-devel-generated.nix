{ callPackage }:
{
  ...
  clojure-mode = callPackage (
    ...
    elpaBuild {
      pname = "clojure-mode";
      ename = "clojure-mode";
      version = "5.22.0.0.20260318.174000";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-mode-5.22.0.0.20260318.174000.tar";
        sha256 = "1zs7bpw11sylzqfrrkh5hpzxg1hqcd7vmbnns5xabswgjpilf6xc";
      };
      packageRequires = [ ];
      meta = {
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.6.0.0.20260317.73459";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.6.0.0.20260317.73459.tar";
        sha256 = "06q4f0zbjly5h46jhikm0452y0q6d86qqgqcpd9ilqrbj71is6rr";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.4.0.20260316.222426";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.4.0.20260316.222426.tar";
        sha256 = "1pd2micmq217ssfl9ibl6sbir39bgdkx8mpwfmm57lxib4jq9zz0";
      };
      packageRequires = [
        compat
        transient
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260318.122554";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260318.122554.tar";
        sha256 = "00mpjzvb7415myby5k1ddsz7yp1pjycmy4w57h5ha0y3h9b8aabc";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260318.122554";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260318.122554.tar";
        sha256 = "10p27z2pppl6qbv3vpjynl3n0hw7yh762ni6615zak5jzf3pxdqw";
      };
      packageRequires = [
        compat
        cond-let
