{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.5.0.20241015.125127";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.5.0.20241015.125127.tar";
        sha256 = "03r1ga4kg55nkhr3k06civg42q5x791nana5zqbh7p40ch7w973z";
      };
      packageRequires = [
        compat
        transient
