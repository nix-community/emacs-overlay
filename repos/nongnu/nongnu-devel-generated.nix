{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.0.20260518.211619";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.0.20260518.211619.tar";
        sha256 = "0phh35ly8xfdjhnyz2na9ij1l92f27jqgcjqwj7mvpfybsw11v5w";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260519.184930";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260519.184930.tar";
        sha256 = "0aq96h68awpkn7938il92kc4rn97arxfxfjgad0i7akvfb6h3m5r";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  elfeed-web = callPackage (
    ...
    elpaBuild {
      pname = "elfeed-web";
      ename = "elfeed-web";
      version = "3.4.2.0.20260517.211650";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-web-3.4.2.0.20260517.211650.tar";
        sha256 = "0gmi5npwaz04lqpg2h1n69pymwvkia0i9w448jkvgkc07qyn3jsg";
      };
      packageRequires = [
        compat
        elfeed
  ...
  gnuplot = callPackage (
    ...
    elpaBuild {
      pname = "gnuplot";
      ename = "gnuplot";
      version = "0.12.0.20260519.104840";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnuplot-0.12.0.20260519.104840.tar";
        sha256 = "1xc8z3navngjkrksfrx2ix13b5755ghs9vb41g214kkzy4hw0lb4";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.7.0.20260518.54205";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.7.0.20260518.54205.tar";
        sha256 = "0qqg0p1bfb2px88d06038b6svp1s8kw4ndq9vgw2pnpki9yqg19q";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.7.0.20260518.54205";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.7.0.20260518.54205.tar";
        sha256 = "1dl2a9fq0nbv7rp5q60s1pkcd0za56rdd7f40lk0ajnsk9vs76if";
      };
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.10.9.0.20260516.32909";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.10.9.0.20260516.32909.tar";
        sha256 = "1p4sr4pm1rw2kfs6zrlnb2jrwlibx49irjf4424ni4v6skwjmv04";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260519.141641";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260519.141641.tar";
        sha256 = "1gp1wbadc8i0sn76ab3888g8zzrj193knhlsisan782d34r275v9";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260519.141641";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260519.141641.tar";
        sha256 = "0m6ypvb6iqn4hy1x3vl2mnhlci850bn7xjdqfyw29ng7kbkdby3d";
      };
      packageRequires = [
        compat
        cond-let
  ...
  vm = callPackage (
    ...
    elpaBuild {
      pname = "vm";
      ename = "vm";
      version = "8.3.30.20260420.63204";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/vm-8.3.30.20260420.63204.tar";
        sha256 = "101cb05gr4q6r30bnif0i14d7yg2a9wardaw6py19l8gazzxz9i2";
      };
