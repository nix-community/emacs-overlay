{ callPackage }:
{
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.3.0.20250508.103057";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.1.3.0.20250508.103057.tar";
        sha256 = "0z6szxxjww759ivl0w45dghbz9i3hqx74054qw5c2ip09il0vjbm";
      };
      packageRequires = [ ];
      meta = {
