{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.20.0snapshot0.20251018.40438";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.20.0snapshot0.20251018.40438.tar";
        sha256 = "11szipp97wxd58v6681ghwmx4w0d5fdic3wi7gwpgahp1kaajr5l";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "0.1.1.0.20251019.202035";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-0.1.1.0.20251019.202035.tar";
        sha256 = "1gxf30y007l82dkxiy75aa1561gngbzlk0i8imbjlqrinr3xrvpy";
      };
      packageRequires = [ ];
      meta = {
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.6.0.20251013.91552";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.6.0.20251013.91552.tar";
        sha256 = "17hb9mc9f4yfgqwypq5c9j29i1qzna0fb69lg36cw2hvbw1zyfkw";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251021.214342";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251021.214342.tar";
        sha256 = "1515sxsgw5skbyk7zpb7z8d5d7pl6w9ll93kbnvsl36l63hrg5pg";
      };
      packageRequires = [
        compat
        transient
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.3.5.0.20251018.70115";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.3.5.0.20251018.70115.tar";
        sha256 = "1q71c6vdj4yv36z0wic7q9w0iiirm5cwy752n3s956gchiky21vn";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.6.0.20251020.133847";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.6.0.20251020.133847.tar";
        sha256 = "1pr28yn6v2mjhi6krs6dswgpb13sypi2jy2m9b3rjjrg28rd5z4j";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.6.0.20251020.133847";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.6.0.20251020.133847.tar";
        sha256 = "0x3yb3nij7zycvi52dpdfzk39cyda391c0mxlh9p750pfy564ahi";
      };
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.4.2.0.20251020.194654";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.4.2.0.20251020.194654.tar";
        sha256 = "18gh967mzzln9zhz4sbla5q86ybslqffkf3vwkhw0542aaz6gi6d";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.4.2.0.20251020.194654";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.4.2.0.20251020.194654.tar";
        sha256 = "1j49rmffmj2q2gl0skzxacpapndi3cglbw8zdv6ikzm4xms3gkld";
      };
      packageRequires = [
        compat
        cond-let
