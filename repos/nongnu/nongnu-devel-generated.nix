{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.21.0snapshot0.20251231.145830";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.21.0snapshot0.20251231.145830.tar";
        sha256 = "1fc75wgxbzxi00kvxsiiw4y2vv0cx9shfn767agbr3amm9b86wx4";
      };
      packageRequires = [
        clojure-mode
        parseedn
