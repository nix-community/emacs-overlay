{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20250106.163403";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20250106.163403.tar";
        sha256 = "1bybzgai6n594cwiiafg4gb2bffvk2kx5f0xz78s7gg6bsh3kyn4";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20250106.73013";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20250106.73013.tar";
        sha256 = "1q5hlr4qabbbsmqsahghlnlrgviznjk9za6ld6fayiq2ikhsr32z";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20250106.73013";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20250106.73013.tar";
        sha256 = "04k2p2bgbhbc61c937wv0x0qkyc827r6r6nr21mr2lszhrh9vxc9";
      };
  ...
  vm = callPackage (
    ...
    elpaBuild {
      pname = "vm";
      ename = "vm";
      version = "8.3.0snapshot0.20250104.230322";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/vm-8.3.0snapshot0.20250104.230322.tar";
        sha256 = "167znjihczjhysv7iqpnv0bdsa5zbnil6xjvs29jq9fsp2gwkpbd";
      };
      packageRequires = [
        cl-lib
        nadvice
