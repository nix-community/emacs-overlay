{ callPackage }:
  {
    adoc-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "adoc-mode";
    ...
    afternoon-theme = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    alect-themes = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "alect-themes";
    ...
    ample-theme = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "ample-theme";
    ...
    annotate = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "annotate";
    ...
    anti-zenburn-theme = callPackage ({ elpaBuild
                                      , fetchurl
                                      , lib }:
      elpaBuild {
    ...
    apache-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "apache-mode";
    ...
    apropospriate-theme = callPackage ({ elpaBuild
                                       , fetchurl
                                       , lib }:
      elpaBuild {
    ...
    arduino-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib
                                , spinner }:
      elpaBuild {
    ...
    bash-completion = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    beancount = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "beancount";
    ...
    better-jumper = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "better-jumper";
    ...
    bind-map = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "bind-map";
    ...
    bison-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "bison-mode";
    ...
    blueprint-ts-mode = callPackage ({ elpaBuild
                                     , fetchurl
                                     , lib }:
      elpaBuild {
    ...
    buttercup = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "buttercup";
    ...
    cider = callPackage ({ clojure-mode
      ...
      elpaBuild {
        pname = "cider";
        ename = "cider";
        version = "1.15.1.0.20240803.82236";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/cider-1.15.1.0.20240803.82236.tar";
          sha256 = "1xbflxb3sh35adaa2crc3qq1iwy7s2gr73prwlcv0p04cgjsyibg";
        };
        packageRequires = [
          clojure-mode
          parseedn
    ...
    clojure-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "clojure-mode";
    ...
    clojure-ts-mode = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    coffee-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "coffee-mode";
    ...
    consult-flycheck = callPackage ({ consult
      ...
      elpaBuild {
        ...
        packageRequires = [ consult flycheck ];
        meta = {
    ...
    csv2ledger = callPackage ({ csv-mode
                              , elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
    ...
    cyberpunk-theme = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    dart-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "dart-mode";
    ...
    denote-refs = callPackage ({ denote
                               , elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
    ...
    diff-ansi = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "diff-ansi";
    ...
    doc-show-inline = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    dockerfile-mode = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    dracula-theme = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "dracula-theme";
    ...
    drupal-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib
                               , php-mode }:
      elpaBuild {
    ...
    edit-indirect = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "edit-indirect";
    ...
    editorconfig = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "editorconfig";
    ...
    elixir-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "elixir-mode";
    ...
    engine-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "engine-mode";
    ...
    evil = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        ...
        packageRequires = [ cl-lib goto-chg ];
        meta = {
    ...
    evil-args = callPackage ({ elpaBuild
                             , evil
                             , fetchurl
                             , lib }:
      elpaBuild {
    ...
    evil-goggles = callPackage ({ elpaBuild
                                , evil
                                , fetchurl
                                , lib }:
      elpaBuild {
    ...
    evil-iedit-state = callPackage ({ elpaBuild
                                    , evil
                                    , fetchurl
                                    , iedit
                                    , lib }:
    ...
    evil-matchit = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "evil-matchit";
    ...
    evil-nerd-commenter = callPackage ({ elpaBuild
                                       , fetchurl
                                       , lib }:
      elpaBuild {
    ...
    evil-numbers = callPackage ({ elpaBuild
                                , evil
                                , fetchurl
                                , lib }:
      elpaBuild {
    ...
    evil-surround = callPackage ({ elpaBuild
                                 , evil
                                 , fetchurl
                                 , lib }:
      elpaBuild {
    ...
    evil-visualstar = callPackage ({ elpaBuild
                                   , evil
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    exec-path-from-shell = callPackage ({ elpaBuild
                                        , fetchurl
                                        , lib }:
      elpaBuild {
    ...
    flycheck = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "flycheck";
    ...
    flymake-kondor = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    flymake-popon = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ flymake popon posframe ];
        meta = {
    ...
    forth-mode = callPackage ({ cl-lib ? null
                              , elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
    ...
    gc-buffers = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "gc-buffers";
    ...
    geiser-chez = callPackage ({ elpaBuild
                               , fetchurl
                               , geiser
                               , lib }:
      elpaBuild {
    ...
    geiser-chibi = callPackage ({ elpaBuild
                                , fetchurl
                                , geiser
                                , lib }:
      elpaBuild {
    ...
    geiser-chicken = callPackage ({ elpaBuild
                                  , fetchurl
                                  , geiser
                                  , lib }:
      elpaBuild {
    ...
    geiser-gambit = callPackage ({ elpaBuild
                                 , fetchurl
                                 , geiser
                                 , lib }:
      elpaBuild {
    ...
    geiser-gauche = callPackage ({ elpaBuild
                                 , fetchurl
                                 , geiser
                                 , lib }:
      elpaBuild {
    ...
    geiser-guile = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ geiser transient ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/geiser-guile.html";
          license = lib.licenses.free;
        };
      }) {};
    geiser-kawa = callPackage ({ elpaBuild
                               , fetchurl
                               , geiser
                               , lib }:
      elpaBuild {
    ...
    geiser-mit = callPackage ({ elpaBuild
                              , fetchurl
                              , geiser
                              , lib }:
      elpaBuild {
    ...
    geiser-racket = callPackage ({ elpaBuild
                                 , fetchurl
                                 , geiser
                                 , lib }:
      elpaBuild {
    ...
    geiser-stklos = callPackage ({ elpaBuild
                                 , fetchurl
                                 , geiser
                                 , lib }:
      elpaBuild {
    ...
    git-commit = callPackage ({ compat
      ...
      elpaBuild {
        pname = "git-commit";
        ename = "git-commit";
        version = "3.3.0.50snapshot0.20240804.112029";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/git-commit-3.3.0.50snapshot0.20240804.112029.tar";
          sha256 = "1spwkgiminplp433cdavmwhzdg9ywh99c6xlx326a7c7nr259a1q";
        };
        packageRequires = [ compat seq transient with-editor ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/git-commit.html";
          license = lib.licenses.free;
        };
      }) {};
    git-modes = callPackage ({ compat
                             , elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
    ...
    gnu-apl-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "gnu-apl-mode";
    ...
    gnu-indent = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "gnu-indent";
    ...
    golden-ratio = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "golden-ratio";
    ...
    gotham-theme = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "gotham-theme";
    ...
    goto-chg = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "goto-chg";
    ...
    gptel = callPackage ({ compat
      ...
      elpaBuild {
        ...
        packageRequires = [ compat transient ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/gptel.html";
          license = lib.licenses.free;
        };
      }) {};
    graphql-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "graphql-mode";
    ...
    gruber-darker-theme = callPackage ({ elpaBuild
                                       , fetchurl
                                       , lib }:
      elpaBuild {
    ...
    guru-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "guru-mode";
    ...
    haskell-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "haskell-mode";
    ...
    haskell-tng-mode = callPackage ({ elpaBuild
                                    , fetchurl
                                    , lib
                                    , popup }:
      elpaBuild {
    ...
    helm = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "helm";
        ename = "helm";
        version = "3.9.9.0.20240802.101727";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/helm-3.9.9.0.20240802.101727.tar";
          sha256 = "1wc1s18vlj0vv6x911rdawqg70sqcqj8il0ipq68n16jl45niw25";
        };
    ...
    helm-core = callPackage ({ async
      ...
      elpaBuild {
        ...
        version = "3.9.9.0.20240802.101727";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/helm-core-3.9.9.0.20240802.101727.tar";
          sha256 = "1xywclq5pjyprnfv4a3kiyby011m0f4hv8l2vxv3flvr0sswbzha";
        };
    ...
    hideshowvis = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "hideshowvis";
    ...
    hl-block-mode = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "hl-block-mode";
    ...
    hl-column = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "hl-column";
    ...
    hyperdrive = callPackage ({ compat
      ...
      elpaBuild {
        pname = "hyperdrive";
        ename = "hyperdrive";
        version = "0.4pre0.20240731.232258";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/hyperdrive-0.4pre0.20240731.232258.tar";
          sha256 = "1xp1693ak5808sx47dvi1c0hh6xfi3510pqn55rsb6lvsjyij7v4";
        };
        packageRequires = [
          compat
          map
    ...
    idle-highlight-mode = callPackage ({ elpaBuild
                                       , fetchurl
                                       , lib }:
      elpaBuild {
    ...
    idris-mode = callPackage ({ cl-lib ? null
      ...
      elpaBuild {
        ...
        packageRequires = [ cl-lib prop-menu ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/idris-mode.html";
          license = lib.licenses.free;
        };
      }) {};
    iedit = callPackage ({ elpaBuild
                         , fetchurl
                         , lib }:
      elpaBuild {
        pname = "iedit";
    ...
    inf-ruby = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "inf-ruby";
    ...
    inkpot-theme = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "inkpot-theme";
    ...
    jade-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "jade-mode";
    ...
    jinja2-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "jinja2-mode";
    ...
    julia-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "julia-mode";
    ...
    keycast = callPackage ({ compat
      ...
      elpaBuild {
        pname = "keycast";
        ename = "keycast";
        version = "1.4.0.0.20240731.115207";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/keycast-1.4.0.0.20240731.115207.tar";
          sha256 = "1wh95w6njckpd0wi7la48p7i1dcfwjcjp6zch0i785cjjya3j6cq";
        };
        packageRequires = [ compat ];
        meta = {
    ...
    kotlin-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "kotlin-mode";
    ...
    lorem-ipsum = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "lorem-ipsum";
    ...
    lua-mode = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "lua-mode";
    ...
    magit = callPackage ({ compat
      ...
      elpaBuild {
        ...
        version = "3.3.0.50snapshot0.20240804.112029";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/magit-3.3.0.50snapshot0.20240804.112029.tar";
          sha256 = "084daxl1jdppqb5sv14bdjdazlwnw7r879mjzf8rj0yqhj4ms14g";
        };
        packageRequires = [
          compat
          dash
    ...
    magit-section = callPackage ({ compat
                                 , dash
                                 , elpaBuild
                                 , fetchurl
                                 , lib
      ...
      elpaBuild {
        ...
        version = "3.3.0.50snapshot0.20240804.112029";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu-devel/magit-section-3.3.0.50snapshot0.20240804.112029.tar";
          sha256 = "0kj8l64a6n0gwjz64k2di2mv9kmk4k0yy0jsa6475l63bgsfy9pf";
        };
        packageRequires = [ compat dash seq ];
        meta = {
    ...
    mastodon = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ persist request ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/mastodon.html";
          license = lib.licenses.free;
        };
      }) {};
    material-theme = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    mentor = callPackage ({ async
      ...
      elpaBuild {
        ...
        packageRequires = [ async seq url-scgi xml-rpc ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/mentor.html";
          license = lib.licenses.free;
        };
      }) {};
    meow = callPackage ({ elpaBuild
                        , fetchurl
                        , lib }:
      elpaBuild {
        pname = "meow";
    ...
    moe-theme = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "moe-theme";
    ...
    monokai-theme = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "monokai-theme";
    ...
    multiple-cursors = callPackage ({ elpaBuild
                                    , fetchurl
                                    , lib }:
      elpaBuild {
    ...
    nasm-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "nasm-mode";
    ...
    nginx-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "nginx-mode";
    ...
    nix-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ magit-section transient ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/nix-mode.html";
          license = lib.licenses.free;
        };
      }) {};
    oblivion-theme = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    opam-switch-mode = callPackage ({ elpaBuild
                                    , fetchurl
                                    , lib }:
      elpaBuild {
    ...
    org-auto-tangle = callPackage ({ async
                                   , elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    org-contrib = callPackage ({ elpaBuild
                               , fetchurl
                               , lib
                               , org }:
      elpaBuild {
    ...
    org-drill = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ org persist seq ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/org-drill.html";
          license = lib.licenses.free;
        };
      }) {};
    org-journal = callPackage ({ elpaBuild
                               , fetchurl
                               , lib
                               , org }:
      elpaBuild {
    ...
    org-mime = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "org-mime";
    ...
    org-present = callPackage ({ elpaBuild
                               , fetchurl
                               , lib
                               , org }:
      elpaBuild {
    ...
    org-superstar = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib
                                 , org }:
      elpaBuild {
    ...
    org-transclusion-http = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ org-transclusion plz ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/org-transclusion-http.html";
          license = lib.licenses.free;
        };
      }) {};
    org-tree-slide = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    orgit = callPackage ({ compat
      ...
      elpaBuild {
        ...
        packageRequires = [ compat magit org ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/orgit.html";
          license = lib.licenses.free;
        };
      }) {};
    p4-16-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "p4-16-mode";
    ...
    package-lint = callPackage ({ elpaBuild
                                , fetchurl
                                , let-alist
                                , lib }:
      elpaBuild {
    ...
    page-break-lines = callPackage ({ elpaBuild
                                    , fetchurl
                                    , lib }:
      elpaBuild {
    ...
    parseclj = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "parseclj";
    ...
    parseedn = callPackage ({ elpaBuild
                            , fetchurl
                            , lib
                            , map
                            , parseclj }:
      elpaBuild {
        ...
        packageRequires = [ map parseclj ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/parseedn.html";
          license = lib.licenses.free;
        };
      }) {};
    pcmpl-args = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "pcmpl-args";
    ...
    pdf-tools = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        packageRequires = [ let-alist tablist ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/pdf-tools.html";
          license = lib.licenses.free;
        };
      }) {};
    php-mode = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "php-mode";
    ...
    projectile = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "projectile";
    ...
    proof-general = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "proof-general";
    ...
    rainbow-delimiters = callPackage ({ elpaBuild
                                      , fetchurl
                                      , lib }:
      elpaBuild {
    ...
    raku-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "raku-mode";
    ...
    recomplete = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "recomplete";
    ...
    reformatter = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "reformatter";
    ...
    rfc-mode = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "rfc-mode";
    ...
    rust-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "rust-mode";
    ...
    scala-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib }:
      elpaBuild {
        pname = "scala-mode";
    ...
    scroll-on-drag = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    scroll-on-jump = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    shellcop = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "shellcop";
    ...
    smartparens = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "smartparens";
    ...
    solarized-theme = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    spacemacs-theme = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    spell-fu = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "spell-fu";
    ...
    stylus-mode = callPackage ({ elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
        pname = "stylus-mode";
    ...
    subatomic-theme = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    swift-mode = callPackage ({ elpaBuild
                              , fetchurl
                              , lib
                              , seq }:
      elpaBuild {
    ...
    symbol-overlay = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib
                                  , seq }:
      elpaBuild {
    ...
    tangotango-theme = callPackage ({ elpaBuild
                                    , fetchurl
                                    , lib }:
      elpaBuild {
    ...
    telephone-line = callPackage ({ cl-generic
      ...
      elpaBuild {
        ...
        packageRequires = [ cl-generic cl-lib seq ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/telephone-line.html";
          license = lib.licenses.free;
        };
      }) {};
    testcover-mark-line = callPackage ({ elpaBuild
                                       , fetchurl
                                       , lib }:
      elpaBuild {
    ...
    textile-mode = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "textile-mode";
    ...
    treesit-fold = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "treesit-fold";
    ...
    treeview = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "treeview";
    ...
    typescript-mode = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    ujelly-theme = callPackage ({ elpaBuild
                                , fetchurl
                                , lib }:
      elpaBuild {
        pname = "ujelly-theme";
    ...
    undo-fu-session = callPackage ({ elpaBuild
                                   , fetchurl
                                   , lib }:
      elpaBuild {
    ...
    vc-fossil = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "vc-fossil";
    ...
    vcomplete = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "vcomplete";
    ...
    visual-fill-column = callPackage ({ elpaBuild
                                      , fetchurl
                                      , lib }:
      elpaBuild {
    ...
    web-mode = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "web-mode";
    ...
    why-this = callPackage ({ elpaBuild
                            , fetchurl
                            , lib }:
      elpaBuild {
        pname = "why-this";
    ...
    with-editor = callPackage ({ compat
                               , elpaBuild
                               , fetchurl
                               , lib }:
      elpaBuild {
    ...
    with-simulated-input = callPackage ({ elpaBuild
                                        , fetchurl
                                        , lib }:
      elpaBuild {
    ...
    workroom = callPackage ({ compat
      ...
      elpaBuild {
        ...
        packageRequires = [ compat project ];
        meta = {
          homepage = "https://elpa.nongnu.org/nongnu-devel/workroom.html";
          license = lib.licenses.free;
        };
      }) {};
    writegood-mode = callPackage ({ elpaBuild
                                  , fetchurl
                                  , lib }:
      elpaBuild {
    ...
    ws-butler = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "ws-butler";
    ...
    yaml-mode = callPackage ({ elpaBuild
                             , fetchurl
                             , lib }:
      elpaBuild {
        pname = "yaml-mode";
    ...
    yasnippet-snippets = callPackage ({ elpaBuild
                                      , fetchurl
                                      , lib
                                      , yasnippet }:
      elpaBuild {
    ...
    zenburn-theme = callPackage ({ elpaBuild
                                 , fetchurl
                                 , lib }:
      elpaBuild {
        pname = "zenburn-theme";
    ...
    zig-mode = callPackage ({ elpaBuild
                            , fetchurl
                            , lib
                            , reformatter }:
      elpaBuild {
