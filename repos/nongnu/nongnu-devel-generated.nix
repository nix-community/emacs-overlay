{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.5.0.20260606.33";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.5.0.20260606.33.tar";
        sha256 = "1xmz9vxa0wyw5pnykvhi9fwrwv050mwda7a4x5hpksrqkrl6rhsy";
      };
      packageRequires = [
        compat
        transient
