{ callPackage }:
{
  ...
  clojure-mode = callPackage (
    ...
    elpaBuild {
      pname = "clojure-mode";
      ename = "clojure-mode";
      version = "5.22.0.0.20260317.173335";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-mode-5.22.0.0.20260317.173335.tar";
        sha256 = "0x3lsrd3kgadls1ar73bwyl7gqza2qzg6101rymliqk4clvg51vf";
      };
      packageRequires = [ ];
      meta = {
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260316.163818";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260316.163818.tar";
        sha256 = "1mrz3v5np9y819b94q70yqfgcl2s8rk01vv0rnxvpqw18xcc73g4";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260316.163818";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260316.163818.tar";
        sha256 = "0w29xbh1qf7v3g5bpwdvn7pb34h2n1z1557677wvrkdgbvmxafq9";
      };
      packageRequires = [
        compat
        cond-let
