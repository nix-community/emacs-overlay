{ callPackage }:
{
  ...
  dracula-theme = callPackage (
    ...
    elpaBuild {
      pname = "dracula-theme";
      ename = "dracula-theme";
      version = "1.8.2.0.20250623.200908";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dracula-theme-1.8.2.0.20250623.200908.tar";
        sha256 = "1gnny1gb2lp8z1mj1jxg4c5dwf2b5gj58y1yziigi1l56zjv44k8";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.5.0.20250625.105732";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.5.0.20250625.105732.tar";
        sha256 = "0dihhw9a8pzjmq0kwbhlyindzbbb8b1b9j04vigajlq8gjyhj1r0";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.4.0.20250625.84625";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.4.0.20250625.84625.tar";
        sha256 = "1qa0hnf5qiz0l27fv7rjbcvnwvdkf9f5zqqlph1rm78d3lgshza4";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.4.0.20250625.84625";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.4.0.20250625.84625.tar";
        sha256 = "0mwn76lg50r19nn7skbal0z37hx9lldzblxzi16jggwk0c7rsm48";
      };
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "26.12.20250606101544.0.20250624.81227";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-26.12.20250606101544.0.20250624.81227.tar";
        sha256 = "0wq5xssdb0zifmkbfbnz89nqmlwmzi3xcvr2afw4602g02z1581l";
      };
      packageRequires = [ ];
      meta = {
