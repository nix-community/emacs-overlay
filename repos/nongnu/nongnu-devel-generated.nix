{ callPackage }:
{
  ...
  meow = callPackage (
    ...
    elpaBuild {
      pname = "meow";
      ename = "meow";
      version = "1.5.0.0.20241130.102626";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/meow-1.5.0.0.20241130.102626.tar";
        sha256 = "0k9rn9vpf4p12416cjjzcgp9i97lxk68vqwciffj5jvi5akdgzl1";
      };
      packageRequires = [ ];
      meta = {
