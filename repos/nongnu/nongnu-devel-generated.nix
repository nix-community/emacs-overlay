{ callPackage }:
{
  adoc-mode = callPackage (
    ...
    elpaBuild {
      pname = "adoc-mode";
      ename = "adoc-mode";
      version = "0.9.0.0.20260603.5";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/adoc-mode-0.9.0.0.20260603.5.tar";
        sha256 = "1zpp2b4580y8fq9yxzd1h0ak39fh3z8cpigd5889cyrgj6w875wf";
      };
      packageRequires = [ ];
      meta = {
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.0.20260602.150";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.0.20260602.150.tar";
        sha256 = "1r6mn64p9m06pd1bc2nzpxb3anxixh325zsz9i44p38ap1hc9ab6";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260603.479";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260603.479.tar";
        sha256 = "0cv8hav7kcjgm3dkgi1v7kyfg2prz1m46padjm878816k41igm68";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.10.10.0.20260530.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.10.10.0.20260530.0.tar";
        sha256 = "0n39w9vi9akw1w1llyd620n26h5dfrjgn7kjvlk876mkp0q61pai";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260602.264";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260602.264.tar";
        sha256 = "03i1n8qq9043cnnkzidkgrgb6xk79cfwcncky73qh6dg6gb2agip";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260602.264";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260602.264.tar";
        sha256 = "15hawlxggpbgvjys3vxqhamm7j2f5zcl3l7483ldcy65jhmn8nx4";
      };
      packageRequires = [
        compat
        cond-let
