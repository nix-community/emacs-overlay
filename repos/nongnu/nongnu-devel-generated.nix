{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251102.10447";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251102.10447.tar";
        sha256 = "1knrmpk9y5kdjcy764a9hbih7q3dpljzydr8ar5dvvvfiip4j6ky";
      };
      packageRequires = [
        compat
        transient
