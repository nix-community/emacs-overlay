{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20250204.120117";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20250204.120117.tar";
        sha256 = "17jb3vc16l4vfdjwy1cw58qzk9acpvm0j1b61wjv91mp4h0ccwi2";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20250204.120818";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20250204.120818.tar";
        sha256 = "1n27zm60fg45y8aancz5q8fgl0rkp72cbbgbqwji4i8dgphzgy3z";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20250204.120818";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20250204.120818.tar";
        sha256 = "1bwakxr8ys4vfqvpd1snr6z9rvmdjy7j3vvy7ww1pw5pn9f9y8d5";
      };
  ...
  loopy = callPackage (
    ...
    elpaBuild {
      pname = "loopy";
      ename = "loopy";
      version = "0.14.0.0.20250119.13540";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/loopy-0.14.0.0.20250119.13540.tar";
        sha256 = "01a77jzbxfm5zrc5nfrih6vwwjyz2vjcpaiqlgmhcmfhj2xnh34n";
      };
      packageRequires = [
        compat
        map
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20250201.91223";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20250201.91223.tar";
        sha256 = "0wsa9ampxjbh3p53c60g6p4gyghkz63pypb53lcdzxj9jhjxq0wx";
      };
      packageRequires = [ ];
      meta = {
