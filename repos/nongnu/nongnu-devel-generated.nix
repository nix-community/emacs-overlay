{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20241225.122717";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20241225.122717.tar";
        sha256 = "0w3f4z2v618rvxjb1yf5agvf2kkz8lddslz8qgip34sijwz2h87l";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20241225.64139";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20241225.64139.tar";
        sha256 = "189ksrjira8r42sbfzgk7n97hn25v62rw8vwfcahsvrr96qfnam9";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20241225.64139";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20241225.64139.tar";
        sha256 = "0fynrlfhw8mk4jqdq5r92pq1nhfdjgvhyrxysqwddzpnizhj6wgd";
      };
  ...
  web-mode = callPackage (
    ...
    elpaBuild {
      pname = "web-mode";
      ename = "web-mode";
      version = "17.3.21.0.20241225.162828";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/web-mode-17.3.21.0.20241225.162828.tar";
        sha256 = "1sl66pm8vi9srh2k1ih507cvam6qxw1jvxhnqvwqcj6mmzs1liwk";
      };
      packageRequires = [ ];
      meta = {
