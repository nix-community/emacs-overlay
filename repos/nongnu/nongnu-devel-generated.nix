{ callPackage }:
{
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.5.0.20250815.70148";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.5.0.20250815.70148.tar";
        sha256 = "11npakgmq84kjvmlfx2ldk1yrsrh28fdj6wlv6jyjwmsigvyl6aw";
      };
      packageRequires = [
        compat
        emacsql
