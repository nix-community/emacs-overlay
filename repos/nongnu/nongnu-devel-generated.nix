{ callPackage }:
{
  ...
  eldoc-mouse = callPackage (
    ...
    elpaBuild {
      pname = "eldoc-mouse";
      ename = "eldoc-mouse";
      version = "3.0.6.0.20260326.35433";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/eldoc-mouse-3.0.6.0.20260326.35433.tar";
        sha256 = "0mavmk2iklb3q6jgj9nxmggj14251c5ks2zw3j81dqzagd9jf51y";
      };
      packageRequires = [
        eglot
        posframe
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.4.0.20260326.225938";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.4.0.20260326.225938.tar";
        sha256 = "0f2ghbhkd0lx7rlp1h5xmflxlv9y8pbrk4j7hpc7i816ysxraz6b";
      };
      packageRequires = [
        compat
        transient
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260326.211052";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260326.211052.tar";
        sha256 = "08ajhf361yccawy150lbqa3p7vmg9fkr4r1wrxw78x47ndkyqgvm";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260326.211052";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260326.211052.tar";
        sha256 = "1d7hffxgbg5kjwylpri2qcr0f21yjbvgd68svigs59lly5hvydxw";
      };
      packageRequires = [
        compat
        cond-let
