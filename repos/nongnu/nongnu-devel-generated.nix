{ callPackage }:
{
  ...
  clojure-mode = callPackage (
    ...
    elpaBuild {
      pname = "clojure-mode";
      ename = "clojure-mode";
      version = "5.21.0.0.20260227.65406";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-mode-5.21.0.0.20260227.65406.tar";
        sha256 = "0nfya121q97v2dvxvhz68g5dzny0gis6z4wqwiry8pwkfbjfrk3q";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.4.0.20260226.213028";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.4.0.20260226.213028.tar";
        sha256 = "0gf127ddj3iykxsdjvix95448p85vdwb1k9wkmjfg2iv70wa4x5n";
      };
      packageRequires = [
        compat
        transient
  ...
  markdown-mode = callPackage (
    ...
    elpaBuild {
      pname = "markdown-mode";
      ename = "markdown-mode";
      version = "2.8alpha0.20260226.60934";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/markdown-mode-2.8alpha0.20260226.60934.tar";
        sha256 = "1wx7fc3q0s4gvvnxlfqj6cgv4ypxhp7y5q4cnd0gdhxfr4rzwl3f";
      };
      packageRequires = [ ];
      meta = {
