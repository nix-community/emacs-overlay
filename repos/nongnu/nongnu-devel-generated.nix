{ callPackage }:
{
  ...
  annotate = callPackage (
    ...
    elpaBuild {
      pname = "annotate";
      ename = "annotate";
      version = "2.4.4.0.20251102.112536";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/annotate-2.4.4.0.20251102.112536.tar";
        sha256 = "08xlvnzhjsaalsj1lima3aqpbnmq0v5qz0ydh2kpig6p3wg2cy5f";
      };
      packageRequires = [ ];
      meta = {
  ...
  emacsql = callPackage (
    ...
    elpaBuild {
      pname = "emacsql";
      ename = "emacsql";
      version = "4.3.3.0.20251101.200741";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/emacsql-4.3.3.0.20251101.200741.tar";
        sha256 = "13danyzm38avj8088m20bjv9v17vc23n1ljvsq084pzd4fkjk97n";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251103.92801";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251103.92801.tar";
        sha256 = "07rk2ym1sb6yjcbpf1wb9ng5rwm42kq3q1p5yycyqcm7rmb4nwbx";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.6.0.20251031.202403";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.6.0.20251031.202403.tar";
        sha256 = "069ksw6lpvr5a47c9ci4j6b8lf88ypi14yaml7l1yq6zn5b9jklm";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.6.0.20251031.202403";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.6.0.20251031.202403.tar";
        sha256 = "10b17fcmbzggdly7w1w76a8g165z6l1jdj261rkhk1yxdvfq04wx";
      };
  ...
  logview = callPackage (
    ...
    elpaBuild {
      pname = "logview";
      ename = "logview";
      version = "0.19.3snapshot0.20251102.142308";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/logview-0.19.3snapshot0.20251102.142308.tar";
        sha256 = "1343z3mf9dny6sfnnsv1ns6j486j540ymvp1xbh5h3795vh5y6km";
      };
      packageRequires = [
        compat
        datetime
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.4.7.0.20251101.210014";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.4.7.0.20251101.210014.tar";
        sha256 = "0fvd8v10clam56579ld1s3ympzk5n0107qa5jj55xgp9rla906av";
      };
      packageRequires = [ compat ];
      meta = {
