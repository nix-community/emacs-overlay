{ callPackage }:
{
  ...
  auto-dim-other-buffers = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.1.1.0.20241213.183015";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/auto-dim-other-buffers-2.1.1.0.20241213.183015.tar";
        sha256 = "1b5qv8s728aa87jx5jk60k39c0ijygdgx4gnnrp39habklbkkyni";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.0.20241212.61019";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.0.20241212.61019.tar";
        sha256 = "1dfbwj90ah47w71w3kf3zizgkwj71ms1y0w8vnk65cl9dsn3p1hx";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.20241212.61019";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.0.20241212.61019.tar";
        sha256 = "1xf5h94y58qs104jcg8qxrj4l6b0x1gjbpc02gsfdb99kwzmpdqb";
      };
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.1.3.0.20241209.93339";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.1.3.0.20241209.93339.tar";
        sha256 = "10j1ly0k9n1xj7z31r4fa832x3gdq2b4d4hz4bjihd19i69miq3l";
      };
      packageRequires = [
        compat
        dash
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.1.3.0.20241209.93339";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.1.3.0.20241209.93339.tar";
        sha256 = "19q1lxix0b33hkvl96bzqvxd2bspkbx261133hdgjk1swdzsfh53";
      };
      packageRequires = [
        compat
        dash
  ...
  meow = callPackage (
    ...
    elpaBuild {
      pname = "meow";
      ename = "meow";
      version = "1.5.0.0.20241213.104034";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/meow-1.5.0.0.20241213.104034.tar";
        sha256 = "19hr4fvgmiqhw0hskncynz0qryqji3wvprimb26wwz920gkzmvyq";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20241216.83424";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20241216.83424.tar";
        sha256 = "1hs7g57mnl52xinxypc9hjciz0smlbzib061q4iagpg03wx9c7gz";
      };
      packageRequires = [ ];
      meta = {
  ...
  subed = callPackage (
    ...
    elpaBuild {
      pname = "subed";
      ename = "subed";
      version = "1.2.21.0.20241213.80149";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/subed-1.2.21.0.20241213.80149.tar";
        sha256 = "19pwj5qi7h7dsf16ffkdm6jcivrs6fq5ym9053hngnahyyh3jsls";
      };
      packageRequires = [ ];
      meta = {
