{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.4.0.20260426.164755";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.4.0.20260426.164755.tar";
        sha256 = "074if83rrdxfb9rvl2f6akkynx5b6p5mhmzn3mc1fgh1nh3wi4r4";
      };
      packageRequires = [
        compat
        transient
