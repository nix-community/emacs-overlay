{ callPackage }:
{
  ...
  hyperdrive = callPackage (
    ...
    elpaBuild {
      pname = "hyperdrive";
      ename = "hyperdrive";
      version = "0.4pre0.20240820.223106";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/hyperdrive-0.4pre0.20240820.223106.tar";
        sha256 = "0x9f5qaql9lvnwa1yzyqbal2rxa4yzcv0c442zssvkbzbg95fi4w";
      };
      packageRequires = [
        compat
        map
