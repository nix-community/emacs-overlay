{ callPackage }:
{
  ...
  dart-mode = callPackage (
    ...
    elpaBuild {
      pname = "dart-mode";
      ename = "dart-mode";
      version = "1.0.7.0.20251104.214339";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dart-mode-1.0.7.0.20251104.214339.tar";
        sha256 = "0yp4h3fsjy8bgcgrcpmmq3iv7qc52aihmjc2wf9rnlapc7hgz7rm";
      };
      packageRequires = [ ];
      meta = {
  ...
  flycheck = callPackage (
    ...
    elpaBuild {
      pname = "flycheck";
      ename = "flycheck";
      version = "35.0.0.20251105.143315";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/flycheck-35.0.0.20251105.143315.tar";
        sha256 = "0drjaw9m3dcq4h91j5qmhw6k7v7sy5frzbbsz3hzmpxc4bhlxgmj";
      };
      packageRequires = [ seq ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.6.0.20251111.62919";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.6.0.20251111.62919.tar";
        sha256 = "0lqpibzkwl05cqz02v8qh917rnng2746kczcz85d5pz3a5ym948p";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.6.0.20251111.62919";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.6.0.20251111.62919.tar";
        sha256 = "1jl214xllg5mc6xq2sfzrya73bgybdc1nfq4vds2mngaxpgbjgkd";
      };
