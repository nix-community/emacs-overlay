{ callPackage }:
{
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20241025.131733";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20241025.131733.tar";
        sha256 = "03b6s7vvblnhjwc204d4scvwqmaq2vshawjwxnb39ngc8fdz91mj";
      };
      packageRequires = [ ];
      meta = {
  ...
  vm = callPackage (
    ...
    elpaBuild {
      pname = "vm";
      ename = "vm";
      version = "8.3.0snapshot0.20241016.54722";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/vm-8.3.0snapshot0.20241016.54722.tar";
        sha256 = "1g0k0qn35zc2m5y3lv9vw033qhmsyjn3bcr8fydc0937ag74mifp";
      };
      packageRequires = [
        cl-lib
        nadvice
