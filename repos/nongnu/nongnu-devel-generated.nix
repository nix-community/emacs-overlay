{ callPackage }:
{
  ...
  dirvish = callPackage (
    ...
    elpaBuild {
      pname = "dirvish";
      ename = "dirvish";
      version = "2.0.53.0.20250211.54001";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dirvish-2.0.53.0.20250211.54001.tar";
        sha256 = "0kk4vrh1bkm1iml5yfzkq1jnlqzggydcqmajdk8h1y0ichr1rclq";
      };
