{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "2.0.0.20260705.26";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-2.0.0.20260705.26.tar";
        sha256 = "1imgjxhwagsficaslggksln0lp800pl8vdfwkcw4nqjdipyydsw5";
      };
      packageRequires = [
        clojure-mode
        compat
