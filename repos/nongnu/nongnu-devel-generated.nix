{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.20.0snapshot0.20250710.81444";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.20.0snapshot0.20250710.81444.tar";
        sha256 = "1jh7v2ik9hcab0iygnvssbf33h1ijmwigj2x58djkyaya1irkxy6";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.5.0.20250719.130445";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.5.0.20250719.130445.tar";
        sha256 = "1w2jyiq6lxpym8g9yym07r340am0ns30nzp44lgagapjixgi02i7";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.4.0.20250722.153042";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.4.0.20250722.153042.tar";
        sha256 = "0n262x6dhvgl6z100v57w1xqqmjnzxd7rc5ig5qpbnxg07rciqya";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.4.0.20250722.153042";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.4.0.20250722.153042.tar";
        sha256 = "125fa0b8banz6a7wj29rl5mr428rlasd9i8vlfridmd78cvm6lpp";
      };
  ...
  htmlize = callPackage (
    ...
    elpaBuild {
      pname = "htmlize";
      ename = "htmlize";
      version = "1.59.0.20250722.94836";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/htmlize-1.59.0.20250722.94836.tar";
        sha256 = "0s3b2b6n8yydp15qy460cjyh5nsyx8phf5h89jvafdrmvm0iqv00";
      };
      packageRequires = [ ];
      meta = {
  ...
  meow = callPackage (
    ...
    elpaBuild {
      pname = "meow";
      ename = "meow";
      version = "1.5.0.0.20250716.84502";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/meow-1.5.0.0.20250716.84502.tar";
        sha256 = "02mcrslj11j0dxp4kz20x9iy9i8bd1903c3g2jadg1pkhbil2dwv";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "27.8.20250721075420.0.20250721.75456";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-27.8.20250721075420.0.20250721.75456.tar";
        sha256 = "1xfbczlhqh9i7f19s9zl7l8a30hgxj2qzma8rlwl8nws7h3kri2j";
      };
      packageRequires = [ ];
      meta = {
