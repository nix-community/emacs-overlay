{ callPackage }:
{
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.0.20240904.135429";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.0.20240904.135429.tar";
        sha256 = "1jngizdvvpknrr88vwph8gvn3ny4mh1mgbmy7slxbwrj0dygsazd";
      };
      packageRequires = [ ];
      meta = {
