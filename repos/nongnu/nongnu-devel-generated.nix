{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.9.0.20260724.4";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.9.0.20260724.4.tar";
        sha256 = "0qyk1h5q9nvynrkq9mpyfcld47igzh7y5n2l18kxh1z0vhnf7ils";
      };
      packageRequires = [
        compat
        markdown-mode
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "2.1.0snapshot0.20260724.5";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-2.1.0snapshot0.20260724.5.tar";
        sha256 = "05z2731p98qh0rljxcak9j7pvmim9kxj2jszvpdzpw4wfdkr3qd2";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  flycheck = callPackage (
    ...
    elpaBuild {
      pname = "flycheck";
      ename = "flycheck";
      version = "37.0.0.20260721.23";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/flycheck-37.0.0.20260721.23.tar";
        sha256 = "19b3ragpgg0sr6qkmacpis552qjnfsx8qg91g2mi5ndbf3giq8bg";
      };
      packageRequires = [ seq ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.5.0.20260724.68";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.5.0.20260724.68.tar";
        sha256 = "0bb76nmlsd6i98zwr7aygqzhmps0p165dsq8z68w7y1rwq39g9jg";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.7.0.20260722.30";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.7.0.20260722.30.tar";
        sha256 = "0fi3x425qnr6cascrbxxxmxsps0c634ziifrnbv3axk6s9s32l5v";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.7.0.20260722.30";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.7.0.20260722.30.tar";
        sha256 = "0knhwi90wy16yky71j1r34ylsmpzn8bm1f23asyylfpi3hvx5sqw";
      };
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.12.2.0.20260724.4";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.12.2.0.20260724.4.tar";
        sha256 = "16c55vrnr5myvk7x1cvixasr9jjz1j60xc4zn2d7idqpcjr39mnn";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.6.0.0.20260724.65";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.6.0.0.20260724.65.tar";
        sha256 = "12m8mp8jxkqsq6r4gwkwl1vbvcjlmsj96jfzzqclrnn4pzk61qp0";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.6.0.0.20260724.65";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.6.0.0.20260724.65.tar";
        sha256 = "06pnyg1aaq3kpjlqhvm0j7gj6fc7dabbq2aghqc0l093gh4cmnjg";
      };
      packageRequires = [
        compat
        cond-let
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "3.3.0snapshot0.20260724.30";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-3.3.0snapshot0.20260724.30.tar";
        sha256 = "16n4wq2j17n3r1s42dadvdyysbi0kads8czmmxc2bv3imm8rwyzl";
      };
      packageRequires = [ compat ];
      meta = {
