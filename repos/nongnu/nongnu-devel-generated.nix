{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.18.0snapshot0.20250423.112423";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.18.0snapshot0.20250423.112423.tar";
        sha256 = "1a59gmyl5vwivm7pn0p48rfx8n7k71bmim059dgc4cxc11ia2926";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.4.0snapshot0.20250423.120257";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.4.0snapshot0.20250423.120257.tar";
        sha256 = "0qdhr8wpw6x9w69yspa7978ka33jnnrdnwk6i14693mswlcmy6lj";
      };
      packageRequires = [ ];
      meta = {
  ...
  flycheck = callPackage (
    ...
    elpaBuild {
      pname = "flycheck";
      ename = "flycheck";
      version = "35.0.0.20250423.132120";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/flycheck-35.0.0.20250423.132120.tar";
        sha256 = "00ics5jrs9jz1ha32aqaplikmjvg2n6pa0qfx1iq2rlzhd8ci6af";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250423.174205";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250423.174205.tar";
        sha256 = "1hrqasma9qamac4i4bpz08isfmfrkivq20rphzkxx1vba6mh1pn2";
      };
      packageRequires = [
        compat
        transient
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0.20250418.133456";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.1.0.20250418.133456.tar";
        sha256 = "13h2n7aan1r7xl5qjrainghs589p1c0skvsrn3297siqgs0n8jr5";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.2.0.20250423.171846";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.2.0.20250423.171846.tar";
        sha256 = "02p3s79qnakp3i8c5r9h86iw53lb6jy9pqa52a58drab4f6j2x8c";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.2.0.20250423.171846";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.2.0.20250423.171846.tar";
        sha256 = "0msf9wanv421y8vqv3sr8ak2cc0ninj5n7jnipp4fj3fgclwkpd4";
      };
  ...
  markdown-mode = callPackage (
    ...
    elpaBuild {
      pname = "markdown-mode";
      ename = "markdown-mode";
      version = "2.8alpha0.20250403.112703";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/markdown-mode-2.8alpha0.20250403.112703.tar";
        sha256 = "1bl0w68vs25ryp2qh73ljks5ch05agg4bdzfl7wpyb2rdscdhi0c";
      };
      packageRequires = [ ];
      meta = {
  ...
  proof-general = callPackage (
    ...
    elpaBuild {
      pname = "proof-general";
      ename = "proof-general";
      version = "4.6snapshot0.20250419.101649";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/proof-general-4.6snapshot0.20250419.101649.tar";
        sha256 = "0rf7a9ym5aq6kh3zbnc8213frrfhaa4kyx7fy0za8g5vz9fvn7sk";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20250423.143818.tar";
        sha256 = "03wmxx0fka3kqbgr6d518jq9jwhka5l37865mnp5sm1arm2imwf9";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "26.12.20250419130746.0.20250419.130948";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-26.12.20250419130746.0.20250419.130948.tar";
        sha256 = "0g187y69bswmczmavz91ffydkfvjwhqsby28cccm77ijj495b05q";
      };
      packageRequires = [ ];
      meta = {
