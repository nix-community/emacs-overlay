{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.3.0.20260209.213741";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.3.0.20260209.213741.tar";
        sha256 = "1l7kfcrybjyx0rs7r003jsrja1svzv9w70bcpc9ypbi2gby04vpw";
      };
      packageRequires = [
        compat
        transient
