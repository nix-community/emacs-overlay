{ callPackage }:
{
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.4.0.0.20250517.73454";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.4.0.0.20250517.73454.tar";
        sha256 = "12dzp9idmph0nq85yvwl3znnfx2qdl2g27z4shyyh043081qj99d";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250522.193037";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250522.193037.tar";
        sha256 = "1jnh7x7zici44fs9p6dd4y5iz37w16smzirmgy1sba2p0zvbm8xj";
      };
      packageRequires = [
        compat
        transient
