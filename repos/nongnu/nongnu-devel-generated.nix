{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20250311.633";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20250311.633.tar";
        sha256 = "030ng9qbg3n17mb5acyl7vq5ja4hg1w11c8cmk83fbg249nn6hbf";
      };
      packageRequires = [
        compat
        transient
