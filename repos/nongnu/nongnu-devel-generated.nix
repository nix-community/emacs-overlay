{ callPackage }:
{
  ...
  geiser = callPackage (
    ...
    elpaBuild {
      pname = "geiser";
      ename = "geiser";
      version = "0.32.0.20250810.30852";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/geiser-0.32.0.20250810.30852.tar";
        sha256 = "11iwvcf4ndzjs2k8vl3jn3l6bw91jvlmyrnc6s9xd2si963myiml";
      };
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.5.0.20250809.205514";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.5.0.20250809.205514.tar";
        sha256 = "12ih85731lknb26d1j6nn16f2gd1q3ng56y2pa03041vx14qk5gn";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.4.0.20250809.81441";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.4.0.20250809.81441.tar";
        sha256 = "1rzklyfz6ydcc99hydwjf0yv0aary5283xcczpi3x11aaf3bcgcr";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.4.0.20250809.81441";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.4.0.20250809.81441.tar";
        sha256 = "0yjhgxgmdy5r1v433pg63xphdlpjvnssaqhhmriijkmkgv1jk227";
      };
  ...
  pg = callPackage (
    ...
    elpaBuild {
      pname = "pg";
      ename = "pg";
      version = "0.57.0.20250730.130322";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/pg-0.57.0.20250730.130322.tar";
        sha256 = "0rrgibc9vmcw84hyycyj5nnd82cgkrgbw7h91vc97vkji9ps7kbp";
      };
      packageRequires = [ peg ];
      meta = {
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.4.5.0.20250801.115254";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.4.5.0.20250801.115254.tar";
        sha256 = "104mfs1zfwrf8v7ny41avizdr1hpi3vwpdfv7gy940pckslcrd95";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "28.3.20250807101931.0.20250807.102025";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-28.3.20250807101931.0.20250807.102025.tar";
        sha256 = "10lvn5ql98d5wjvpaqndaqcqfmzb6sz9d7rydzfmwkna73v983f2";
      };
      packageRequires = [ ];
      meta = {
