{ callPackage }:
{
  ...
  vm = callPackage (
    ...
    elpaBuild {
      pname = "vm";
      ename = "vm";
      version = "8.3.0snapshot0.20250111.14006";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/vm-8.3.0snapshot0.20250111.14006.tar";
        sha256 = "0k8pddsm2c0mrfsd896088158jd5svrylgwl648bwgxb09j89alf";
      };
      packageRequires = [
        cl-lib
        nadvice
