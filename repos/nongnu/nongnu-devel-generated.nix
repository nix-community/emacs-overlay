{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.4.0.20250617.114530";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.4.0.20250617.114530.tar";
        sha256 = "11qylgliaajqczi2nvrv0xdd5rh0c46wr4ay2drhrnci58m0q27i";
      };
      packageRequires = [
        compat
        markdown-mode
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.19.0snapshot0.20250619.115909";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.19.0snapshot0.20250619.115909.tar";
        sha256 = "02ljyzvmqdwnn4yyq1pvga8i3kld7pjb9lqfb9k3msk9xyby2n6a";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.6.0snapshot0.20250621.45932";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.6.0snapshot0.20250621.45932.tar";
        sha256 = "0aaxw230lwgmiwwy187l3w4cxp1wyv8ngzff7pkj8kmmqimpchmk";
      };
      packageRequires = [ ];
      meta = {
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.1.0.20250622.13927";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.1.0.20250622.13927.tar";
        sha256 = "05jbwp9iblxz3dvxccbgg0zv8lbvv6kb8pappm9jrlx3nb7xvwqi";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.5.0.20250622.105851";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.5.0.20250622.105851.tar";
        sha256 = "0772x5ldgz3pgrdgmcyw3wb8b580hfv2qb2i9wl3fc4qzavxi90x";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.4.0.20250621.74233";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.4.0.20250621.74233.tar";
        sha256 = "0s4fgpycsy30hkdnljk4sd3mg9kdyq51gmdl2ywp0x3wq0ayp3c2";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.4.0.20250621.74233";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.4.0.20250621.74233.tar";
        sha256 = "11vz6wyr5l6218yrham4lzs0akagcdbpifmi3g06vpdafvchvnyx";
      };
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.3.6.0.20250601.102812";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.3.6.0.20250601.102812.tar";
        sha256 = "1wjwzyc591viacq2zfmlhbjncpwnfywnjy48l386c8pga9ni5gz2";
      };
      packageRequires = [
        compat
        llama
  ...
  markdown-mode = callPackage (
    ...
    elpaBuild {
      pname = "markdown-mode";
      ename = "markdown-mode";
      version = "2.8alpha0.20250606.31450";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/markdown-mode-2.8alpha0.20250606.31450.tar";
        sha256 = "0rmafjq934zfff9aq730ihk5bbzkyqmfpyi2iv21z6msq79y9ijc";
      };
      packageRequires = [ ];
      meta = {
  ...
  proof-general = callPackage (
    ...
    elpaBuild {
      pname = "proof-general";
      ename = "proof-general";
      version = "4.6snapshot0.20250609.194752";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/proof-general-4.6snapshot0.20250609.194752.tar";
        sha256 = "0s0asjsmh2s8nwqk1vjan6vmg1ja9cn31pqb5aky4jvlnj3hhq2z";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20250609.112224.tar";
        sha256 = "1w4kbpxxj67is7vfgsv4wfql0ibiq910bwvsm1kpaj714qkd92fx";
      };
      packageRequires = [ compat ];
      meta = {
