{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.7.0.20250221.230520";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.7.0.20250221.230520.tar";
        sha256 = "1skq8yy7gqr73fwnvgcy1w3slpml0bpfjahigg7mbg6h2jimnm89";
      };
      packageRequires = [
        compat
        transient
