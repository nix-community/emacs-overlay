{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.21.0snapshot0.20260109.74333";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.21.0snapshot0.20260109.74333.tar";
        sha256 = "1kjzrn8bf2zvnyi7g8qmr6qsnwk9wp072s17mxp4y6vwgglfv8g1";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "0.2.1.0.20260101.182855";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-0.2.1.0.20260101.182855.tar";
        sha256 = "03hvmzg7hvawalkhg9b9jvrm2va7pgcl3rj11q8s7wyavi4m030q";
      };
      packageRequires = [ ];
      meta = {
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260108.224750";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260108.224750.tar";
        sha256 = "118h54628nfims1slfn9xq250lmsyvdib6srlcchqjv4ii34yld0";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260108.224750";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260108.224750.tar";
        sha256 = "04bipvk3sjy9n5pdhps885i0dd15riwh16vwn72f6hnjk4d03y2k";
      };
      packageRequires = [
        compat
        cond-let
  ...
  multiple-cursors = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.5.0.0.20260108.90920";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/multiple-cursors-1.5.0.0.20260108.90920.tar";
        sha256 = "1skizgn3baxh3sk7fplg8p3a8pdazcq4ns5k561lpvwj8qlw8kz2";
      };
      packageRequires = [ cl-lib ];
      meta = {
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.9.1.0.20260109.74226";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.9.1.0.20260109.74226.tar";
        sha256 = "0f130x20p9r9lx25irqaah6h2hld3jmcq9dmg6rvjh1g5a2ixg0s";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20260106.94405";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20260106.94405.tar";
        sha256 = "01cqc0ls652qhsccfjd2qx99q3pgnzzd43yn5d19szp8kk2pzk41";
      };
      packageRequires = [ compat ];
      meta = {
