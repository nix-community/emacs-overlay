{ callPackage }:
{
  ...
  casual = callPackage (
    ...
    elpaBuild {
      pname = "casual";
      ename = "casual";
      version = "2.17.0.0.20260715.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/casual-2.17.0.0.20260715.0.tar";
        sha256 = "04zc4iw0s0igrh0y8ccw5bz78myr002b25xsk08sjbw502r36bgn";
      };
      packageRequires = [
        csv-mode
        transient
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "2.0.1snapshot0.20260716.2";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-2.0.1snapshot0.20260716.2.tar";
        sha256 = "08gm3nyi41r8kclgyxmy0197p9lqm8g4l91bwy0n34w3dkqcl0gx";
      };
      packageRequires = [
        clojure-mode
        compat
  ...
  loopy = callPackage (
    ...
    elpaBuild {
      pname = "loopy";
      ename = "loopy";
      version = "0.16.1.0.20260705.9";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/loopy-0.16.1.0.20260705.9.tar";
        sha256 = "1bgng7905rah9q2csz122sp216wzyf786340pblqlgknfh031sgn";
      };
      packageRequires = [
        compat
        map
  ...
  php-mode = callPackage (
    ...
    elpaBuild {
      pname = "php-mode";
      ename = "php-mode";
      version = "1.26.1.0.20260715.58";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/php-mode-1.26.1.0.20260715.58.tar";
        sha256 = "10yx9l53v5qb8hc4pzql36k26md8afmivlgkbsvdg6h6m43wkk94";
      };
      packageRequires = [ ];
      meta = {
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "3.3.0snapshot0.20260715.2";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-3.3.0snapshot0.20260715.2.tar";
        sha256 = "19bb53x8nn2afx9yzn21yrify2hfy980qfr0vc72r5qbbmqbk372";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  slime = callPackage (
    ...
    elpaBuild {
      pname = "slime";
      ename = "slime";
      version = "2.32snapshot0.20260711.51";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/slime-2.32snapshot0.20260711.51.tar";
        sha256 = "1mai67gghpn7p79q2p4hjbm7qpj94azq5jvnrfl1dpg40r6qykyw";
      };
