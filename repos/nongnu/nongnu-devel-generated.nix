{ callPackage }:
{
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20241018.114543";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20241018.114543.tar";
        sha256 = "0ds8jf4b6m194pk8ab9y7d9bpqvzrka8a098vrk8lhkykbia7zcc";
      };
      packageRequires = [ ];
      meta = {
