{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.22.0snapshot0.20260428.84400";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.22.0snapshot0.20260428.84400.tar";
        sha256 = "1xxja9zfgnqcnsdd47w053fgkg7b6jynzyawvjfqrf90kwjarmp1";
      };
      packageRequires = [
        clojure-mode
        compat
