{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.16.0.0.20240924.195900";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.16.0.0.20240924.195900.tar";
        sha256 = "0wl963mp3q69m7ifk72azvcycwpk4acsc8b5rxx6lvm1xljwfhif";
      };
      packageRequires = [
        clojure-mode
        parseedn
