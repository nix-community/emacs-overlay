{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251003.172917";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251003.172917.tar";
        sha256 = "1r0995n4fi57al0h235mkrw0v07qvajamxz3lqdlzjbjwndzslrp";
      };
      packageRequires = [
        compat
        transient
