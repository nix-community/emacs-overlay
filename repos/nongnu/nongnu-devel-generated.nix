{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.3.0.20251109.802";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.3.0.20251109.802.tar";
        sha256 = "1764gp9pfcpp8p2pg5zkz3g8410am9a368akbv9qvn8m3r6llr3f";
      };
      packageRequires = [
        compat
        transient
