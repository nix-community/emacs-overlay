{ callPackage }:
{
  adoc-mode = callPackage (
    ...
    elpaBuild {
      pname = "adoc-mode";
      ename = "adoc-mode";
      version = "0.8.0.0.20260602.35";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/adoc-mode-0.8.0.0.20260602.35.tar";
        sha256 = "0xsqp008b7xpjkzh97122ygmx1gr7mamxa4ycps5qqsqqimb0dml";
      };
      packageRequires = [ ];
      meta = {
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260602.478";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260602.478.tar";
        sha256 = "0g97aqyizh4b5avkj0lfhvfjgpyxnrj6jmdfs7x5w7qhqcq0gpv0";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  evil = callPackage (
    ...
    elpaBuild {
      pname = "evil";
      ename = "evil";
      version = "1.15.0.0.20260601.293";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/evil-1.15.0.0.20260601.293.tar";
        sha256 = "1k9cy88l37rxiy12fnr8fbx0m323g1904nyx7yphxljrxr1y3shr";
      };
      packageRequires = [
        cl-lib
        goto-chg
