{ callPackage }:
{
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.5.0.20250813.175922";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.5.0.20250813.175922.tar";
        sha256 = "05g46r38wagrsgyh9ncw3f3l3p5lwnxazilnzay4j95b5q3xirbb";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.5.0.20250812.171615";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.5.0.20250812.171615.tar";
        sha256 = "1syklb96hhls196479d3zpbxy3cm7rlhb7jk4y8qa76vk8jg40kx";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.4.0.20250813.33052";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.4.0.20250813.33052.tar";
        sha256 = "1rwngfgq4f8mdv1gl5fjzh7259l6afvw6042wadk0064avkws595";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.4.0.20250813.33052";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.4.0.20250813.33052.tar";
        sha256 = "1yfwskay8bp7s4xcnvl44rknwlwfikhavp97xy0n7fglyiawhjsh";
      };
  ...
  pg = callPackage (
    ...
    elpaBuild {
      pname = "pg";
      ename = "pg";
      version = "0.58.0.20250813.134611";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/pg-0.58.0.20250813.134611.tar";
        sha256 = "116hlglphqa1rq7ybj0dsi7nbwqspcjqkvi7swpaimfyh6cy165p";
      };
      packageRequires = [ peg ];
      meta = {
