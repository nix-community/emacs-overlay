{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.1.0.20250325.33235";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.1.0.20250325.33235.tar";
        sha256 = "0qdjvamjavad8rbybkbwy4vrvwzha42xv9qafzi8scc7fdyfw7v2";
      };
      packageRequires = [
        compat
        transient
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.18.0snapshot0.20250321.70355";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.18.0snapshot0.20250321.70355.tar";
        sha256 = "19cvqx7zh6ncddrlb2jzciy34wgkq14j8pmgqaxy26nrkksg6yq4";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.4snapshot0.20250325.70315";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/clojure-ts-mode-0.2.4snapshot0.20250325.70315.tar";
        sha256 = "1212qf2jn2k5m6my1a4ig54hbfmc7ha5561w64q5q0xx5wsl79j6";
      };
      packageRequires = [ ];
      meta = {
  ...
  dirvish = callPackage (
    ...
    elpaBuild {
      pname = "dirvish";
      ename = "dirvish";
      version = "2.2.7.0.20250324.225256";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dirvish-2.2.7.0.20250324.225256.tar";
        sha256 = "17sbi7pdx6spkqvi11j5p2awp0hzfi4sbygbcy7m9vapg1zl29kz";
      };
      packageRequires = [ ];
      meta = {
  ...
  dracula-theme = callPackage (
    ...
    elpaBuild {
      pname = "dracula-theme";
      ename = "dracula-theme";
      version = "1.8.2.0.20250324.140302";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/dracula-theme-1.8.2.0.20250324.140302.tar";
        sha256 = "1xsxql5689fk34z90hfb6nsjkf80sqi6sbz5i4sgwv35wvj4x4ps";
      };
      packageRequires = [ ];
      meta = {
  ...
  eglot-inactive-regions = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.6.4.0.20250323.83845";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/eglot-inactive-regions-0.6.4.0.20250323.83845.tar";
        sha256 = "0f7rv0vn9rk9h5cwms3n1i1i91g9x3jqr1jag3lg1wvcf2vr34an";
      };
      packageRequires = [ ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.8.0.20250324.193751";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.8.0.20250324.193751.tar";
        sha256 = "0h9a3bbzry6r1wlncd2hfzn8abc2p6jsyv6lcisr5krigk2697sd";
      };
      packageRequires = [
        compat
        transient
  ...
  haskell-mode = callPackage (
    ...
    elpaBuild {
      pname = "haskell-mode";
      ename = "haskell-mode";
      version = "17.5.0.20250324.192155";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-mode-17.5.0.20250324.192155.tar";
        sha256 = "1cijsh414mm484cgbk40qqlsjidxlggrdq9ppi7a278aczhpnnjr";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.2.0.20250325.43947";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.2.0.20250325.43947.tar";
        sha256 = "0wjzqfrzy25xkxgh89hg7da7cyi77nbrvd900glh04jp244rilsd";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.2.0.20250325.43947";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.2.0.20250325.43947.tar";
        sha256 = "0kwy9dl7rrx6xzhw9cv1njmja8hjmfy0y8z00gav8gc7zvvpakyd";
      };
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.3.1.0.20250323.130640";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.3.1.0.20250323.130640.tar";
        sha256 = "1qxvhkirn9ydqdrffnbh6r6dpv3d9xhxfngzq55whskzyh1ay0sv";
      };
      packageRequires = [
        compat
        llama
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.3.1.0.20250323.130640";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.3.1.0.20250323.130640.tar";
        sha256 = "0jgan1a9z3ab9l6s4aicrz1jg06jk9znbi1ly5q41rkd2m1ij8km";
      };
      packageRequires = [
        compat
        llama
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "26.11.20250324000003.0.20250324.145";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-26.11.20250324000003.0.20250324.145.tar";
        sha256 = "16gjwv6rznkpwdwmq2bf5dv5dkb08p7qzwjmca5p50zgnqhg1d1q";
      };
      packageRequires = [ ];
      meta = {
