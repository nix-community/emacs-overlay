{ callPackage }:
{
  ...
  flycheck = callPackage (
    ...
    elpaBuild {
      pname = "flycheck";
      ename = "flycheck";
      version = "35.0.0.20260211.204741";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/flycheck-35.0.0.20260211.204741.tar";
        sha256 = "1swdi3c9643hxmdbxdgdkrbfyly0k8wb9nfb8h6vrsvff75lh65q";
      };
      packageRequires = [ seq ];
      meta = {
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.6.0.0.20260202.35243";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.6.0.0.20260202.35243.tar";
        sha256 = "11afg636q46018d1ahg7jhl5i5fq9lq0k53yqw2qhzwvmrrxgplm";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.3.0.20260212.235446";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.3.0.20260212.235446.tar";
        sha256 = "00fxp5zsl6b7a8wkbjjkb9kzr85d86imqmls7kk4xgzdnyx12i8r";
      };
      packageRequires = [
        compat
        transient
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.6.0.20260208.71803";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.6.0.20260208.71803.tar";
        sha256 = "1r5y5ffsi4v0gyv8d55rr3ngkf13cgy3dfdl18b78wdcx367aka7";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.6.0.20260208.71803";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.6.0.20260208.71803.tar";
        sha256 = "1m33lsr7aqvxs79ypjh75yym0kvsb06vmddrdrx6p8w8k13dvpmw";
      };
  ...
  isl = callPackage (
    ...
    elpaBuild {
      pname = "isl";
      ename = "isl";
      version = "1.6.0.20260212.202656";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/isl-1.6.0.20260212.202656.tar";
        sha256 = "0fc8lx4z7j8cqhw2k8zc4ykgl8x86qshbpdm5j0i5gddzrrybkgq";
      };
      packageRequires = [ ];
      meta = {
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260212.165537";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260212.165537.tar";
        sha256 = "1jr1lpkmw9h1fl08aiy135qqps2apmjwcln9k3q9g6n9yjcmzscg";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260212.165537";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260212.165537.tar";
        sha256 = "1ljhqjl4mar965pn68xi64l0n1pw94bjigssl9ad2cyvmmx48s2h";
      };
      packageRequires = [
        compat
        cond-let
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.9.1.0.20260213.80255";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.9.1.0.20260213.80255.tar";
        sha256 = "145w6prk09ycbnw7970j72gmb65sc0amllgah0kmnfci0xyimivv";
      };
      packageRequires = [ ];
      meta = {
