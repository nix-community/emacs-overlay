{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.9.0.20260720.2";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.9.0.20260720.2.tar";
        sha256 = "1z7fl2ljcsnsjxlsvnaqb2r9rxdy9pblvd8ww9sysjsx58y1gjlw";
      };
      packageRequires = [
        compat
        markdown-mode
