{ callPackage }:
{
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.15.1.0.20240813.183210";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.15.1.0.20240813.183210.tar";
        sha256 = "1wyf4wgisdq1g9a7rbhd7i5jgqrn68qdik9sc72xklvy6pil91l5";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  git-commit = callPackage (
    ...
    elpaBuild {
      pname = "git-commit";
      ename = "git-commit";
      version = "4.0.0.0.20240811.151155";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/git-commit-4.0.0.0.20240811.151155.tar";
        sha256 = "0l6wf0z6y6scykyjpm1cd5whm2r2s1a6hfd7jgzcgsplaa7pxr1f";
      };
      packageRequires = [
        compat
        seq
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "3.9.9.0.20240813.192005";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-3.9.9.0.20240813.192005.tar";
        sha256 = "0k7yn4yklwfhlklhbbg8d0xq7h40a3xa7b4n19ay178vcmc780vg";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "3.9.9.0.20240813.192005";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-3.9.9.0.20240813.192005.tar";
        sha256 = "0y5fmm49g5c0zisbsvj7gfndh1afkg954pkvz2k6j0r1n9fxbr0a";
      };
  ...
  magit = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.0.20240811.151155";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.0.0.0.20240811.151155.tar";
        sha256 = "11vbmqsxd96pbdpjfqq8lm38hqj7nms15082n28awf7scjakjg9i";
      };
      packageRequires = [
        compat
        dash
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.0.0.20240811.151155";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.0.0.0.20240811.151155.tar";
        sha256 = "19vgckpx71pjqzv20bjrhabvqyxac2avlgphlm1a40nsgd3yc7bi";
      };
      packageRequires = [
        compat
        dash
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.4.1.0.20240806.145443";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.4.1.0.20240806.145443.tar";
        sha256 = "05dn1zpadc4vh43faav2m62wvr7jrlif4c1sk0dddjc9gjlafw69";
      };
      packageRequires = [ compat ];
      meta = {
