{ callPackage }:
{
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260516.105915";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260516.105915.tar";
        sha256 = "0zb00vixmvawh0hbdsfhcviy4jf3zcv54ginsjxnvxl355xgncij";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260516.144432";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260516.144432.tar";
        sha256 = "0slwp5kr064ifb2r8glp8w3xj3ccrspj7jpa7qiv9bq88misnkxd";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260516.144432";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260516.144432.tar";
        sha256 = "0byif7nxarzp9rl8adjr8547im5h3ifzqabi3naijrnh58ipdy22";
      };
      packageRequires = [
        compat
        cond-let
  ...
  simple-httpd = callPackage (
    ...
    elpaBuild {
      pname = "simple-httpd";
      ename = "simple-httpd";
      version = "1.5.1.0.20260515.121404";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/simple-httpd-1.5.1.0.20260515.121404.tar";
        sha256 = "17bx2gnr3icrhink68prrbl8jz2ikrgjqb93biqmx6crrn64mb0s";
      };
      packageRequires = [ compat ];
      meta = {
