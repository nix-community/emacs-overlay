{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.3.0.20251123.234209";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.3.0.20251123.234209.tar";
        sha256 = "0cn9vi6rccfqyp87ws0vqnvqz71cy8jsqz4bzz8a4dkxsfjl598x";
      };
      packageRequires = [
        compat
        transient
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.4.2.0.20251124.213405";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.4.2.0.20251124.213405.tar";
        sha256 = "1zffzmkvm32hjbp7n6w1nphzlixzw60dv1zdswrdrqmsihj5x5rb";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.4.2.0.20251124.213405";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.4.2.0.20251124.213405.tar";
        sha256 = "0w53af9g13gr3177622f1j3qg7d08mbyxyr1wvfis444p5wjzyp3";
      };
      packageRequires = [
        compat
        cond-let
  ...
  org-mime = callPackage (
    ...
    elpaBuild {
      pname = "org-mime";
      ename = "org-mime";
      version = "0.3.4.0.20251123.234218";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/org-mime-0.3.4.0.20251123.234218.tar";
        sha256 = "0z4rirzbhap93p4sv1ziwd2zjwfa06xc845basf6a7hql8cms4qw";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      version = "28.11.20251123201632.0.20251123.202307";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/xah-fly-keys-28.11.20251123201632.0.20251123.202307.tar";
        sha256 = "1ggjld21l8i1f5grm3pypc5l2hvvgwamajq27xnisymzvm2wykkf";
      };
      packageRequires = [ ];
      meta = {
