{ callPackage }:
{
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260503.163100";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260503.163100.tar";
        sha256 = "11naiszb984l3isxvq3rzi03jd407h7xaldz3yy8fjd9gh06y2dv";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  gnuplot = callPackage (
    ...
    elpaBuild {
      pname = "gnuplot";
      ename = "gnuplot";
      version = "0.11.0.20260502.103134";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnuplot-0.11.0.20260502.103134.tar";
        sha256 = "1308hl2mwpdlappmi2qz5f2k3sgrxg70b1fr6j6254vbx82g1ll1";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.4.0.20260503.114603";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.4.0.20260503.114603.tar";
        sha256 = "1qzg00l5p73qsiwkfv6x9rmmg4bp2fxfyzsmsnqxs141cb111b37";
      };
      packageRequires = [
        compat
        transient
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.10.6.0.20260503.165034";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.10.6.0.20260503.165034.tar";
        sha256 = "0zj0b8n7drbf8lsnxb4j4d8ha0f3hwyxdrcqb58i3v8cskdih4z2";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260502.103651";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260502.103651.tar";
        sha256 = "10cz6j0f1g01wvzan9g7zfrc8iryhwva6fp56fiaq29hjkyz81r9";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260502.103651";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260502.103651.tar";
        sha256 = "0p3apg8bfagdj3ar16ix8bfqdl9k89a4bn02rib4z21q9hyww3y4";
      };
      packageRequires = [
        compat
        cond-let
