{ callPackage }:
{
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "0.1.0.0.20250829.152948";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-0.1.0.0.20250829.152948.tar";
        sha256 = "1yn21v7hqmkarxw8alyi05zggsi3apwjga9rzm8b3hlpcabcklhk";
      };
      packageRequires = [ ];
      meta = {
  ...
  emacsql = callPackage (
    ...
    elpaBuild {
      pname = "emacsql";
      ename = "emacsql";
      version = "4.3.1.0.20250829.153001";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/emacsql-4.3.1.0.20250829.153001.tar";
        sha256 = "1w4fb3sdhapd71jvn8cwv8r8rnsy0fb2zv3d9pvb9y8gky4wf81a";
      };
      packageRequires = [ ];
      meta = {
  ...
  git-modes = callPackage (
    ...
    elpaBuild {
      pname = "git-modes";
      ename = "git-modes";
      version = "1.4.5.0.20250829.153303";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/git-modes-1.4.5.0.20250829.153303.tar";
        sha256 = "1fw7pp23402w1mcdl1v1sg55bcsqww8xbci8hslbdkqpr7scxvib";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.5.0.20250828.92820";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.5.0.20250828.92820.tar";
        sha256 = "1zyd82rjp9h5mgilgc02xz03vvakd7d9j7ryyicy74gkpjv9pq75";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.5.0.20250828.92820";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.5.0.20250828.92820.tar";
        sha256 = "1z6k5cfab8bqw9461lw1n2nhang27647a8sra1s9j8i0y03zwq33";
      };
  ...
  keycast = callPackage (
    ...
    elpaBuild {
      pname = "keycast";
      ename = "keycast";
      version = "1.4.4.0.20250829.153140";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/keycast-1.4.4.0.20250829.153140.tar";
        sha256 = "1kpkgbml39ccz1yhwmgsql78klr5crid5l91z9g16aws9arkdwcw";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llama = callPackage (
    ...
    elpaBuild {
      pname = "llama";
      ename = "llama";
      version = "1.0.0.0.20250829.153154";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/llama-1.0.0.0.20250829.153154.tar";
        sha256 = "054q51pswql0bzsidspplnspqvjpklwplc531h3k829854nl656j";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  orgit = callPackage (
    ...
    elpaBuild {
      pname = "orgit";
      ename = "orgit";
      version = "2.0.3.0.20250829.153208";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/orgit-2.0.3.0.20250829.153208.tar";
        sha256 = "1ky99fglq69f9b5qiahair1bsv843yj4cjwbzw087247qjsgvxal";
      };
      packageRequires = [
        compat
        magit
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20250828.110715";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20250828.110715.tar";
        sha256 = "1mls1mj2wjlrk1na77m8q2i82m1lm4mcqxff2ngv1ijjlhvrp813";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.4.5.0.20250829.153220";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.4.5.0.20250829.153220.tar";
        sha256 = "1xxmb5gmsgwyj19pmmpc6f1s32k1hfrn3kj24l7wr5mgnglq5bli";
      };
      packageRequires = [ compat ];
      meta = {
