{ callPackage }:
{
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.6.0.20251016.40241";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.6.0.20251016.40241.tar";
        sha256 = "12jmwc7q4qp1pjvr9v5qnqs1p00g8snn6hbw9xs1275m9jcggwg4";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251022.100650";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251022.100650.tar";
        sha256 = "1455vis6mcnf5a03zqwar0zks631661l810h4jj25xhssbz0drlv";
      };
      packageRequires = [
        compat
        transient
