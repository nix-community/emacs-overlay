{ callPackage }:
{
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.3.0.0.20250628.71812";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.3.0.0.20250628.71812.tar";
        sha256 = "1g3i2w3hp3hvvhjzhzgf32xg4g56fz1nwwjfhwb5nplia5dxaqp9";
      };
      packageRequires = [ ];
      meta = {
