{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20250927.132404";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20250927.132404.tar";
        sha256 = "0a8bfciswsm895zn9f6v4jclhlm7bg1pm1smyi3r6pvphxvf9f9c";
      };
      packageRequires = [
        compat
        transient
