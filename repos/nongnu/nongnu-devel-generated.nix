{ callPackage }:
{
  ...
  aidermacs = callPackage (
    ...
    elpaBuild {
      pname = "aidermacs";
      ename = "aidermacs";
      version = "1.5.0.20251020.162739";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/aidermacs-1.5.0.20251020.162739.tar";
        sha256 = "1ncwn3iac8dr3rmmb1zbxif53v6h47kx4zc41cqi65ylnjpq1vgn";
      };
      packageRequires = [
        compat
        markdown-mode
  ...
  cider = callPackage (
    ...
    elpaBuild {
      pname = "cider";
      ename = "cider";
      version = "1.20.0snapshot0.20251028.60325";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cider-1.20.0snapshot0.20251028.60325.tar";
        sha256 = "1lzz3lvpmr8pciaigjjxbqi3rar98wlh9xgphgja9vz6i1r2r7rq";
      };
      packageRequires = [
        clojure-mode
        parseedn
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "0.1.1.0.20251031.1718";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-0.1.1.0.20251031.1718.tar";
        sha256 = "0nvajgfnz82pvzygdr2908h29sfqc38j2vxp3sr80d7v142s6kds";
      };
      packageRequires = [ ];
      meta = {
  ...
  emacsql = callPackage (
    ...
    elpaBuild {
      pname = "emacsql";
      ename = "emacsql";
      version = "4.3.2.0.20251031.1638";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/emacsql-4.3.2.0.20251031.1638.tar";
        sha256 = "07lhji2mjpjyqk2l888744xp267zl41wd1c95fgc35v5iv5i7gbd";
      };
      packageRequires = [ ];
      meta = {
  ...
  git-modes = callPackage (
    ...
    elpaBuild {
      pname = "git-modes";
      ename = "git-modes";
      version = "1.4.6.0.20251031.1514";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/git-modes-1.4.6.0.20251031.1514.tar";
        sha256 = "17a19kb8zy0k3wczk5jgnpa7yy6gfnxpz46xn7zqmn9bcbn4fb03";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  gnosis = callPackage (
    ...
    elpaBuild {
      pname = "gnosis";
      ename = "gnosis";
      version = "0.5.7.0.20251026.144001";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnosis-0.5.7.0.20251026.144001.tar";
        sha256 = "1brnja2kligjqnc53k4sb9h9i89hk8ybhp6gsfzlkzy6slk98mys";
      };
      packageRequires = [
        compat
        emacsql
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.0.20251030.195153";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.0.20251030.195153.tar";
        sha256 = "06kv6zfiq5wqa85zm8nklpdczir8pin2ic3wcmmjyxr0n5cjbgyr";
      };
      packageRequires = [
        compat
        transient
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.3.5.0.20251030.64652";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/haskell-ts-mode-1.3.5.0.20251030.64652.tar";
        sha256 = "01pf8gy9pij0kx64msdp9b6glpr0g023jwyzs4skcra1arf05s71";
      };
      packageRequires = [ ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.6.0.20251029.53517";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.6.0.20251029.53517.tar";
        sha256 = "0fqs5gz4qvzpzy7kw7rn084m3rs18iih8fvaiyxp9ximwsb9p7cg";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.6.0.20251029.53517";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.6.0.20251029.53517.tar";
        sha256 = "1amss3akgk1nbb1iwqp7m8b2537a2awc3z4yv9ddp8idm2xzm68i";
      };
  ...
  keycast = callPackage (
    ...
    elpaBuild {
      pname = "keycast";
      ename = "keycast";
      version = "1.4.5.0.20251031.1539";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/keycast-1.4.5.0.20251031.1539.tar";
        sha256 = "0p4kzqx0x2fcmscq6zy5w0m5zc8nap3gvgnynkjzicwyf7h4j1ld";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llama = callPackage (
    ...
    elpaBuild {
      pname = "llama";
      ename = "llama";
      version = "1.0.1.0.20251031.1653";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/llama-1.0.1.0.20251031.1653.tar";
        sha256 = "1lm5wpwmzrya14x4c2mk915himnhx9pvz994zzl8p1sijd9pnyr4";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  loopy = callPackage (
    ...
    elpaBuild {
      pname = "loopy";
      ename = "loopy";
      version = "0.14.0.0.20251013.15429";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/loopy-0.14.0.0.20251013.15429.tar";
        sha256 = "0jsj841ch2qrz8b626hpacdads6nz29wpkfks7qcsz4j3n7khrb7";
      };
      packageRequires = [
        compat
        map
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.4.2.0.20251025.175548";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.4.2.0.20251025.175548.tar";
        sha256 = "1fxn8gwykkbm8zr7spz0jcjf8pfjm86m1dsv71ygx9vmfrr1hgpk";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.4.2.0.20251025.175548";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.4.2.0.20251025.175548.tar";
        sha256 = "1sc0z3x1883snm9nsac3fblxsqhj6b238qx5yhrj9hnvw2dfyagq";
      };
      packageRequires = [
        compat
        cond-let
  ...
  orgit = callPackage (
    ...
    elpaBuild {
      pname = "orgit";
      ename = "orgit";
      version = "2.0.5.0.20251031.1607";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/orgit-2.0.5.0.20251031.1607.tar";
        sha256 = "09ppl06h7g9zckvsm6dhhslpzrrinwcx388r5yhzgynhganf4k28";
      };
      packageRequires = [
        compat
        magit
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      version = "1.0.20251029.163833";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/racket-mode-1.0.20251029.163833.tar";
        sha256 = "00pkh1laj5b7d7vplz8623l1a4vryx700nlvsv9ai4yvi049vyh6";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  slime = callPackage (
    ...
    elpaBuild {
      pname = "slime";
      ename = "slime";
      version = "2.31snapshot0.20251020.185538";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/slime-2.31snapshot0.20251020.185538.tar";
        sha256 = "1b7fdagmhbbpwm9grpm67869s4rrsr2mkygk0dwq4rwggpzm0xz5";
      };
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.4.6.0.20251030.222848";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.4.6.0.20251030.222848.tar";
        sha256 = "0cd0a71r1n27x9l3kjy7wpz8wp16017n0hdbvd0dh59qqgga7jpa";
      };
      packageRequires = [ compat ];
      meta = {
