{ callPackage }:
{
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20240924.164110.tar";
        sha256 = "12q1arbz6kpmvp486ar7sy2r6d5r64d0l1qpj6mzpbma1grchxwj";
      };
      packageRequires = [ ];
      meta = {
  ...
  subed = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.2.15";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/subed-1.2.15.tar";
        sha256 = "08b1ln5idclxr8jdq7san05lf3sm3iqg56v7h0yjdsxfjaqbw00a";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-26.4.20240926100036.tar";
        sha256 = "08lz1yvghp3cbq2dmvq7ma6h5w8jmad223gk6d0525ydl43ib6w7";
      };
      packageRequires = [ ];
      meta = {
