{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.22.2";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.22.2.tar";
          sha256 = "1sq4r3np34fcgn844n0dz6x1vgy0c49whz8k8h6vy37s9fv9m56y";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.6.20230815153238.tar";
          sha256 = "0l9nyrbqq56lqvf0dhlqcr4l1i4n670rdwy39vn8qm7jrwxmi09r";
        };
        packageRequires = [ emacs ];
        meta = {
