{ callPackage }:
{
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/clojure-ts-mode-0.3.0.tar";
        sha256 = "02zgwr62raffih1l4qygqnhqf1s4l07nvfgzqygwbjj5799s9210";
      };
      packageRequires = [ ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20250501.150023.tar";
        sha256 = "0jx8nlrq79j9yjsla0w68i20in2nl0wb3jhrb3arrpm3m7f62qw9";
      };
      packageRequires = [ ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-26.12.20250419130746.tar";
        sha256 = "112w5vcjai9dqkxksp5cjbp5zw1k4yhlp0530sp4mcqgzb1jb1dv";
      };
      packageRequires = [ ];
      meta = {
