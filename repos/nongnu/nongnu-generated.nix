{ callPackage }:
{
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.12.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/jabber-0.12.1.tar";
        sha256 = "0l788pyhm7kb1b6bwm51zg20ipa7cwyk5y1sxqysnjqlz7bmhk3w";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-28.11.20260709144945.tar";
        sha256 = "0fa34hd6x296b6cyizvpzl8nlnz9kvim5qkgcq8ccgsmrkripkva";
      };
      packageRequires = [ ];
      meta = {
