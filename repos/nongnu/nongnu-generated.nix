    ...
    annotate = callPackage ({ elpaBuild, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1bpqg6pgsrm3n3mh0zqbdp9xwwya319dz33ranf88rxisj0b89az";
        };
        packageRequires = [];
        meta = {
    ...
    buttercup = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1yackq1rkz2slyh9nlngizbr1aqg82dcwy2113nay1s4z00lvb1g";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    package-lint = callPackage ({ elpaBuild, emacs, fetchurl, let-alist, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1alcvlwcbf5mklyi9bf38yd2557sl1rnqvrpyf789gp2j36xbbsj";
        };
