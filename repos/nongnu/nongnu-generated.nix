{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.14.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.14.0.tar";
          sha256 = "1w5xwi0ywx7ckjdmigf2r28a3b87wzwzvc783k3pbmrggg00kyl6";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-22.7.20230125182943.tar";
          sha256 = "0b8wphpxv4b24fmk0c8aqc86p02yara74vw8s5yispfpr3a1l5zd";
        };
        packageRequires = [ emacs ];
        meta = {
