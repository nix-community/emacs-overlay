{ callPackage }:
{
  ...
  clojure-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.5.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/clojure-ts-mode-0.5.0.tar";
        sha256 = "1al5dzl64wjijkxycmdfbq8s0vqhym6z0lrgm17yklcdankqiq3j";
      };
      packageRequires = [ ];
      meta = {
  ...
  haskell-ts-mode = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.2.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/haskell-ts-mode-1.2.1.tar";
        sha256 = "0qhzg7n9v1qllz39whzxxcl6s7x1zh5psga2kqva0r11bhck4jjv";
      };
      packageRequires = [ ];
      meta = {
