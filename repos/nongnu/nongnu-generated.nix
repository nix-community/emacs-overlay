{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.26.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.26.1.tar";
          sha256 = "1hjj72x47p64zfdqgxslwsfhc3332z45g8ribz67zjfbf6ldlraq";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.15.20231102161602.tar";
          sha256 = "03xd142140aq8f8wv8d973qb1kcqjs3hh4wivd8y1czbisbannvj";
        };
        packageRequires = [ emacs ];
        meta = {
