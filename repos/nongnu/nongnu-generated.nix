{ callPackage }:
  {
    ...
    cider = callPackage ({ clojure-mode
      ...
      elpaBuild {
        ...
        version = "1.12.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/cider-1.12.0.tar";
          sha256 = "17vikav3mxw7fz9xryr2qlqb3i1yw3nr9wwzi027kxc117c2j4m6";
        };
        packageRequires = [
          clojure-mode
          emacs
    ...
    racket-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "racket-mode";
        ename = "racket-mode";
        version = "1.0.20231224.162603";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20231224.162603.tar";
          sha256 = "1dnqbmjafvw0w6ipdrdl8p98lbv973w73wwsba598pm4fp5mpgm3";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    sweeprolog = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.27.3";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.27.3.tar";
          sha256 = "0h3h9l3g205wwcz15g0pacr0ly96jalldsk08m6nw1773iiicwk1";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.19.20240101152046.tar";
          sha256 = "02idh38spwj6v73rn3bczs3hcrvckqrha8cd26ds6bprp6yg99b7";
        };
        packageRequires = [ emacs ];
        meta = {
