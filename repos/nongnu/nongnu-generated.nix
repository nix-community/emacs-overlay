{ callPackage }:
  {
    ...
    helm-core = callPackage ({ async, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "3.9.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/helm-core-3.9.1.tar";
          sha256 = "1i8xwin5bcv9xdcwxk8hrc22dfbp28xny2nb0h7lpbwh839fzm21";
        };
    ...
    opam-switch-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "1.5";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/opam-switch-mode-1.5.tar";
          sha256 = "033lpa4rqbhmzry4xkqh2fgcg4zh8xxkjwmsjp5gr1nxcfcqc92h";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    sweeprolog = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.21.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.21.0.tar";
          sha256 = "0m7bzb7mdaw59vkycl3nh0x7gvhnclrvyf2w3kkdj2pyk7dshidh";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-23.13.20230713112850.tar";
          sha256 = "08rvf908a9k80qi5b6kgzzcm7z50yzjsmhbsl1901jz8d84m2y73";
        };
        packageRequires = [ emacs ];
        meta = {
