{ callPackage }:
{
  ...
  org-superstar = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.6.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/org-superstar-1.6.0.tar";
        sha256 = "1w0fqf44wc2ri7bwm9lzwnsrl72n15qzvckljdl4mh97m133pb6i";
      };
      packageRequires = [ org ];
      meta = {
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20250828.110715.tar";
        sha256 = "0rb19fjixxsa9301w21slxarhs9h2f72b6cl1sd7ik06r7da36rg";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-28.4.20250829124616.tar";
        sha256 = "1xy25lk4ia07zwykfymiw54h9zqxnmf5f6dfc0fijxljg7qmaq7g";
      };
      packageRequires = [ ];
      meta = {
