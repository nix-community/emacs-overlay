{ callPackage }:
  {
    ...
    cider = callPackage ({ clojure-mode
      ...
      elpaBuild {
        ...
        version = "1.15.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/cider-1.15.0.tar";
          sha256 = "1x49ln9b057ymn34ynx3iqan7b59afyc0biqjj0qbkng83lpnlms";
        };
        packageRequires = [
          clojure-mode
          emacs
    ...
    racket-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        pname = "racket-mode";
        ename = "racket-mode";
        version = "1.0.20240620.135010";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20240620.135010.tar";
          sha256 = "0gmf0f3hg5hi1lmxhxh4xkgh2iknajnx3mnp2k2dxh46rk27gj1y";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    with-editor = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "3.3.3";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/with-editor-3.3.3.tar";
          sha256 = "1mgra6xpdkiq14shzsk3dfg53qjygz8gj56ikrxyhw608nryl9xc";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-25.8.20240619081048.tar";
          sha256 = "1lxns64iwhb44jd7lh7d6skk3ra2mqfi8h8m0s0vy6c1jkjbcfag";
        };
        packageRequires = [ emacs ];
        meta = {
