{ callPackage }:
  {
    ...
    highlight-parentheses = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "2.2.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/highlight-parentheses-2.2.1.tar";
          sha256 = "07k2jzrgy64gg89x6nmhlb1zv9lc6j4cj9j6m5vscwbas3s34scc";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    racket-mode = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1mx4173zgfv3fz5dazvyhjan3njwlgplnpnzk1vwkqy7z4wx2cm1";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    slime = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib, macrostep }:
      elpaBuild {
        ...
        src = fetchurl {
          ...
          sha256 = "1s9r2vhrrqix8h2q1iczlics93n1hp86p0idyri9czszdi3a00dy";
        };
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.24.20240406145635.tar";
          sha256 = "0f52xj72xfdz7w0ffrni6736bs0j383a4bwqbx79byf6g3xswadi";
        };
        packageRequires = [ emacs ];
        meta = {
