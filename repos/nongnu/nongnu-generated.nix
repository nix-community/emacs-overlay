{ callPackage }:
{
  ...
  hyperdrive = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.4.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/hyperdrive-0.4.1.tar";
        sha256 = "16y1ly3yvz6r5milf2bzf8rhnbl0009bay7d6jslnsqnp9ciy653";
      };
      packageRequires = [
        compat
        map
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20240914.104237.tar";
        sha256 = "1698nwlm3npk1wrykkrxqxakcx244y87ygxs2x08dgp6r4xl37i5";
      };
      packageRequires = [ ];
      meta = {
