{ callPackage }:
{
  ...
  mastodon = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.5";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/mastodon-1.1.5.tar";
        sha256 = "1j8w7qvd7d15sp1x9bj5pdn9nlxydy04xa2yisrr6vv9l9dx9i4j";
      };
      packageRequires = [
        persist
        request
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20241103.192733.tar";
        sha256 = "1y62svjml3kv06rdb0bfp77i47z3m02jxjdsqgjzjf9zhw4d1nch";
      };
      packageRequires = [ ];
      meta = {
  ...
  subed = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.2.18";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/subed-1.2.18.tar";
        sha256 = "1h289dgglwcaz1gy53950frxw9s9yjjdkpcwkzrjs0v2bipr2f0y";
      };
      packageRequires = [ ];
      meta = {
  ...
  ujelly-theme = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.3.2";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/ujelly-theme-1.3.2.tar";
        sha256 = "0069znmsnlipz1ahzmhfq3dxf282k4drz6zx2bf5vbrbk82nvk0b";
      };
      packageRequires = [ ];
      meta = {
