{ callPackage }:
{
  ...
  eldoc-mouse = callPackage (
    ...
    elpaBuild {
      ...
      version = "3.0.4";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/eldoc-mouse-3.0.4.tar";
        sha256 = "15igklj0qiq1c5nk3gyh6p09vzqb8vwjhjx52jiyrfm6yc9bwz70";
      };
      packageRequires = [
        eglot
        posframe
  ...
  mastodon = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.0.12";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/mastodon-2.0.12.tar";
        sha256 = "0vk6qynz29b0lcmr6l457x1b9v9svck3ar919wsc1xfa9x2xhfd0";
      };
      packageRequires = [
        persist
        tp
