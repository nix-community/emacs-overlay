{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.25.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.25.1.tar";
          sha256 = "0v2wk79fp7k8385056hnhhsczi2fk0ff72akc7gvri080z9gl8an";
        };
        packageRequires = [ compat emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.11.20230921082343.tar";
          sha256 = "05kx4jgpqcani94zzj9fg5i4516x7ksbii5avrr9fdkldqp06mkb";
        };
        packageRequires = [ emacs ];
        meta = {
