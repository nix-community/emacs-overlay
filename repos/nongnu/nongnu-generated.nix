{ callPackage }:
  {
    ...
    cider = callPackage ({ clojure-mode
      ...
      elpaBuild {
        ...
        version = "1.14.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/cider-1.14.0.tar";
          sha256 = "1x8hddy77v2kjk0071lmpsr6dxm8l86girzf01hwrh06gybw6wrm";
        };
        packageRequires = [
          clojure-mode
          emacs
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-25.8.20240606205522.tar";
          sha256 = "1bdj5vq2kwgcl98wvai140mfyb2ckr90g5ifln8b4018lxv4ayyc";
        };
        packageRequires = [ emacs ];
        meta = {
