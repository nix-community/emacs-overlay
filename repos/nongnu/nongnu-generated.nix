{ callPackage }:
  {
    ...
    eat = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.7";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/eat-0.7.tar";
          sha256 = "1znz13aijwda66c57faw1zif7in7cz2snj5dk4pk140sd809lzv8";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-23.10.20230404113004.tar";
          sha256 = "0rm8j83pv3sp484p9ilc76z6kbfh415lmb5vbcjyrzv7g43i0wgl";
        };
        packageRequires = [ emacs ];
        meta = {
