{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.22.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.22.1.tar";
          sha256 = "1hdnlcwmg1bm65jmgd11k382jxxwk6j0jmwm0nva3ch98y5g4xs2";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-24.4.20230807001101.tar";
          sha256 = "0rv4mrmlqk9nb62jvv290x5w2f2pabshl5rx8cnjqf13nxgyk5zh";
        };
        packageRequires = [ emacs ];
        meta = {
