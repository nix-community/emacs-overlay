{ callPackage }:
{
  ...
  mastodon = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/mastodon-1.1.0.tar";
        sha256 = "0r8di2yac5plslj3xxvvvcq70nn3vd2w8k65pfpp1wb2s32p44wg";
      };
      packageRequires = [
        persist
        request
  ...
  racket-mode = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20241018.114543.tar";
        sha256 = "0zr7xmcii0qfv53fa07kx134mwsy1xja0azzdyq0lwwmqv2qpn5d";
      };
      packageRequires = [ ];
      meta = {
