{ callPackage }:
  {
    ...
    geiser = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "0.25.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/geiser-0.25.1.tar";
          sha256 = "1b4mpvmj93jv332930nw9vn25kw7annis80lxhh20jx77bzx4s0n";
        };
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-17.20.20220819141933.tar";
          sha256 = "0dnxm3pq2n5ds98228r09k9z6gqsi5mpsx0pzwl5h27fvjnh7n20";
        };
        packageRequires = [ emacs ];
        meta = {
