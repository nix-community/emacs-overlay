{ callPackage }:
{
  ...
  casual = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.15.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/casual-2.15.1.tar";
        sha256 = "0kqdbv8549g80mni97lkhvns614axxgf1kp4p5yw8kv86891360f";
      };
      packageRequires = [
        csv-mode
        transient
  ...
  xah-fly-keys = callPackage (
    ...
    elpaBuild {
      ...
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-28.11.20260414134011.tar";
        sha256 = "0lznzibywsqh8vn095pr5kw1a7ngfiszr6b89k8kchsj7l00y9g3";
      };
      packageRequires = [ ];
      meta = {
