{ callPackage }:
  {
    ...
    eat = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.3.1";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/eat-0.3.1.tar";
          sha256 = "0q83i5v9psln35b4qjlc0hf2byrcqvdfy27ic60bf8r04vyhhsqs";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    subed = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "1.0.27";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/subed-1.0.27.tar";
          sha256 = "0nyhrlpvvglc3gd2wv20j34mws6f6s2j7q73b4lf3j0mw9yq1cgf";
        };
        packageRequires = [ emacs ];
        meta = {
