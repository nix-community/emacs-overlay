{ callPackage }:
  {
    ...
    sweeprolog = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "0.11.0";
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/sweeprolog-0.11.0.tar";
          sha256 = "08q9iq67pmywqczxjhdm8as7xkqcx7zws4xg672srksnkm4hylk7";
        };
        packageRequires = [ emacs ];
        meta = {
    ...
    xah-fly-keys = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        src = fetchurl {
          url = "https://elpa.nongnu.org/nongnu/xah-fly-keys-22.5.20230101184908.tar";
          sha256 = "19kx0g4dhhhf6r4lzyc0h37nif98srcbg3sc4iyk5ibv29msjmc2";
        };
        packageRequires = [ emacs ];
        meta = {
