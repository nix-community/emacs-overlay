...
These attributes are named =emacsGit= and =emacsGit27= in the overlay
and they are respectively built from the =master= branch (for Emacs 28)
and =emacs-27= branch.
Emacs from git is not guaranteed stable and may break your setup at any
time, if it breaks you get to keep both pieces.

We also provide two attributes named =emacsGit-nox= and =emacsGit27-nox=
